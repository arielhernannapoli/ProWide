...
namespace com.prowidesoftware.swift.constraints
{
	...
	/// </para>
	/// </summary>
	/// <seealso cref= com.prowidesoftware.swift.model.BIC#validate() for implementation details
	/// @since 7.10.3 </seealso>
//JAVA TO C# CONVERTER TODO TASK: There is no attribute target in .NET corresponding to METHOD:
//ORIGINAL LINE: @Documented @Constraint(validatedBy = BicValidator.class) @Target({ METHOD, FIELD, PARAMETER }) @Retention(RetentionPolicy.RUNTIME) public class BicConstraint extends System.Attribute
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	...
	public class BicConstraint : System.Attribute
	{
