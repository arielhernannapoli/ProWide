...
namespace com.prowidesoftware.deprecation
{
	...
	/// for more details.
	/// 
	/// <para>This annotation is intended for internal use of Prowide and 
...
//ORIGINAL LINE: @Retention(RetentionPolicy.SOURCE) @Documented public class ProwideDeprecated extends System.Attribute
	public class ProwideDeprecated : System.Attribute
	{
