...
//ORIGINAL LINE: @Generated public class MT112 extends com.prowidesoftware.swift.model.mt.AbstractMT implements java.io.Serializable
	[Serializable]
	public class MT112 : AbstractMT
	{
		/// <summary>
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		[NonSerialized]
		private static readonly java.util.logging.Logger log = java.util.logging.Logger.getLogger(typeof(MT112).FullName);

		/// <summary>
		/// Constant for MT name, this is part of the classname, after <code>MT</code>
		/// </summary>
		public const string NAME = "112";
	...
	// end qualifiers constants	
		...
		/// <summary>
		/// Creates an MT112 initialized with the parameter SwiftMessage </summary>
		/// <param name="m"> swift message with the MT112 content </param>
		public MT112(SwiftMessage m) : base(m)
		{
			sanityCheck(m);
		}

		/// <summary>
		/// Creates an MT112 initialized with the parameter MtSwiftMessage. </summary>
		/// <param name="m"> swift message with the MT112 content, the parameter can not be null </param>
		/// <seealso cref= #MT112(String) </seealso>
		public MT112(MtSwiftMessage m) : this(m.message())
		{
		}
		...
		/// @since 7.6
		/// </summary>
		public MT112() : this(BIC.TEST8, BIC.TEST8)
		{
		}
...
//ORIGINAL LINE: public MT112(final String sender, final String receiver)
		public MT112(string sender, string receiver) : base(112, sender, receiver)
		{
		}
		...
		/// <seealso cref= #MT112(String, String) </seealso>
		/// @deprecated Use instead <code>new MT112(sender, receiver)</code> instead 
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deprecated("Use instead <code>new MT112(sender, receiver)</code> instead") @com.prowidesoftware.deprecation.ProwideDeprecated(phase4=com.prowidesoftware.deprecation.TargetYear._2019) public MT112(final int messageType, final String sender, final String receiver)
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		[Obsolete("Use instead <code>new MT112(sender, receiver)</code> instead")]
		public MT112(int messageType, string sender, string receiver) : base(112, sender, receiver)
		{
			com.prowidesoftware.deprecation.DeprecationUtils.phase3(this.GetType(), "MT112(int, String, String)", "Use the constructor MT112(sender, receiver) instead.");
		}
		...
		/// @since 7.7 </param>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public MT112(final String fin)
		public MT112(string fin) : base()
		{
			if (fin != null)
			{
...
//ORIGINAL LINE: private void sanityCheck(final SwiftMessage param)
		private void sanityCheck(SwiftMessage param)
		{
			...
			{
				log.warning("Creating an MT112 object from FIN content with message type " + param.Type);
			}
		}
		...
		/// <returns> a new instance of MT112 or null if fin is null 
		/// @since 7.7 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static MT112 parse(final String fin)
...
//ORIGINAL LINE: public MT112(final java.io.InputStream stream) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public MT112(InputStream stream) : this(Lib.readStream(stream))
		{
		}
		...
		/// </summary>
		/// <param name="stream"> an input stream in UTF-8 encoding with the MT message in its FIN swift format. </param>
		/// <returns> a new instance of MT112 or null if stream is null or the message cannot be parsed </returns>
		/// <exception cref="IOException"> if the stream data cannot be read
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static MT112 parse(final java.io.InputStream stream) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public static MT112 parse(InputStream stream)
		{
			if (stream == null)
			{
				return null;
		...
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public MT112(final java.io.File file) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public MT112(File file) : this(Lib.readFile(file))
		{
		}
		...
		/// </summary>
		/// <param name="file"> a file with the MT message in its FIN swift format. </param>
		/// <returns> a new instance of MT112 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed </returns>
		/// <exception cref="IOException"> if the file content cannot be read
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static MT112 parse(final java.io.File file) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public static MT112 parse(File file)
		{
			if (file == null)
			{
				return null;
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT112 append(final SwiftTagListBlock block)
		public override MT112 append(SwiftTagListBlock block)
		{
			base.append(block);
			return this;
		}
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT112 append(final Tag... tags)
		public override MT112 append(params Tag[] tags)
		{
			base.append(tags);
			return this;
		}
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT112 append(final Field... fields)
		public override MT112 append(params Field[] fields)
		{
			base.append(fields);
			return this;
		}
		...
		/// </para>
		/// </summary>
		/// <param name="json"> a JSON representation of an MT112 message </param>
		/// <returns> a new instance of MT112
