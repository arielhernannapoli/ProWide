...
//ORIGINAL LINE: @Generated public class MT103_REMIT extends com.prowidesoftware.swift.model.mt.AbstractMT implements java.io.Serializable
	[Serializable]
	public class MT103_REMIT : AbstractMT
	{
		/// <summary>
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		[NonSerialized]
		private static readonly java.util.logging.Logger log = java.util.logging.Logger.getLogger(typeof(MT103_REMIT).FullName);

		/// <summary>
		/// Constant for MT name, this is part of the classname, after <code>MT</code>
		/// </summary>
		public const string NAME = "103_REMIT";
...
//ORIGINAL LINE: @Deprecated @com.prowidesoftware.deprecation.ProwideDeprecated(phase4=com.prowidesoftware.deprecation.TargetYear._2019) public static final String TELI = "TELI";
	...
	// end qualifiers constants	
		...
		/// <summary>
		/// Creates an MT103_REMIT initialized with the parameter SwiftMessage </summary>
		/// <param name="m"> swift message with the MT103_REMIT content </param>
		public MT103_REMIT(SwiftMessage m) : base(m)
		{
			sanityCheck(m);
		}

		/// <summary>
		/// Creates an MT103_REMIT initialized with the parameter MtSwiftMessage. </summary>
		/// <param name="m"> swift message with the MT103_REMIT content, the parameter can not be null </param>
		/// <seealso cref= #MT103_REMIT(String) </seealso>
		public MT103_REMIT(MtSwiftMessage m) : this(m.message())
		{
		}
		...
		/// <seealso cref= #MT103_REMIT(String)
		/// @since 7.7 </seealso>
		...
		/// @since 7.6
		/// </summary>
		public MT103_REMIT() : this(BIC.TEST8, BIC.TEST8)
		{
		}
...
//ORIGINAL LINE: public MT103_REMIT(final String sender, final String receiver)
		public MT103_REMIT(string sender, string receiver) : base(103, sender, receiver)
		{
			m.Variant = com.prowidesoftware.swift.model.mt.MTVariant.REMIT;
		...
		/// <seealso cref= #MT103_REMIT(String, String) </seealso>
		/// @deprecated Use instead <code>new MT103_REMIT(sender, receiver)</code> instead 
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deprecated("Use instead <code>new MT103_REMIT(sender, receiver)</code> instead") @com.prowidesoftware.deprecation.ProwideDeprecated(phase4=com.prowidesoftware.deprecation.TargetYear._2019) public MT103_REMIT(final int messageType, final String sender, final String receiver)
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		[Obsolete("Use instead <code>new MT103_REMIT(sender, receiver)</code> instead")]
		public MT103_REMIT(int messageType, string sender, string receiver) : base(103, sender, receiver)
		{
			com.prowidesoftware.deprecation.DeprecationUtils.phase3(this.GetType(), "MT103_REMIT(int, String, String)", "Use the constructor MT103_REMIT(sender, receiver) instead.");
		}
		...
		/// @since 7.7 </param>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public MT103_REMIT(final String fin)
		public MT103_REMIT(string fin) : base()
		{
			if (fin != null)
			{
...
//ORIGINAL LINE: private void sanityCheck(final SwiftMessage param)
		private void sanityCheck(SwiftMessage param)
		{
			...
			{
				log.warning("Creating an MT103_REMIT object from FIN content with message type " + param.Type);
			}
		}
		...
		/// <returns> a new instance of MT103_REMIT or null if fin is null 
		/// @since 7.7 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static MT103_REMIT parse(final String fin)
		public static MT103_REMIT parse(string fin)
		{
			if (fin == null)
			{
				return null;
...
//ORIGINAL LINE: public MT103_REMIT(final java.io.InputStream stream) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public MT103_REMIT(InputStream stream) : this(Lib.readStream(stream))
		{
		}
		...
		/// </summary>
		/// <param name="stream"> an input stream in UTF-8 encoding with the MT message in its FIN swift format. </param>
		/// <returns> a new instance of MT103_REMIT or null if stream is null or the message cannot be parsed </returns>
		/// <exception cref="IOException"> if the stream data cannot be read
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static MT103_REMIT parse(final java.io.InputStream stream) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public static MT103_REMIT parse(InputStream stream)
		{
			if (stream == null)
			{
				return null;
		...
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public MT103_REMIT(final java.io.File file) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public MT103_REMIT(File file) : this(Lib.readFile(file))
		{
		}
		...
		/// </summary>
		/// <param name="file"> a file with the MT message in its FIN swift format. </param>
		/// <returns> a new instance of MT103_REMIT or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed </returns>
		/// <exception cref="IOException"> if the file content cannot be read
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static MT103_REMIT parse(final java.io.File file) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public static MT103_REMIT parse(File file)
		{
			if (file == null)
			{
				return null;
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT103_REMIT append(final SwiftTagListBlock block)
		public override MT103_REMIT append(SwiftTagListBlock block)
		{
			base.append(block);
			return this;
		}
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT103_REMIT append(final Tag... tags)
		public override MT103_REMIT append(params Tag[] tags)
		{
			base.append(tags);
			return this;
		}
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT103_REMIT append(final Field... fields)
		public override MT103_REMIT append(params Field[] fields)
		{
			base.append(fields);
			return this;
		}
		...
		/// </para>
		/// </summary>
		/// <param name="json"> a JSON representation of an MT103_REMIT message </param>
		/// <returns> a new instance of MT103_REMIT
	...
	//ORIGINAL LINE: final Tag t = tag("55A");
		...
		/// </summary>
		/// <returns> a Field55B object or null if the field is not found </returns>
		/// <seealso cref= SwiftTagListBlock#getTagByName(String) </seealso>
		/// <exception cref="IllegalStateException"> if SwiftMessage object is not initialized </exception>
		public virtual Field55B Field55B
		{
			get
			{
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final Tag t = tag("55B");
				Tag t = tag("55B");
				if (t != null)
				{
					return new Field55B(t.Value);
				}
				else
				{
					return null;
		...
		/// </summary>
		/// <returns> a Field55D object or null if the field is not found </returns>
		/// <seealso cref= SwiftTagListBlock#getTagByName(String) </seealso>
		/// <exception cref="IllegalStateException"> if SwiftMessage object is not initialized </exception>
		public virtual Field55D Field55D
		{
			get
			{
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final Tag t = tag("55D");
				Tag t = tag("55D");
				if (t != null)
				{
					return new Field55D(t.Value);
				}
				else
				{
					return null;
	...
	//ORIGINAL LINE: final Tag t = tag("77B");
		...
		/// </summary>
		/// <returns> a Field77T object or null if the field is not found </returns>
		/// <seealso cref= SwiftTagListBlock#getTagByName(String) </seealso>
		/// <exception cref="IllegalStateException"> if SwiftMessage object is not initialized </exception>
		public virtual Field77T Field77T
		{
			get
			{
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final Tag t = tag("77T");
				Tag t = tag("77T");
				if (t != null)
				{
					return new Field77T(t.Value);
				}
				else
				{
					return null;
