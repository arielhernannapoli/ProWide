...
//ORIGINAL LINE: @Generated public class MT400 extends com.prowidesoftware.swift.model.mt.AbstractMT implements java.io.Serializable
	[Serializable]
	public class MT400 : AbstractMT
	{
		/// <summary>
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		[NonSerialized]
		private static readonly java.util.logging.Logger log = java.util.logging.Logger.getLogger(typeof(MT400).FullName);

		/// <summary>
		/// Constant for MT name, this is part of the classname, after <code>MT</code>
		/// </summary>
		public const string NAME = "400";
	...
	// end qualifiers constants	
		...
		/// <summary>
		/// Creates an MT400 initialized with the parameter SwiftMessage </summary>
		/// <param name="m"> swift message with the MT400 content </param>
		public MT400(SwiftMessage m) : base(m)
		{
			sanityCheck(m);
		}

		/// <summary>
		/// Creates an MT400 initialized with the parameter MtSwiftMessage. </summary>
		/// <param name="m"> swift message with the MT400 content, the parameter can not be null </param>
		/// <seealso cref= #MT400(String) </seealso>
		public MT400(MtSwiftMessage m) : this(m.message())
		{
		}
		...
		/// @since 7.6
		/// </summary>
		public MT400() : this(BIC.TEST8, BIC.TEST8)
		{
		}
...
//ORIGINAL LINE: public MT400(final String sender, final String receiver)
		public MT400(string sender, string receiver) : base(400, sender, receiver)
		{
		}
		...
		/// <seealso cref= #MT400(String, String) </seealso>
		/// @deprecated Use instead <code>new MT400(sender, receiver)</code> instead 
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deprecated("Use instead <code>new MT400(sender, receiver)</code> instead") @com.prowidesoftware.deprecation.ProwideDeprecated(phase4=com.prowidesoftware.deprecation.TargetYear._2019) public MT400(final int messageType, final String sender, final String receiver)
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		[Obsolete("Use instead <code>new MT400(sender, receiver)</code> instead")]
		public MT400(int messageType, string sender, string receiver) : base(400, sender, receiver)
		{
			com.prowidesoftware.deprecation.DeprecationUtils.phase3(this.GetType(), "MT400(int, String, String)", "Use the constructor MT400(sender, receiver) instead.");
		}
		...
		/// @since 7.7 </param>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public MT400(final String fin)
		public MT400(string fin) : base()
		{
			if (fin != null)
			{
...
//ORIGINAL LINE: private void sanityCheck(final SwiftMessage param)
		private void sanityCheck(SwiftMessage param)
		{
			...
			{
				log.warning("Creating an MT400 object from FIN content with message type " + param.Type);
			}
		}
		...
		/// <returns> a new instance of MT400 or null if fin is null 
		/// @since 7.7 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static MT400 parse(final String fin)
		public static MT400 parse(string fin)
		{
			if (fin == null)
			{
				return null;
...
//ORIGINAL LINE: public MT400(final java.io.InputStream stream) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public MT400(InputStream stream) : this(Lib.readStream(stream))
		{
		}
		...
		/// </summary>
		/// <param name="stream"> an input stream in UTF-8 encoding with the MT message in its FIN swift format. </param>
		/// <returns> a new instance of MT400 or null if stream is null or the message cannot be parsed </returns>
		/// <exception cref="IOException"> if the stream data cannot be read
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static MT400 parse(final java.io.InputStream stream) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public static MT400 parse(InputStream stream)
		{
			if (stream == null)
			{
				return null;
		...
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public MT400(final java.io.File file) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public MT400(File file) : this(Lib.readFile(file))
		{
		}
		...
		/// </summary>
		/// <param name="file"> a file with the MT message in its FIN swift format. </param>
		/// <returns> a new instance of MT400 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed </returns>
		/// <exception cref="IOException"> if the file content cannot be read
		/// @since 7.7 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static MT400 parse(final java.io.File file) throws java.io.IOException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		public static MT400 parse(File file)
		{
			if (file == null)
			{
				return null;
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT400 append(final SwiftTagListBlock block)
		public override MT400 append(SwiftTagListBlock block)
		{
			base.append(block);
			return this;
		}
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT400 append(final Tag... tags)
		public override MT400 append(params Tag[] tags)
		{
			base.append(tags);
			return this;
		}
		...
		/// @since 7.6 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public MT400 append(final Field... fields)
		public override MT400 append(params Field[] fields)
		{
			base.append(fields);
			return this;
		}
		...
		/// </para>
		/// </summary>
		/// <param name="json"> a JSON representation of an MT400 message </param>
		/// <returns> a new instance of MT400
	...
	//ORIGINAL LINE: final Tag t = tag("32B");
		...
		/// </summary>
		/// <returns> a Field32K object or null if the field is not found </returns>
		/// <seealso cref= SwiftTagListBlock#getTagByName(String) </seealso>
		/// <exception cref="IllegalStateException"> if SwiftMessage object is not initialized </exception>
		public virtual Field32K Field32K
		{
			get
			{
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final Tag t = tag("32K");
				Tag t = tag("32K");
				if (t != null)
				{
					return new Field32K(t.Value);
				}
				else
				{
					return null;
		...
		/// </summary>
		/// <returns> a Field33A object or null if the field is not found </returns>
		/// <seealso cref= SwiftTagListBlock#getTagByName(String) </seealso>
		/// <exception cref="IllegalStateException"> if SwiftMessage object is not initialized </exception>
		public virtual Field33A Field33A
		{
			get
			{
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final Tag t = tag("33A");
				Tag t = tag("33A");
				if (t != null)
				{
					return new Field33A(t.Value);
				}
				else
				{
					return null;
	...
	//ORIGINAL LINE: final Tag t = tag("58A");
		...
		/// </summary>
		/// <returns> a Field58B object or null if the field is not found </returns>
		/// <seealso cref= SwiftTagListBlock#getTagByName(String) </seealso>
		/// <exception cref="IllegalStateException"> if SwiftMessage object is not initialized </exception>
		public virtual Field58B Field58B
		{
			get
			{
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final Tag t = tag("58B");
				Tag t = tag("58B");
				if (t != null)
				{
					return new Field58B(t.Value);
				}
				else
				{
					return null;
	...
	//ORIGINAL LINE: final Tag t = tag("72");
		...
		/// </summary>
		/// <returns> a Field73 object or null if the field is not found </returns>
		/// <seealso cref= SwiftTagListBlock#getTagByName(String) </seealso>
		/// <exception cref="IllegalStateException"> if SwiftMessage object is not initialized </exception>
		public virtual Field73 Field73
		{
			get
			{
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final Tag t = tag("73");
				Tag t = tag("73");
				if (t != null)
				{
					return new Field73(t.Value);
				}
				else
				{
					return null;
