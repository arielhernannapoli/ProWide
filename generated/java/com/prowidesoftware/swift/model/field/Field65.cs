...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field65 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field65 : Field, DateContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "65";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_65 = "65";
		public const string PARSER_PATTERN = "[c]<DATE2>SN";
		public const string COMPONENTS_PATTERN = "SESN";
...
//ORIGINAL LINE: public Field65(final String value)
		public Field65(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field65(final com.prowidesoftware.swift.model.Tag tag)
		public Field65(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "65"))
			{
				throw new System.ArgumentException("cannot create field 65 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field65 setComponent1(string component1)
		{
		...
		public virtual Field65 setDCMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field65 setComponent2(string component2)
		{
		...
		public virtual Field65 setComponent2(DateTime component2)
		{
		...
		public virtual Field65 setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field65 setDate(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field65 setComponent3(string component3)
		{
		...
		public virtual Field65 setCurrency(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field65 setComponent4(string component4)
		{
		...
		public virtual Field65 setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field65 setAmount(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field65 setAmount(java.lang.Number component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field65.NAME </returns>
		...
		/// <returns> the static value of Field65.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field65 get(final SwiftTagListBlock block)
		public static Field65 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field65 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field65 get(final SwiftMessage msg)
		public static Field65 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field65> getAll(final SwiftMessage msg)
		public static IList<Field65> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field65> getAll(final SwiftTagListBlock block)
		public static IList<Field65> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field65> result = new java.util.ArrayList<>(arr.length);
				IList<Field65> result = new List<Field65>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 65");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field65 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field65 fromJson(final String json)
		public static Field65 fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("currency").AsString;
			}
		...
		public virtual java.util.Currency Component3AsCurrency
		{
			get
			{
				return (java.util.Currency)getComponentAs(3, typeof(java.util.Currency));
			}
		}
