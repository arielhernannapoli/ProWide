...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22S extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22S : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22S";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22S = "22S";
		...
		/// </summary>
		public const int? SIDE_INDICATOR = 1;
...
//ORIGINAL LINE: public Field22S(final String value)
		public Field22S(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22S(final com.prowidesoftware.swift.model.Tag tag)
		public Field22S(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22S"))
			{
				throw new System.ArgumentException("cannot create field 22S from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Side Indicator (component1). </summary>
		/// <returns> the Side Indicator from component1 </returns>
		public virtual string SideIndicator
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field22S setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Side Indicator (component1). </summary>
		/// <param name="component1"> the Side Indicator to set </param>
		public virtual Field22S setSideIndicator(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Identification (component2). </summary>
		/// <returns> the Identification from component2 </returns>
		...
		public virtual Field22S setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Identification (component2). </summary>
		/// <param name="component2"> the Identification to set </param>
		public virtual Field22S setIdentification(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22S.NAME </returns>
		...
		/// <returns> the static value of Field22S.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22S get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22S in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22S get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22S> getAll(final SwiftMessage msg)
		public static IList<Field22S> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22S> getAll(final SwiftTagListBlock block)
		public static IList<Field22S> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22S> result = new java.util.ArrayList<>(arr.length);
				IList<Field22S> result = new List<Field22S>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22S");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "sideIndicator";
				result[2] = "identification";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field22S object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22S fromJson(final String json)
		public static Field22S fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("sideIndicator").AsString;
			}
			if (jsonObject.get("identification") != null)
			{
				field.Component2 = jsonObject.get("identification").AsString;
			}
			return field;
		}
