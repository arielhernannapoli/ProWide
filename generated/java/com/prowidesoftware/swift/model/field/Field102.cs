...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field102 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field102 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string F_102 = "102";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "Z";
...
//ORIGINAL LINE: public Field102(final String value)
		public Field102(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field102(final com.prowidesoftware.swift.model.Tag tag)
		public Field102(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "102"))
			{
				throw new System.ArgumentException("cannot create field 102 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field102 setComponent1(string component1)
		{
		...
		public virtual Field102 setComponent1(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
		...
		public virtual Field102 setLTAddress(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field102 setLTAddress(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field102.NAME </returns>
		...
		/// <returns> the static value of Field102.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field102 get(final SwiftTagListBlock block)
		public static Field102 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field102 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field102 get(final SwiftMessage msg)
		public static Field102 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field102> getAll(final SwiftMessage msg)
		public static IList<Field102> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field102> getAll(final SwiftTagListBlock block)
		public static IList<Field102> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field102> result = new java.util.ArrayList<>(arr.length);
				IList<Field102> result = new List<Field102>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 102");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field102 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field102 fromJson(final String json)
		public static Field102 fromJson(string json)
		{
