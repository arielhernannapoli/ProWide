...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37M extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37M : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37M";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37M = "37M";
		public const string PARSER_PATTERN = "[S]N";
...
//ORIGINAL LINE: public Field37M(final String value)
		public Field37M(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37M(final com.prowidesoftware.swift.model.Tag tag)
		public Field37M(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37M"))
			{
				throw new System.ArgumentException("cannot create field 37M from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Sign (component1). </summary>
		/// <returns> the Sign from component1 </returns>
		...
		public virtual Field37M setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Sign (component1). </summary>
		/// <param name="component1"> the Sign to set </param>
		public virtual Field37M setSign(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Rate (component2). </summary>
		/// <returns> the Rate from component2 </returns>
		...
		/// <summary>
		/// Get the Rate (component2) as Number </summary>
		/// <returns> the Rate from component2 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field37M setComponent2(string component2)
		{
		...
		public virtual Field37M setComponent2(java.lang.Number component2)
		{
		...
		/// <summary>
		/// Set the Rate (component2). </summary>
		/// <param name="component2"> the Rate to set </param>
		public virtual Field37M setRate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Rate (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the Rate content to set </param>
		public virtual Field37M setRate(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37M.NAME </returns>
		...
		/// <returns> the static value of Field37M.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37M get(final SwiftTagListBlock block)
		public static Field37M get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37M in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37M get(final SwiftMessage msg)
		public static Field37M get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37M> getAll(final SwiftMessage msg)
		public static IList<Field37M> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37M> getAll(final SwiftTagListBlock block)
		public static IList<Field37M> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37M> result = new java.util.ArrayList<>(arr.length);
				IList<Field37M> result = new List<Field37M>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37M");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37M object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37M fromJson(final String json)
		public static Field37M fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("sign").AsString;
			}
			if (jsonObject.get("rate") != null)
			{
				field.setComponent2(jsonObject.get("rate").AsString);
			}
			return field;
		}
