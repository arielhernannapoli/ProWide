...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field125 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field125 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "125";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_125 = "125";
...
//ORIGINAL LINE: public Field125(final String value)
		public Field125(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field125(final com.prowidesoftware.swift.model.Tag tag)
		public Field125(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "125"))
			{
				throw new System.ArgumentException("cannot create field 125 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Category (component1). </summary>
		/// <returns> the Category from component1 </returns>
		...
		/// <summary>
		/// Get the Category (component1) as Number </summary>
		/// <returns> the Category from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number CategoryAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field125 setComponent1(string component1)
		{
		...
		public virtual Field125 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Category (component1). </summary>
		/// <param name="component1"> the Category to set </param>
		public virtual Field125 setCategory(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Category (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Category content to set </param>
		public virtual Field125 setCategory(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field125.NAME </returns>
		...
		/// <returns> the static value of Field125.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field125 get(final SwiftTagListBlock block)
		public static Field125 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field125 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field125 get(final SwiftMessage msg)
		public static Field125 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field125> getAll(final SwiftMessage msg)
		public static IList<Field125> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field125> getAll(final SwiftTagListBlock block)
		public static IList<Field125> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field125> result = new java.util.ArrayList<>(arr.length);
				IList<Field125> result = new List<Field125>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 125");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field125 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field125 fromJson(final String json)
		public static Field125 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("category").AsString);
			}
			return field;
		}
