...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field136 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field136 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "136";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_136 = "136";
		...
		/// </summary>
		public const int? BROADCAST_NUMBER = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field136() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field136(final String value)
		public Field136(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field136(final com.prowidesoftware.swift.model.Tag tag)
		public Field136(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "136"))
			{
				throw new System.ArgumentException("cannot create field 136 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field136 setComponent1(string component1)
		{
		...
		public virtual Field136 setBroadcastIndicator(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Broadcast Number (component2). </summary>
		/// <returns> the Broadcast Number from component2 </returns>
		...
		/// <summary>
		/// Get the Broadcast Number (component2) as Number </summary>
		/// <returns> the Broadcast Number from component2 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field136 setComponent2(string component2)
		{
		...
		public virtual Field136 setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		/// <summary>
		/// Set the Broadcast Number (component2). </summary>
		/// <param name="component2"> the Broadcast Number to set </param>
		public virtual Field136 setBroadcastNumber(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field136 setBroadcastNumber(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field136.NAME </returns>
		...
		/// <returns> the static value of Field136.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field136 get(final SwiftTagListBlock block)
		public static Field136 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field136 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field136 get(final SwiftMessage msg)
		public static Field136 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field136> getAll(final SwiftMessage msg)
		public static IList<Field136> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field136> getAll(final SwiftTagListBlock block)
		public static IList<Field136> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field136> result = new java.util.ArrayList<>(arr.length);
				IList<Field136> result = new List<Field136>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 136");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[2] = "broadcastNumber";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field136 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field136 fromJson(final String json)
		public static Field136 fromJson(string json)
		{
			...
			{
				field.setComponent2(jsonObject.get("broadcastNumber").AsString);
			}
			return field;
		}
