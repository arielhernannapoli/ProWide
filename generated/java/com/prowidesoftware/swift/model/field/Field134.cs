...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field134 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field134 : Field, BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "134";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_134 = "134";
		public const string PARSER_PATTERN = "S$S$S";
		public const string COMPONENTS_PATTERN = "BSS";
		...
		/// </summary>
		public const int? BROADCAST_REQUESTER_NAME = 2;

		/// <summary>
		/// Component number for the Broadcast Requester City subfield
		/// </summary>
		public const int? BROADCAST_REQUESTER_CITY = 3;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field134() : base(3)
		{
		}
...
//ORIGINAL LINE: public Field134(final String value)
		public Field134(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field134(final com.prowidesoftware.swift.model.Tag tag)
		public Field134(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "134"))
			{
				throw new System.ArgumentException("cannot create field 134 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field134 setComponent1(string component1)
		{
		...
		public virtual Field134 setComponent1(BIC component1)
		{
		...
		public virtual Field134 setBIC(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field134 setBIC(BIC component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Broadcast Requester Name (component2). </summary>
		/// <returns> the Broadcast Requester Name from component2 </returns>
		public virtual string BroadcastRequesterName
		{
			get
			{
				return getComponent(2);
		...
		public virtual Field134 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Broadcast Requester Name (component2). </summary>
		/// <param name="component2"> the Broadcast Requester Name to set </param>
		public virtual Field134 setBroadcastRequesterName(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Broadcast Requester City (component3). </summary>
		/// <returns> the Broadcast Requester City from component3 </returns>
		public virtual string BroadcastRequesterCity
		{
			get
			{
				return getComponent(3);
		...
		public virtual Field134 setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Broadcast Requester City (component3). </summary>
		/// <param name="component3"> the Broadcast Requester City to set </param>
		public virtual Field134 setBroadcastRequesterCity(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: final java.util.List<String> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field134.NAME </returns>
		...
		/// <returns> the static value of Field134.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field134 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field134 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field134 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field134> getAll(final SwiftMessage msg)
		public static IList<Field134> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field134> getAll(final SwiftTagListBlock block)
		public static IList<Field134> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field134> result = new java.util.ArrayList<>(arr.length);
				IList<Field134> result = new List<Field134>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 134");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "bIC";
				result[2] = "broadcastRequesterName";
				result[3] = "broadcastRequesterCity";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field134 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field134 fromJson(final String json)
