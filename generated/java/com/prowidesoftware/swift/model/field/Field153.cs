...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field153 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field153 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "153";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_153 = "153";
		...
		/// </summary>
		public const int? SEQUENCE_NUMBER = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field153() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field153(final String value)
		public Field153(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field153(final com.prowidesoftware.swift.model.Tag tag)
		public Field153(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "153"))
			{
				throw new System.ArgumentException("cannot create field 153 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Sequence Number (component1). </summary>
		/// <returns> the Sequence Number from component1 </returns>
		...
		/// <summary>
		/// Get the Sequence Number (component1) as Number </summary>
		/// <returns> the Sequence Number from component1 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field153 setComponent1(string component1)
		{
		...
		public virtual Field153 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Sequence Number (component1). </summary>
		/// <param name="component1"> the Sequence Number to set </param>
		public virtual Field153 setSequenceNumber(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field153 setSequenceNumber(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field153.NAME </returns>
		...
		/// <returns> the static value of Field153.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field153 get(final SwiftTagListBlock block)
		public static Field153 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field153 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field153 get(final SwiftMessage msg)
		public static Field153 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field153> getAll(final SwiftMessage msg)
		public static IList<Field153> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field153> getAll(final SwiftTagListBlock block)
		public static IList<Field153> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field153> result = new java.util.ArrayList<>(arr.length);
				IList<Field153> result = new List<Field153>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 153");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field153 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field153 fromJson(final String json)
		public static Field153 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("sequenceNumber").AsString);
			}
			return field;
		}
