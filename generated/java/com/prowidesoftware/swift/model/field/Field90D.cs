...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field90D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field90D : Field, CurrencyContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "90D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_90D = "90D";
...
//ORIGINAL LINE: public Field90D(final String value)
		public Field90D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field90D(final com.prowidesoftware.swift.model.Tag tag)
		public Field90D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "90D"))
			{
				throw new System.ArgumentException("cannot create field 90D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field90D setComponent1(string component1)
		{
		...
		public virtual Field90D setComponent1(java.lang.Number component1)
		{
		...
		public virtual Field90D setNumber(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field90D setNumber(java.lang.Number component1)
		{
		...
		public virtual Field90D setComponent2(string component2)
		{
		...
		public virtual Field90D setComponent2(Currency component2)
		{
		...
		public virtual Field90D setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field90D setCurrency(Currency component2)
		{
		...
		public virtual Field90D setComponent3(string component3)
		{
		...
		public virtual Field90D setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field90D setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field90D setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field90D.NAME </returns>
		...
		/// <returns> the static value of Field90D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field90D get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field90D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field90D get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field90D> getAll(final SwiftMessage msg)
		public static IList<Field90D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field90D> getAll(final SwiftTagListBlock block)
		public static IList<Field90D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field90D> result = new java.util.ArrayList<>(arr.length);
				IList<Field90D> result = new List<Field90D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 90D");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field90D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field90D fromJson(final String json)
