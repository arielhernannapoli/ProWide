...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field90J extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	...
	public class Field90J : Field, CurrencyContainer, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		...
		/// </summary>
		public const string NAME = "90J";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_90J = "90J";
		public const string PARSER_PATTERN = ":S//S/SN/SN";
		public const string COMPONENTS_PATTERN = "SSCNCN";
...
//ORIGINAL LINE: public Field90J(final String value)
		public Field90J(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field90J(final com.prowidesoftware.swift.model.Tag tag)
		public Field90J(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "90J"))
			{
				throw new System.ArgumentException("cannot create field 90J from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field90J setComponent1(string component1)
		{
		...
		public virtual Field90J setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field90J setComponent2(string component2)
		{
		...
		public virtual Field90J setCode(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Gets the Currency1 (component3). </summary>
		/// <returns> the Currency1 from component3 </returns>
		...
		/// <summary>
		/// Get the Currency1 (component3) as Currency </summary>
		/// <returns> the Currency1 from component3 converted to Currency or null if cannot be converted </returns>
		...
		public virtual Field90J setComponent3(string component3)
		{
		...
		public virtual Field90J setComponent3(Currency component3)
		{
		...
		/// <summary>
		/// Set the Currency1 (component3). </summary>
		/// <param name="component3"> the Currency1 to set </param>
		public virtual Field90J setCurrency1(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Currency1 (component3) from a Currency object. </summary>
		/// <seealso cref= #setComponent3(java.util.Currency) </seealso>
		/// <param name="component3"> Currency with the Currency1 content to set </param>
		public virtual Field90J setCurrency1(Currency component3)
		{
		...
		/// <summary>
		/// Gets the Amount1 (component4). </summary>
		/// <returns> the Amount1 from component4 </returns>
		public virtual string getAmount1()
		{
			return getComponent(4);
		}

		/// <summary>
		/// Get the Amount1 (component4) as Number </summary>
		/// <returns> the Amount1 from component4 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number Amount1AsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(4));
		...
		public virtual Field90J setComponent4(string component4)
		{
		...
		public virtual Field90J setComponent4(java.lang.Number component4)
		{
		...
		/// <summary>
		/// Set the Amount1 (component4). </summary>
		/// <param name="component4"> the Amount1 to set </param>
		public virtual Field90J setAmount1(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Set the Amount1 (component4) from a Number object. </summary>
		/// <seealso cref= #setComponent4(java.lang.Number) </seealso>
		/// <param name="component4"> Number with the Amount1 content to set </param>
		public virtual Field90J setAmount1(java.lang.Number component4)
		{
		...
		public virtual Currency Component5AsCurrency
		{
			get
			{
		...
		/// <summary>
		/// Gets the Currency2 (component5). </summary>
		/// <returns> the Currency2 from component5 </returns>
		...
		/// <summary>
		/// Get the Currency2 (component5) as Currency </summary>
		/// <returns> the Currency2 from component5 converted to Currency or null if cannot be converted </returns>
		...
		public virtual Field90J setComponent5(string component5)
		{
		...
		public virtual Field90J setComponent5(Currency component5)
		{
		...
		/// <summary>
		/// Set the Currency2 (component5). </summary>
		/// <param name="component5"> the Currency2 to set </param>
		public virtual Field90J setCurrency2(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		/// <summary>
		/// Set the Currency2 (component5) from a Currency object. </summary>
		/// <seealso cref= #setComponent5(java.util.Currency) </seealso>
		/// <param name="component5"> Currency with the Currency2 content to set </param>
		public virtual Field90J setCurrency2(Currency component5)
		{
		...
		/// <summary>
		/// Gets the Amount2 (component6). </summary>
		/// <returns> the Amount2 from component6 </returns>
		public virtual string getAmount2()
		{
			return getComponent(6);
		}

		/// <summary>
		/// Get the Amount2 (component6) as Number </summary>
		/// <returns> the Amount2 from component6 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number Amount2AsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(6));
		...
		public virtual Field90J setComponent6(string component6)
		{
		...
		public virtual Field90J setComponent6(java.lang.Number component6)
		{
		...
		/// <summary>
		/// Set the Amount2 (component6). </summary>
		/// <param name="component6"> the Amount2 to set </param>
		public virtual Field90J setAmount2(string component6)
		{
			setComponent(6, component6);
			return this;
		}
		...
		/// <summary>
		/// Set the Amount2 (component6) from a Number object. </summary>
		/// <seealso cref= #setComponent6(java.lang.Number) </seealso>
		/// <param name="component6"> Number with the Amount2 content to set </param>
		public virtual Field90J setAmount2(java.lang.Number component6)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field90J.NAME </returns>
		...
		/// <returns> the static value of Field90J.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field90J get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field90J in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field90J get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field90J> getAll(final SwiftMessage msg)
		public static IList<Field90J> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field90J> getAll(final SwiftTagListBlock block)
		public static IList<Field90J> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field90J> result = new java.util.ArrayList<>(arr.length);
				IList<Field90J> result = new List<Field90J>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 90J");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field90J object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field90J fromJson(final String json)
		public static Field90J fromJson(string json)
		{
			...
			{
				field.setComponent3(jsonObject.get("currency1").AsString);
			}
			if (jsonObject.get("amount1") != null)
			{
				field.setComponent4(jsonObject.get("amount1").AsString);
			}
			if (jsonObject.get("currency2") != null)
			{
				field.setComponent5(jsonObject.get("currency2").AsString);
			}
			if (jsonObject.get("amount2") != null)
			{
				field.setComponent6(jsonObject.get("amount2").AsString);
			}
			return field;
		}
