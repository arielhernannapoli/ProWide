...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37B extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37B : Field, DateContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37B";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37B = "37B";
...
//ORIGINAL LINE: public Field37B(final String value)
		public Field37B(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37B(final com.prowidesoftware.swift.model.Tag tag)
		public Field37B(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37B"))
			{
				throw new System.ArgumentException("cannot create field 37B from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field37B setComponent1(string component1)
		{
		...
		public virtual Field37B setComponent1(java.lang.Number component1)
		{
		...
		public virtual Field37B setRate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field37B setRate(java.lang.Number component1)
		{
		...
		public virtual Field37B setComponent2(string component2)
		{
		...
		public virtual Field37B setComponent2(DateTime component2)
		{
		...
		public virtual Field37B setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field37B setDate(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field37B setComponent3(string component3)
		{
		...
		public virtual Field37B setDMMark(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field37B setComponent4(string component4)
		{
		...
		public virtual Field37B setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field37B setNumberofDaysMonths(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field37B setNumberofDaysMonths(java.lang.Number component4)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		public virtual Field37B setComponent5(string component5)
		{
		...
		public virtual Field37B setInformation(string component5)
		{
			setComponent(5, component5);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37B.NAME </returns>
		...
		/// <returns> the static value of Field37B.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37B get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37B in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37B get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37B> getAll(final SwiftMessage msg)
		public static IList<Field37B> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37B> getAll(final SwiftTagListBlock block)
		public static IList<Field37B> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37B> result = new java.util.ArrayList<>(arr.length);
				IList<Field37B> result = new List<Field37B>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37B");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37B object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37B fromJson(final String json)
		public static Field37B fromJson(string json)
		{
