...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field29K extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field29K : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "29K";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_29K = "29K";
...
//ORIGINAL LINE: public Field29K(final String value)
		public Field29K(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field29K(final com.prowidesoftware.swift.model.Tag tag)
		public Field29K(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "29K"))
			{
				throw new System.ArgumentException("cannot create field 29K from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field29K setComponent1(string component1)
		{
		...
		public virtual Field29K setLocation(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field29K setComponent2(string component2)
		{
		...
		public virtual Field29K setComponent2(DateTime component2)
		{
		...
		public virtual Field29K setTime(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field29K setTime(DateTime component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field29K.NAME </returns>
		...
		/// <returns> the static value of Field29K.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29K get(final SwiftTagListBlock block)
		public static Field29K get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field29K in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29K get(final SwiftMessage msg)
		public static Field29K get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field29K> getAll(final SwiftMessage msg)
		public static IList<Field29K> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field29K> getAll(final SwiftTagListBlock block)
		public static IList<Field29K> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field29K> result = new java.util.ArrayList<>(arr.length);
				IList<Field29K> result = new List<Field29K>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 29K");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field29K object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29K fromJson(final String json)
		public static Field29K fromJson(string json)
		{
