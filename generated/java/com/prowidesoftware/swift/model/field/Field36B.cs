...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field36B extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field36B : Field, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "36B";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_36B = "36B";
		public const string PARSER_PATTERN = ":S//S/N";
...
//ORIGINAL LINE: public Field36B(final String value)
		public Field36B(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field36B(final com.prowidesoftware.swift.model.Tag tag)
		public Field36B(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "36B"))
			{
				throw new System.ArgumentException("cannot create field 36B from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field36B setComponent1(string component1)
		{
		...
		public virtual Field36B setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field36B setComponent2(string component2)
		{
		...
		public virtual Field36B setQuantityTypeCode(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Gets the Quantity (component3). </summary>
		/// <returns> the Quantity from component3 </returns>
		...
		/// <summary>
		/// Get the Quantity (component3) as Number </summary>
		/// <returns> the Quantity from component3 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field36B setComponent3(string component3)
		{
		...
		public virtual Field36B setComponent3(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Set the Quantity (component3). </summary>
		/// <param name="component3"> the Quantity to set </param>
		public virtual Field36B setQuantity(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Quantity (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Quantity content to set </param>
		public virtual Field36B setQuantity(java.lang.Number component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field36B.NAME </returns>
		...
		/// <returns> the static value of Field36B.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field36B get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field36B in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field36B get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field36B> getAll(final SwiftMessage msg)
		public static IList<Field36B> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field36B> getAll(final SwiftTagListBlock block)
		public static IList<Field36B> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field36B> result = new java.util.ArrayList<>(arr.length);
				IList<Field36B> result = new List<Field36B>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 36B");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field36B object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field36B fromJson(final String json)
		public static Field36B fromJson(string json)
		{
			...
			{
				field.setComponent3(jsonObject.get("quantity").AsString);
			}
			return field;
		}
