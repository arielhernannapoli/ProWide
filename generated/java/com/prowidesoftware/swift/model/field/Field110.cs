...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field110 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field110 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const int? WINDOW_SIZE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field110() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field110(final String value)
		public Field110(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field110(final com.prowidesoftware.swift.model.Tag tag)
		public Field110(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "110"))
			{
				throw new System.ArgumentException("cannot create field 110 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Window Size (component1). </summary>
		/// <returns> the Window Size from component1 </returns>
		public virtual string getWindowSize()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Window Size (component1) as Number </summary>
		/// <returns> the Window Size from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number WindowSizeAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field110 setComponent1(string component1)
		{
		...
		public virtual Field110 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Window Size (component1). </summary>
		/// <param name="component1"> the Window Size to set </param>
		public virtual Field110 setWindowSize(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Window Size (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Window Size content to set </param>
		public virtual Field110 setWindowSize(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field110.NAME </returns>
		...
		/// <returns> the static value of Field110.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field110 get(final SwiftTagListBlock block)
		public static Field110 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field110 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field110 get(final SwiftMessage msg)
		public static Field110 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field110> getAll(final SwiftMessage msg)
		public static IList<Field110> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field110> getAll(final SwiftTagListBlock block)
		public static IList<Field110> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field110> result = new java.util.ArrayList<>(arr.length);
				IList<Field110> result = new List<Field110>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 110");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field110 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field110 fromJson(final String json)
		public static Field110 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("windowSize").AsString);
			}
			return field;
		}
