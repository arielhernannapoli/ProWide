...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field92A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field92A : Field, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "92A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_92A = "92A";
		public const string PARSER_PATTERN = ":S//[c]N";
		...
		/// </summary>
		public const int? RATE_AMOUNT = 3;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field92A() : base(3)
		{
		}
...
//ORIGINAL LINE: public Field92A(final String value)
		public Field92A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field92A(final com.prowidesoftware.swift.model.Tag tag)
		public Field92A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "92A"))
			{
				throw new System.ArgumentException("cannot create field 92A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field92A setComponent1(string component1)
		{
		...
		public virtual Field92A setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Sign (component2). </summary>
		/// <returns> the Sign from component2 </returns>
		...
		public virtual Field92A setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Sign (component2). </summary>
		/// <param name="component2"> the Sign to set </param>
		public virtual Field92A setSign(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Gets the Rate Amount (component3). </summary>
		/// <returns> the Rate Amount from component3 </returns>
		public virtual string getRateAmount()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the Rate Amount (component3) as Number </summary>
		/// <returns> the Rate Amount from component3 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number RateAmountAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(3));
		...
		public virtual Field92A setComponent3(string component3)
		{
		...
		public virtual Field92A setComponent3(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Set the Rate Amount (component3). </summary>
		/// <param name="component3"> the Rate Amount to set </param>
		public virtual Field92A setRateAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Rate Amount (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Rate Amount content to set </param>
		public virtual Field92A setRateAmount(java.lang.Number component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field92A.NAME </returns>
		...
		/// <returns> the static value of Field92A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92A get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field92A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92A get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92A> getAll(final SwiftMessage msg)
		public static IList<Field92A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92A> getAll(final SwiftTagListBlock block)
		public static IList<Field92A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field92A> result = new java.util.ArrayList<>(arr.length);
				IList<Field92A> result = new List<Field92A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 92A");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field92A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92A fromJson(final String json)
		public static Field92A fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("sign").AsString;
			}
			if (jsonObject.get("rateAmount") != null)
			{
				field.setComponent3(jsonObject.get("rateAmount").AsString);
			}
			return field;
		}
