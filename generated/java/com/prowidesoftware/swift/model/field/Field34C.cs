...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field34C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field34C : Field, CurrencyContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "34C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_34C = "34C";
		public const string PARSER_PATTERN = "S/[c]<CUR>N";
		public const string COMPONENTS_PATTERN = "SSCN";

		/// <summary>
		/// Component number for the Commission Type subfield
		/// </summary>
		public const int? COMMISSION_TYPE = 1;
...
//ORIGINAL LINE: public Field34C(final String value)
		public Field34C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field34C(final com.prowidesoftware.swift.model.Tag tag)
		public Field34C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "34C"))
			{
				throw new System.ArgumentException("cannot create field 34C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (prefix != null)
			{
				if (prefix.Length > 3)
				{
					Component2 = StringUtils.Substring(prefix, 0, 1);
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Commission Type (component1). </summary>
		/// <returns> the Commission Type from component1 </returns>
		...
		public virtual Field34C setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Commission Type (component1). </summary>
		/// <param name="component1"> the Commission Type to set </param>
		public virtual Field34C setCommissionType(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field34C setComponent2(string component2)
		{
		...
		public virtual Field34C setSign(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field34C setComponent3(string component3)
		{
		...
		public virtual Field34C setComponent3(Currency component3)
		{
		...
		public virtual Field34C setCurrency(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field34C setCurrency(Currency component3)
		{
		...
		public virtual Field34C setComponent4(string component4)
		{
		...
		public virtual Field34C setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field34C setAmount(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field34C setAmount(java.lang.Number component4)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field34C.NAME </returns>
		...
		/// <returns> the static value of Field34C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34C get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field34C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34C get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34C> getAll(final SwiftMessage msg)
		public static IList<Field34C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34C> getAll(final SwiftTagListBlock block)
		public static IList<Field34C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field34C> result = new java.util.ArrayList<>(arr.length);
				IList<Field34C> result = new List<Field34C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 34C");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field34C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34C fromJson(final String json)
		public static Field34C fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("commissionType").AsString;
			}
