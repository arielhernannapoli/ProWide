...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field38E extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field38E : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "38E";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_38E = "38E";
		public const string PARSER_PATTERN = "NS";
...
//ORIGINAL LINE: public Field38E(final String value)
		public Field38E(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field38E(final com.prowidesoftware.swift.model.Tag tag)
		public Field38E(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "38E"))
			{
				throw new System.ArgumentException("cannot create field 38E from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			Component2 = SwiftParseUtils.getAlphaSuffix(value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field38E setComponent1(string component1)
		{
		...
		public virtual Field38E setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		public virtual Field38E setNumber(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field38E setNumber(java.lang.Number component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Period (component2). </summary>
		/// <returns> the Period from component2 </returns>
		...
		public virtual Field38E setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Period (component2). </summary>
		/// <param name="component2"> the Period to set </param>
		public virtual Field38E setPeriod(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field38E.NAME </returns>
		...
		/// <returns> the static value of Field38E.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field38E get(final SwiftTagListBlock block)
		public static Field38E get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field38E in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field38E get(final SwiftMessage msg)
		public static Field38E get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field38E> getAll(final SwiftMessage msg)
		public static IList<Field38E> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field38E> getAll(final SwiftTagListBlock block)
		public static IList<Field38E> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field38E> result = new java.util.ArrayList<>(arr.length);
				IList<Field38E> result = new List<Field38E>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 38E");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field38E object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field38E fromJson(final String json)
		public static Field38E fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("period").AsString;
			}
			return field;
		}
