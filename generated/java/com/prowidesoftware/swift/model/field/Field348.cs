...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field348 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field348 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "348";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_348 = "348";
		...
		/// </summary>
		public const int? SUBSET_SHARING = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field348() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field348(final String value)
		public Field348(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field348(final com.prowidesoftware.swift.model.Tag tag)
		public Field348(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "348"))
			{
				throw new System.ArgumentException("cannot create field 348 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Subset Sharing (component1). </summary>
		/// <returns> the Subset Sharing from component1 </returns>
		public virtual string SubsetSharing
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field348 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Subset Sharing (component1). </summary>
		/// <param name="component1"> the Subset Sharing to set </param>
		public virtual Field348 setSubsetSharing(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field348.NAME </returns>
		...
		/// <returns> the static value of Field348.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field348 get(final SwiftTagListBlock block)
		public static Field348 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field348 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field348 get(final SwiftMessage msg)
		public static Field348 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field348> getAll(final SwiftMessage msg)
		public static IList<Field348> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field348> getAll(final SwiftTagListBlock block)
		public static IList<Field348> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field348> result = new java.util.ArrayList<>(arr.length);
				IList<Field348> result = new List<Field348>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 348");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "subsetSharing";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field348 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field348 fromJson(final String json)
		public static Field348 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("subsetSharing").AsString;
			}
			return field;
		}
