...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field33K extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field33K : Field, CurrencyContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "33K";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_33K = "33K";
...
//ORIGINAL LINE: public Field33K(final String value)
		public Field33K(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field33K(final com.prowidesoftware.swift.model.Tag tag)
		public Field33K(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "33K"))
			{
				throw new System.ArgumentException("cannot create field 33K from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field33K setComponent1(string component1)
		{
		...
		public virtual Field33K setDMMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field33K setComponent2(string component2)
		{
		...
		public virtual Field33K setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field33K setNumberofDaysMonths(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field33K setNumberofDaysMonths(java.lang.Number component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field33K setComponent3(string component3)
		{
		...
		public virtual Field33K setCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field33K setComponent4(string component4)
		{
		...
		public virtual Field33K setComponent4(Currency component4)
		{
		...
		public virtual Field33K setCurrency(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field33K setCurrency(Currency component4)
		{
		...
		public virtual Field33K setComponent5(string component5)
		{
		...
		public virtual Field33K setComponent5(java.lang.Number component5)
		{
		...
		public virtual Field33K setAmount(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		public virtual Field33K setAmount(java.lang.Number component5)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field33K.NAME </returns>
		...
		/// <returns> the static value of Field33K.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33K get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field33K in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33K get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33K> getAll(final SwiftMessage msg)
		public static IList<Field33K> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33K> getAll(final SwiftTagListBlock block)
		public static IList<Field33K> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field33K> result = new java.util.ArrayList<>(arr.length);
				IList<Field33K> result = new List<Field33K>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 33K");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field33K object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33K fromJson(final String json)
