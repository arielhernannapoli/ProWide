...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field95S extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field95S : Field, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "95S";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_95S = "95S";
		public const string PARSER_PATTERN = ":S/[S]/S/S/S";
		public const string COMPONENTS_PATTERN = "SSSKS";
		...
		/// </summary>
		public const int? TYPE_OF_ID = 3;

		/// <summary>
		/// Component number for the Country Code subfield
		/// </summary>
		public const int? COUNTRY_CODE = 4;

		/// <summary>
		/// Component number for the Alternate ID subfield
		/// </summary>
		public const int? ALTERNATE_ID = 5;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field95S() : base(5)
		{
		}
...
//ORIGINAL LINE: public Field95S(final String value)
		public Field95S(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field95S(final com.prowidesoftware.swift.model.Tag tag)
		public Field95S(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "95S"))
			{
				throw new System.ArgumentException("cannot create field 95S from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			Component3 = SwiftParseUtils.getTokenThird(value, "/");
			string toparse = SwiftParseUtils.getTokenForthLast(value, "/");
			Component4 = SwiftParseUtils.getTokenFirst(toparse, "/");
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field95S setComponent1(string component1)
		{
		...
		public virtual Field95S setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field95S setComponent2(string component2)
		{
		...
		public virtual Field95S setDataSourceScheme(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Type Of ID (component3). </summary>
		/// <returns> the Type Of ID from component3 </returns>
		public virtual string TypeOfID
		{
			get
			{
				return getComponent(3);
		...
		public virtual Field95S setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Type Of ID (component3). </summary>
		/// <param name="component3"> the Type Of ID to set </param>
		public virtual Field95S setTypeOfID(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Gets the Country Code (component4). </summary>
		/// <returns> the Country Code from component4 </returns>
		...
		public virtual Field95S setComponent4(string component4)
		{
		...
		/// <summary>
		/// Set the Country Code (component4). </summary>
		/// <param name="component4"> the Country Code to set </param>
		public virtual Field95S setCountryCode(string component4)
		{
			setComponent(4, component4);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		/// <summary>
		/// Gets the Alternate ID (component5). </summary>
		/// <returns> the Alternate ID from component5 </returns>
		...
		public virtual Field95S setComponent5(string component5)
		{
		...
		/// <summary>
		/// Set the Alternate ID (component5). </summary>
		/// <param name="component5"> the Alternate ID to set </param>
		public virtual Field95S setAlternateID(string component5)
		{
			setComponent(5, component5);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field95S.NAME </returns>
		...
		/// <returns> the static value of Field95S.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field95S get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field95S in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field95S get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field95S> getAll(final SwiftMessage msg)
		public static IList<Field95S> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field95S> getAll(final SwiftTagListBlock block)
		public static IList<Field95S> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field95S> result = new java.util.ArrayList<>(arr.length);
				IList<Field95S> result = new List<Field95S>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 95S");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[3] = "typeOfID";
				result[4] = "countryCode";
				result[5] = "alternateID";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field95S object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field95S fromJson(final String json)
		public static Field95S fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("typeOfID").AsString;
			}
			if (jsonObject.get("countryCode") != null)
			{
				field.Component4 = jsonObject.get("countryCode").AsString;
			}
			if (jsonObject.get("alternateID") != null)
			{
				field.Component5 = jsonObject.get("alternateID").AsString;
			}
			return field;
		}
