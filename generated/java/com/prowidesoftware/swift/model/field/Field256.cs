...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field256 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field256 : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "256";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_256 = "256";
		public const string PARSER_PATTERN = "<LT>4!Nc<DATE2>[<HHMM><HHMM>]";
		public const string COMPONENTS_PATTERN = "ZNNEHH";
		...
		/// </summary>
		public const int? MESSAGE_CATEGORY = 3;
...
//ORIGINAL LINE: public Field256(final String value)
		public Field256(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field256(final com.prowidesoftware.swift.model.Tag tag)
		public Field256(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "256"))
			{
				throw new System.ArgumentException("cannot create field 256 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 27)
				{
					setComponent6(StringUtils.Substring(value, 27 - value));
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field256 setComponent1(string component1)
		{
		...
		public virtual Field256 setComponent1(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
		...
		public virtual Field256 setLTAddress(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field256 setLTAddress(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
		...
		public virtual Field256 setComponent2(string component2)
		{
		...
		public virtual Field256 setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		public virtual Field256 setSessionNumber(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field256 setSessionNumber(java.lang.Number component2)
		{
		...
		/// <summary>
		/// Gets the Message Category (component3). </summary>
		/// <returns> the Message Category from component3 </returns>
		public virtual string getMessageCategory()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the Message Category (component3) as Number </summary>
		/// <returns> the Message Category from component3 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number MessageCategoryAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(3));
		...
		public virtual Field256 setComponent3(string component3)
		{
		...
		public virtual Field256 setComponent3(java.lang.Number component3)
		{
			if (component3 != null)
			{
		...
		/// <summary>
		/// Set the Message Category (component3). </summary>
		/// <param name="component3"> the Message Category to set </param>
		public virtual Field256 setMessageCategory(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Message Category (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Message Category content to set </param>
		public virtual Field256 setMessageCategory(java.lang.Number component3)
		{
		...
		public virtual Field256 setComponent4(string component4)
		{
		...
		public virtual Field256 setComponent4(DateTime component4)
		{
		...
		public virtual Field256 setDate(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field256 setDate(DateTime component4)
		{
		...
		public virtual Field256 setComponent5(string component5)
		{
		...
		public virtual Field256 setComponent5(DateTime component5)
		{
		...
		public virtual Field256 setStartTime(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		public virtual Field256 setStartTime(DateTime component5)
		{
		...
		public virtual Field256 setComponent6(string component6)
		{
		...
		public virtual Field256 setComponent6(DateTime component6)
		{
		...
		public virtual Field256 setEndTime(string component6)
		{
			setComponent(6, component6);
			return this;
		}
		...
		public virtual Field256 setEndTime(DateTime component6)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field256.NAME </returns>
		...
		/// <returns> the static value of Field256.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field256 get(final SwiftTagListBlock block)
		public static Field256 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field256 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field256 get(final SwiftMessage msg)
		public static Field256 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field256> getAll(final SwiftMessage msg)
		public static IList<Field256> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field256> getAll(final SwiftTagListBlock block)
		public static IList<Field256> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field256> result = new java.util.ArrayList<>(arr.length);
				IList<Field256> result = new List<Field256>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 256");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field256 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field256 fromJson(final String json)
		public static Field256 fromJson(string json)
		{
			...
			{
				field.setComponent3(jsonObject.get("messageCategory").AsString);
			}
