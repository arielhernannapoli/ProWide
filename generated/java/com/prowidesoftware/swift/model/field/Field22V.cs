...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22V extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22V : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22V";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22V = "22V";
		...
		/// </summary>
		public const int? EXECUTION_VENUE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field22V() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field22V(final String value)
		public Field22V(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22V(final com.prowidesoftware.swift.model.Tag tag)
		public Field22V(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22V"))
			{
				throw new System.ArgumentException("cannot create field 22V from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Execution Venue (component1). </summary>
		/// <returns> the Execution Venue from component1 </returns>
		public virtual string ExecutionVenue
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field22V setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Execution Venue (component1). </summary>
		/// <param name="component1"> the Execution Venue to set </param>
		public virtual Field22V setExecutionVenue(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22V.NAME </returns>
		...
		/// <returns> the static value of Field22V.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22V get(final SwiftTagListBlock block)
		public static Field22V get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22V in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22V get(final SwiftMessage msg)
		public static Field22V get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22V> getAll(final SwiftMessage msg)
		public static IList<Field22V> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22V> getAll(final SwiftTagListBlock block)
		public static IList<Field22V> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22V> result = new java.util.ArrayList<>(arr.length);
				IList<Field22V> result = new List<Field22V>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22V");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "executionVenue";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field22V object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22V fromJson(final String json)
		public static Field22V fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("executionVenue").AsString;
			}
			return field;
		}
