...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field28E extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field28E : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "28E";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_28E = "28E";
		public const string PARSER_PATTERN = "S/S";
		public const string COMPONENTS_PATTERN = "NS";
		...
		/// </summary>
		public const int? CONTINUATION_INDICATOR = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field28E() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field28E(final String value)
		public Field28E(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field28E(final com.prowidesoftware.swift.model.Tag tag)
		public Field28E(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "28E"))
			{
				throw new System.ArgumentException("cannot create field 28E from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Page Number (component1). </summary>
		/// <returns> the Page Number from component1 </returns>
		public virtual string getPageNumber()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Page Number (component1) as Number </summary>
		/// <returns> the Page Number from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number PageNumberAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field28E setComponent1(string component1)
		{
		...
		public virtual Field28E setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Page Number (component1). </summary>
		/// <param name="component1"> the Page Number to set </param>
		public virtual Field28E setPageNumber(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Page Number (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Page Number content to set </param>
		public virtual Field28E setPageNumber(java.lang.Number component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Continuation Indicator (component2). </summary>
		/// <returns> the Continuation Indicator from component2 </returns>
		public virtual string ContinuationIndicator
		{
			get
			{
				return getComponent(2);
		...
		public virtual Field28E setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Continuation Indicator (component2). </summary>
		/// <param name="component2"> the Continuation Indicator to set </param>
		public virtual Field28E setContinuationIndicator(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field28E.NAME </returns>
		...
		/// <returns> the static value of Field28E.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field28E get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field28E in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field28E get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field28E> getAll(final SwiftMessage msg)
		public static IList<Field28E> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field28E> getAll(final SwiftTagListBlock block)
		public static IList<Field28E> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field28E> result = new java.util.ArrayList<>(arr.length);
				IList<Field28E> result = new List<Field28E>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 28E");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "pageNumber";
				result[2] = "continuationIndicator";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field28E object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field28E fromJson(final String json)
