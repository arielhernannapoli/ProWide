...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field12E extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field12E : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "12E";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_12E = "12E";
		...
		/// </summary>
		public const int? EXPIRATION_STYLE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field12E() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field12E(final String value)
		public Field12E(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field12E(final com.prowidesoftware.swift.model.Tag tag)
		public Field12E(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "12E"))
			{
				throw new System.ArgumentException("cannot create field 12E from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Expiration Style (component1). </summary>
		/// <returns> the Expiration Style from component1 </returns>
		public virtual string ExpirationStyle
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field12E setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Expiration Style (component1). </summary>
		/// <param name="component1"> the Expiration Style to set </param>
		public virtual Field12E setExpirationStyle(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field12E.NAME </returns>
		...
		/// <returns> the static value of Field12E.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12E get(final SwiftTagListBlock block)
		public static Field12E get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field12E in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12E get(final SwiftMessage msg)
		public static Field12E get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12E> getAll(final SwiftMessage msg)
		public static IList<Field12E> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12E> getAll(final SwiftTagListBlock block)
		public static IList<Field12E> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field12E> result = new java.util.ArrayList<>(arr.length);
				IList<Field12E> result = new List<Field12E>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 12E");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "expirationStyle";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field12E object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12E fromJson(final String json)
		public static Field12E fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("expirationStyle").AsString;
			}
			return field;
		}
