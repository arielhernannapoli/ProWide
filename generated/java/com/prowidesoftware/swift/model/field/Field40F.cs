...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field40F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field40F : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "40F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_40F = "40F";
		...
		/// </summary>
		public const int? APPLICABLE_RULES = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field40F() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field40F(final String value)
		public Field40F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field40F(final com.prowidesoftware.swift.model.Tag tag)
		public Field40F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "40F"))
			{
				throw new System.ArgumentException("cannot create field 40F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Applicable Rules (component1). </summary>
		/// <returns> the Applicable Rules from component1 </returns>
		public virtual string ApplicableRules
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field40F setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Applicable Rules (component1). </summary>
		/// <param name="component1"> the Applicable Rules to set </param>
		public virtual Field40F setApplicableRules(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field40F.NAME </returns>
		...
		/// <returns> the static value of Field40F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field40F get(final SwiftTagListBlock block)
		public static Field40F get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field40F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field40F get(final SwiftMessage msg)
		public static Field40F get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field40F> getAll(final SwiftMessage msg)
		public static IList<Field40F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field40F> getAll(final SwiftTagListBlock block)
		public static IList<Field40F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field40F> result = new java.util.ArrayList<>(arr.length);
				IList<Field40F> result = new List<Field40F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 40F");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "applicableRules";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field40F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field40F fromJson(final String json)
		public static Field40F fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("applicableRules").AsString;
			}
			return field;
		}
