...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field92D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field92D : Field, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "92D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_92D = "92D";
		public const string PARSER_PATTERN = ":S//N/N";
		public const string COMPONENTS_PATTERN = "SNN";
		...
		/// </summary>
		public const int? QUANTITY1 = 2;

		/// <summary>
		/// Component number for the Quantity2 subfield
		/// </summary>
		public const int? QUANTITY2 = 3;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field92D() : base(3)
		{
		}
...
//ORIGINAL LINE: public Field92D(final String value)
		public Field92D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field92D(final com.prowidesoftware.swift.model.Tag tag)
		public Field92D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "92D"))
			{
				throw new System.ArgumentException("cannot create field 92D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field92D setComponent1(string component1)
		{
		...
		public virtual Field92D setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Quantity1 (component2). </summary>
		/// <returns> the Quantity1 from component2 </returns>
		public virtual string getQuantity1()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Quantity1 (component2) as Number </summary>
		/// <returns> the Quantity1 from component2 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number Quantity1AsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(2));
		...
		public virtual Field92D setComponent2(string component2)
		{
		...
		public virtual Field92D setComponent2(java.lang.Number component2)
		{
		...
		/// <summary>
		/// Set the Quantity1 (component2). </summary>
		/// <param name="component2"> the Quantity1 to set </param>
		public virtual Field92D setQuantity1(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Quantity1 (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the Quantity1 content to set </param>
		public virtual Field92D setQuantity1(java.lang.Number component2)
		{
		...
		/// <summary>
		/// Gets the Quantity2 (component3). </summary>
		/// <returns> the Quantity2 from component3 </returns>
		public virtual string getQuantity2()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the Quantity2 (component3) as Number </summary>
		/// <returns> the Quantity2 from component3 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number Quantity2AsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(3));
		...
		public virtual Field92D setComponent3(string component3)
		{
		...
		public virtual Field92D setComponent3(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Set the Quantity2 (component3). </summary>
		/// <param name="component3"> the Quantity2 to set </param>
		public virtual Field92D setQuantity2(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Quantity2 (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Quantity2 content to set </param>
		public virtual Field92D setQuantity2(java.lang.Number component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field92D.NAME </returns>
		...
		/// <returns> the static value of Field92D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92D get(final SwiftTagListBlock block)
		public static Field92D get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field92D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92D get(final SwiftMessage msg)
		public static Field92D get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92D> getAll(final SwiftMessage msg)
		public static IList<Field92D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92D> getAll(final SwiftTagListBlock block)
		public static IList<Field92D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field92D> result = new java.util.ArrayList<>(arr.length);
				IList<Field92D> result = new List<Field92D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 92D");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field92D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92D fromJson(final String json)
		public static Field92D fromJson(string json)
		{
			...
			{
				field.setComponent2(jsonObject.get("quantity1").AsString);
			}
			if (jsonObject.get("quantity2") != null)
			{
				field.setComponent3(jsonObject.get("quantity2").AsString);
			}
			return field;
		}
