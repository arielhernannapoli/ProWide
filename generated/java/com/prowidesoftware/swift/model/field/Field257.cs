...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field257 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field257 : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "257";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_257 = "257";
...
//ORIGINAL LINE: public Field257(final String value)
		public Field257(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field257(final com.prowidesoftware.swift.model.Tag tag)
		public Field257(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "257"))
			{
				throw new System.ArgumentException("cannot create field 257 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field257 setComponent1(string component1)
		{
		...
		public virtual Field257 setLTAddress(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field257 setComponent2(string component2)
		{
		...
		public virtual Field257 setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field257 setDate(DateTime component2)
		{
		...
		public virtual Field257 setComponent3(string component3)
		{
		...
		public virtual Field257 setComponent3(DateTime component3)
		{
		...
		public virtual Field257 setStartTime(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field257 setStartTime(DateTime component3)
		{
		...
		public virtual Field257 setComponent4(string component4)
		{
		...
		public virtual Field257 setEndTime(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field257 setEndTime(DateTime component4)
		{
		...
		public virtual Field257 setComponent5(string component5)
		{
		...
		public virtual Field257 setSessionNumber(string component5)
		{
			setComponent(5, component5);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field257.NAME </returns>
		...
		/// <returns> the static value of Field257.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field257 get(final SwiftTagListBlock block)
		public static Field257 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field257 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field257 get(final SwiftMessage msg)
		public static Field257 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field257> getAll(final SwiftMessage msg)
		public static IList<Field257> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field257> getAll(final SwiftTagListBlock block)
		public static IList<Field257> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field257> result = new java.util.ArrayList<>(arr.length);
				IList<Field257> result = new List<Field257>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 257");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field257 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field257 fromJson(final String json)
		public static Field257 fromJson(string json)
		{
