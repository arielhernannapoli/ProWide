...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field339 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field339 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "339";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_339 = "339";
		...
		/// </summary>
		public const int? SUBSET_NAME = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field339() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field339(final String value)
		public Field339(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field339(final com.prowidesoftware.swift.model.Tag tag)
		public Field339(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "339"))
			{
				throw new System.ArgumentException("cannot create field 339 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Subset Name (component1). </summary>
		/// <returns> the Subset Name from component1 </returns>
		public virtual string SubsetName
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field339 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Subset Name (component1). </summary>
		/// <param name="component1"> the Subset Name to set </param>
		public virtual Field339 setSubsetName(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field339.NAME </returns>
		...
		/// <returns> the static value of Field339.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field339 get(final SwiftTagListBlock block)
		public static Field339 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field339 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field339 get(final SwiftMessage msg)
		public static Field339 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field339> getAll(final SwiftMessage msg)
		public static IList<Field339> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field339> getAll(final SwiftTagListBlock block)
		public static IList<Field339> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field339> result = new java.util.ArrayList<>(arr.length);
				IList<Field339> result = new List<Field339>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 339");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field339 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field339 fromJson(final String json)
		public static Field339 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("subsetName").AsString;
			}
			return field;
		}
