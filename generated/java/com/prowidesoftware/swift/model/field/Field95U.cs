...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field95U extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.GenericField, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field95U : Field, com.prowidesoftware.swift.model.field.GenericField, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "95U";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_95U = "95U";
		public const string PARSER_PATTERN = ":S//S[$S]0-2";
		public const string COMPONENTS_PATTERN = "SSSS";
		...
		/// </summary>
		public const int? PARTY_NAME = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field95U() : base(4)
		{
		}
...
//ORIGINAL LINE: public Field95U(final String value)
		public Field95U(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field95U(final com.prowidesoftware.swift.model.Tag tag)
		public Field95U(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "95U"))
			{
				throw new System.ArgumentException("cannot create field 95U from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field95U setComponent1(string component1)
		{
		...
		public virtual Field95U setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Party Name (component2). </summary>
		/// <returns> the Party Name from component2 </returns>
		public virtual string PartyNameLine1
		{
			get
			{
				return getComponent(2);
		...
		/// <summary>
		/// Gets the Party Name (component3). </summary>
		/// <returns> the Party Name from component3 </returns>
		public virtual string PartyNameLine2
		{
			get
			{
		...
		/// <summary>
		/// Gets the Party Name (component4). </summary>
		/// <returns> the Party Name from component4 </returns>
		public virtual string PartyNameLine3
		{
			get
			{
		...
		/// <summary>
		/// Gets the Party Name as a concatenation of component2 to component4. </summary>
		/// <returns> the Party Name from components </returns>
		...
		public virtual Field95U setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Party Name (component2). </summary>
		/// <param name="component2"> the Party Name to set </param>
		public virtual Field95U setPartyNameLine1(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Party Name (component3). </summary>
		/// <param name="component3"> the Party Name to set </param>
		public virtual Field95U setPartyNameLine2(string component3)
		{
		...
		/// <summary>
		/// Set the Party Name (component4). </summary>
		/// <param name="component4"> the Party Name to set </param>
		public virtual Field95U setPartyNameLine3(string component4)
		{
		...
		/// <summary>
		/// Set the Party Name splitting the parameter lines into components 2 to 4. </summary>
		/// <param name="value"> the Party Name to set, may contain line ends and each line will be set to its correspondent component attribute </param>
		public virtual Field95U setPartyName(string value)
		{
			IList<string> lines = SwiftParseUtils.getLines(value);
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field95U setComponent3(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field95U setComponent4(string component4)
		{
			setComponent(4, component4);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field95U.NAME </returns>
		...
		/// <returns> the static value of Field95U.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field95U get(final SwiftTagListBlock block)
		public static Field95U get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field95U in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field95U get(final SwiftMessage msg)
		public static Field95U get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field95U> getAll(final SwiftMessage msg)
		public static IList<Field95U> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field95U> getAll(final SwiftTagListBlock block)
		public static IList<Field95U> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field95U> result = new java.util.ArrayList<>(arr.length);
				IList<Field95U> result = new List<Field95U>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 95U");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field95U object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field95U fromJson(final String json)
		public static Field95U fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("partyName").AsString;
			}
			if (jsonObject.get("partyName2") != null)
			{
				field.Component3 = jsonObject.get("partyName2").AsString;
			}
			if (jsonObject.get("partyName3") != null)
			{
				field.Component4 = jsonObject.get("partyName3").AsString;
			}
			return field;
		}
