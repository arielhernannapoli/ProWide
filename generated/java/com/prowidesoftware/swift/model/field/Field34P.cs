...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field34P extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	...
	public class Field34P : Field, CurrencyContainer, DateContainer, AmountContainer
	{
		...
		/// </summary>
		public const string NAME = "34P";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_34P = "34P";
...
//ORIGINAL LINE: public Field34P(final String value)
		public Field34P(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field34P(final com.prowidesoftware.swift.model.Tag tag)
		public Field34P(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "34P"))
			{
				throw new System.ArgumentException("cannot create field 34P from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field34P setComponent1(string component1)
		{
		...
		public virtual Field34P setComponent1(DateTime component1)
		{
		...
		public virtual Field34P setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field34P setDate(DateTime component1)
		{
		...
		public virtual Field34P setComponent2(string component2)
		{
		...
		public virtual Field34P setComponent2(Currency component2)
		{
		...
		public virtual Field34P setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field34P setCurrency(Currency component2)
		{
		...
		public virtual Field34P setComponent3(string component3)
		{
		...
		public virtual Field34P setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field34P setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field34P setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field34P.NAME </returns>
		...
		/// <returns> the static value of Field34P.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34P get(final SwiftTagListBlock block)
		public static Field34P get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field34P in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34P get(final SwiftMessage msg)
		public static Field34P get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34P> getAll(final SwiftMessage msg)
		public static IList<Field34P> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34P> getAll(final SwiftTagListBlock block)
		public static IList<Field34P> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field34P> result = new java.util.ArrayList<>(arr.length);
				IList<Field34P> result = new List<Field34P>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 34P");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field34P object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34P fromJson(final String json)
		public static Field34P fromJson(string json)
		{
