...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field111 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field111 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string F_111 = "111";
		public const string PARSER_PATTERN = "N";
		public const string COMPONENTS_PATTERN = "N";

		/// <summary>
		/// Component number for the Service Type Identifier subfield
		/// </summary>
		public const int? SERVICE_TYPE_IDENTIFIER = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field111() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field111(final String value)
		public Field111(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field111(final com.prowidesoftware.swift.model.Tag tag)
		public Field111(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "111"))
			{
				throw new System.ArgumentException("cannot create field 111 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Service Type Identifier (component1). </summary>
		/// <returns> the Service Type Identifier from component1 </returns>
		public virtual string getServiceTypeIdentifier()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Service Type Identifier (component1) as Number </summary>
		/// <returns> the Service Type Identifier from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number ServiceTypeIdentifierAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field111 setComponent1(string component1)
		{
		...
		public virtual Field111 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Service Type Identifier (component1). </summary>
		/// <param name="component1"> the Service Type Identifier to set </param>
		public virtual Field111 setServiceTypeIdentifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Service Type Identifier (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Service Type Identifier content to set </param>
		public virtual Field111 setServiceTypeIdentifier(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field111.NAME </returns>
		...
		/// <returns> the static value of Field111.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field111 get(final SwiftTagListBlock block)
		public static Field111 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field111 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field111 get(final SwiftMessage msg)
		public static Field111 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field111> getAll(final SwiftMessage msg)
		public static IList<Field111> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field111> getAll(final SwiftTagListBlock block)
		public static IList<Field111> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field111> result = new java.util.ArrayList<>(arr.length);
				IList<Field111> result = new List<Field111>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 111");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "serviceTypeIdentifier";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field111 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field111 fromJson(final String json)
		public static Field111 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("serviceTypeIdentifier").AsString);
			}
			return field;
		}
