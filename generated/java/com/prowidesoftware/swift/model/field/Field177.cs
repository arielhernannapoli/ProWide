...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field177 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field177 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "177";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_177 = "177";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "U";

		/// <summary>
		/// Component number for the Date Time subfield
		/// </summary>
		public const int? DATE_TIME = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field177() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field177(final String value)
		public Field177(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field177(final com.prowidesoftware.swift.model.Tag tag)
		public Field177(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "177"))
			{
				throw new System.ArgumentException("cannot create field 177 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Date Time (component1). </summary>
		/// <returns> the Date Time from component1 </returns>
		...
		/// <summary>
		/// Get the Date Time (component1) as Calendar </summary>
		/// <returns> the Date Time from component1 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime DateTimeAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getDateTimeShortYear(getComponent(1));
		...
		public virtual Field177 setComponent1(string component1)
		{
		...
		public virtual Field177 setComponent1(DateTime component1)
		{
		...
		/// <summary>
		/// Set the Date Time (component1). </summary>
		/// <param name="component1"> the Date Time to set </param>
		public virtual Field177 setDateTime(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Date Time (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Date Time content to set </param>
		public virtual Field177 setDateTime(DateTime component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field177.NAME </returns>
		...
		/// <returns> the static value of Field177.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field177 get(final SwiftTagListBlock block)
		public static Field177 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field177 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field177 get(final SwiftMessage msg)
		public static Field177 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field177> getAll(final SwiftMessage msg)
		public static IList<Field177> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field177> getAll(final SwiftTagListBlock block)
		public static IList<Field177> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field177> result = new java.util.ArrayList<>(arr.length);
				IList<Field177> result = new List<Field177>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 177");
			}
			if (component == 1)
			{
				//date + time
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field177 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field177 fromJson(final String json)
		public static Field177 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("dateTime").AsString);
			}
			return field;
		}
