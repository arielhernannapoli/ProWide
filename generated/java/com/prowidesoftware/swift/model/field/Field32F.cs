...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field32F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field32F : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "32F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_32F = "32F";
...
//ORIGINAL LINE: public Field32F(final String value)
		public Field32F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field32F(final com.prowidesoftware.swift.model.Tag tag)
		public Field32F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "32F"))
			{
				throw new System.ArgumentException("cannot create field 32F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Unit (component1). </summary>
		/// <returns> the Unit from component1 </returns>
		...
		public virtual Field32F setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Unit (component1). </summary>
		/// <param name="component1"> the Unit to set </param>
		public virtual Field32F setUnit(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field32F setComponent2(string component2)
		{
		...
		public virtual Field32F setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field32F setAmount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field32F setAmount(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field32F.NAME </returns>
		...
		/// <returns> the static value of Field32F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32F get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field32F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32F get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field32F> getAll(final SwiftMessage msg)
		public static IList<Field32F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field32F> getAll(final SwiftTagListBlock block)
		public static IList<Field32F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field32F> result = new java.util.ArrayList<>(arr.length);
				IList<Field32F> result = new List<Field32F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 32F");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field32F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32F fromJson(final String json)
		public static Field32F fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("unit").AsString;
			}
