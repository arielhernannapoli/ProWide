...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field93C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field93C : Field, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "93C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_93C = "93C";
		...
		/// </summary>
		public const int? QUANTITY_TYPE_CODE = 2;

		/// <summary>
		/// Component number for the Balance Type Code subfield
		/// </summary>
		public const int? BALANCE_TYPE_CODE = 3;
...
//ORIGINAL LINE: public Field93C(final String value)
		public Field93C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field93C(final com.prowidesoftware.swift.model.Tag tag)
		public Field93C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "93C"))
			{
				throw new System.ArgumentException("cannot create field 93C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			Component3 = SwiftParseUtils.getTokenSecond(toparse, "/");
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field93C setComponent1(string component1)
		{
		...
		public virtual Field93C setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Quantity Type Code (component2). </summary>
		/// <returns> the Quantity Type Code from component2 </returns>
		...
		public virtual Field93C setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Quantity Type Code (component2). </summary>
		/// <param name="component2"> the Quantity Type Code to set </param>
		public virtual Field93C setQuantityTypeCode(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Balance Type Code (component3). </summary>
		/// <returns> the Balance Type Code from component3 </returns>
		public virtual string BalanceTypeCode
		{
			get
			{
				return getComponent(3);
		...
		public virtual Field93C setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Balance Type Code (component3). </summary>
		/// <param name="component3"> the Balance Type Code to set </param>
		public virtual Field93C setBalanceTypeCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field93C setComponent4(string component4)
		{
		...
		public virtual Field93C setSign(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field93C setComponent5(string component5)
		{
		...
		public virtual Field93C setComponent5(java.lang.Number component5)
		{
		...
		public virtual Field93C setAmount(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		public virtual Field93C setAmount(java.lang.Number component5)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field93C.NAME </returns>
		...
		/// <returns> the static value of Field93C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field93C get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field93C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field93C get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field93C> getAll(final SwiftMessage msg)
		public static IList<Field93C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field93C> getAll(final SwiftTagListBlock block)
		public static IList<Field93C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field93C> result = new java.util.ArrayList<>(arr.length);
				IList<Field93C> result = new List<Field93C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 93C");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "qualifier";
				result[2] = "quantityTypeCode";
				result[3] = "balanceTypeCode";
				result[4] = "sign";
				result[5] = "amount";
				return result;
			}
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field93C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field93C fromJson(final String json)
		public static Field93C fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("quantityTypeCode").AsString;
			}
			if (jsonObject.get("balanceTypeCode") != null)
			{
				field.Component3 = jsonObject.get("balanceTypeCode").AsString;
			}
