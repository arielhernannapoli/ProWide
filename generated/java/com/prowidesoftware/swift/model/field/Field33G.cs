...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field33G extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field33G : Field, CurrencyContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "33G";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_33G = "33G";
		public const string PARSER_PATTERN = "SNS";
		public const string COMPONENTS_PATTERN = "CNS";
...
//ORIGINAL LINE: public Field33G(final String value)
		public Field33G(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field33G(final com.prowidesoftware.swift.model.Tag tag)
		public Field33G(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "33G"))
			{
				throw new System.ArgumentException("cannot create field 33G from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field33G setComponent1(string component1)
		{
		...
		public virtual Field33G setComponent1(Currency component1)
		{
		...
		public virtual Field33G setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field33G setCurrency(Currency component1)
		{
		...
		public virtual Field33G setComponent2(string component2)
		{
		...
		public virtual Field33G setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field33G setAmount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field33G setAmount(java.lang.Number component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field33G setComponent3(string component3)
		{
		...
		public virtual Field33G setCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field33G.NAME </returns>
		...
		/// <returns> the static value of Field33G.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33G get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field33G in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33G get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33G> getAll(final SwiftMessage msg)
		public static IList<Field33G> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33G> getAll(final SwiftTagListBlock block)
		public static IList<Field33G> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field33G> result = new java.util.ArrayList<>(arr.length);
				IList<Field33G> result = new List<Field33G>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 33G");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field33G object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33G fromJson(final String json)
