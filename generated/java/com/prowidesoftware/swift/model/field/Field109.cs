...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field109 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field109 : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "109";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_109 = "109";
		public const string PARSER_PATTERN = "<DATE2><TIME2>S";
		public const string COMPONENTS_PATTERN = "DTS";
		...
		/// </summary>
		public const int? MIR_Renamed = 3;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field109() : base(3)
		{
		}
...
//ORIGINAL LINE: public Field109(final String value)
		public Field109(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field109(final com.prowidesoftware.swift.model.Tag tag)
		public Field109(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "109"))
			{
				throw new System.ArgumentException("cannot create field 109 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 12)
				{
					Component3 = StringUtils.Substring(value, 12 - value);
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field109 setComponent1(string component1)
		{
		...
		public virtual Field109 setComponent1(DateTime component1)
		{
		...
		public virtual Field109 setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field109 setDate(DateTime component1)
		{
		...
		public virtual Field109 setComponent2(string component2)
		{
		...
		public virtual Field109 setComponent2(DateTime component2)
		{
		...
		public virtual Field109 setTime(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field109 setTime(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the MIR (component3). </summary>
		/// <returns> the MIR from component3 </returns>
		...
		public virtual Field109 setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the MIR (component3). </summary>
		/// <param name="component3"> the MIR to set </param>
		public virtual Field109 setMIR(string component3)
		{
			setComponent(3, component3);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field109.NAME </returns>
		...
		/// <returns> the static value of Field109.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field109 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field109 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field109 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field109> getAll(final SwiftMessage msg)
		public static IList<Field109> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field109> getAll(final SwiftTagListBlock block)
		public static IList<Field109> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field109> result = new java.util.ArrayList<>(arr.length);
				IList<Field109> result = new List<Field109>(arr.Length);
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field109 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field109 fromJson(final String json)
		public static Field109 fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("mIR").AsString;
			}
			return field;
		}
