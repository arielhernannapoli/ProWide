...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37E extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37E : Field, DateContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37E";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37E = "37E";
...
//ORIGINAL LINE: public Field37E(final String value)
		public Field37E(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37E(final com.prowidesoftware.swift.model.Tag tag)
		public Field37E(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37E"))
			{
				throw new System.ArgumentException("cannot create field 37E from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field37E setComponent1(string component1)
		{
		...
		public virtual Field37E setComponent1(java.lang.Number component1)
		{
		...
		public virtual Field37E setRate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field37E setRate(java.lang.Number component1)
		{
		...
		public virtual Field37E setComponent2(string component2)
		{
		...
		public virtual Field37E setComponent2(DateTime component2)
		{
		...
		public virtual Field37E setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field37E setDate(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field37E setComponent3(string component3)
		{
		...
		public virtual Field37E setDMMark(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field37E setComponent4(string component4)
		{
		...
		public virtual Field37E setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field37E setNumberofDaysMonths(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field37E setNumberofDaysMonths(java.lang.Number component4)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		public virtual Field37E setComponent5(string component5)
		{
		...
		public virtual Field37E setInformation(string component5)
		{
			setComponent(5, component5);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37E.NAME </returns>
		...
		/// <returns> the static value of Field37E.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37E get(final SwiftTagListBlock block)
		public static Field37E get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37E in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37E get(final SwiftMessage msg)
		public static Field37E get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37E> getAll(final SwiftMessage msg)
		public static IList<Field37E> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37E> getAll(final SwiftTagListBlock block)
		public static IList<Field37E> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37E> result = new java.util.ArrayList<>(arr.length);
				IList<Field37E> result = new List<Field37E>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37E");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37E object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37E fromJson(final String json)
		public static Field37E fromJson(string json)
		{
