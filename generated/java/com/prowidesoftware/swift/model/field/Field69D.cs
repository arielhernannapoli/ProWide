...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field69D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field69D : Field, DateContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "69D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_69D = "69D";
		public const string PARSER_PATTERN = ":S//<DATE4><TIME2>/S";
		public const string COMPONENTS_PATTERN = "SDTS";
		...
		/// </summary>
		public const int? DATE_CODE = 4;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field69D() : base(4)
		{
		}
...
//ORIGINAL LINE: public Field69D(final String value)
		public Field69D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field69D(final com.prowidesoftware.swift.model.Tag tag)
		public Field69D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "69D"))
			{
				throw new System.ArgumentException("cannot create field 69D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			Component4 = SwiftParseUtils.getTokenSecondLast(toparse, "/");
			if (toparse2 != null)
			{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field69D setComponent1(string component1)
		{
		...
		public virtual Field69D setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field69D setComponent2(string component2)
		{
		...
		public virtual Field69D setComponent2(DateTime component2)
		{
		...
		public virtual Field69D setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field69D setDate(DateTime component2)
		{
		...
		public virtual Field69D setComponent3(string component3)
		{
		...
		public virtual Field69D setComponent3(DateTime component3)
		{
		...
		public virtual Field69D setTime(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field69D setTime(DateTime component3)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		/// <summary>
		/// Gets the Date Code (component4). </summary>
		/// <returns> the Date Code from component4 </returns>
		...
		public virtual Field69D setComponent4(string component4)
		{
		...
		/// <summary>
		/// Set the Date Code (component4). </summary>
		/// <param name="component4"> the Date Code to set </param>
		public virtual Field69D setDateCode(string component4)
		{
			setComponent(4, component4);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field69D.NAME </returns>
		...
		/// <returns> the static value of Field69D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69D get(final SwiftTagListBlock block)
		public static Field69D get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field69D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69D get(final SwiftMessage msg)
		public static Field69D get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field69D> getAll(final SwiftMessage msg)
		public static IList<Field69D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field69D> getAll(final SwiftTagListBlock block)
		public static IList<Field69D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field69D> result = new java.util.ArrayList<>(arr.length);
				IList<Field69D> result = new List<Field69D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 69D");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field69D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69D fromJson(final String json)
		public static Field69D fromJson(string json)
		{
			...
			{
				field.Component4 = jsonObject.get("dateCode").AsString;
			}
			return field;
		}
