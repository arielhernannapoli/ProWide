...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field33A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	...
	public class Field33A : Field, CurrencyContainer, DateContainer, AmountContainer
	{
		...
		/// </summary>
		public const string NAME = "33A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_33A = "33A";
...
//ORIGINAL LINE: public Field33A(final String value)
		public Field33A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field33A(final com.prowidesoftware.swift.model.Tag tag)
		public Field33A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "33A"))
			{
				throw new System.ArgumentException("cannot create field 33A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field33A setComponent1(string component1)
		{
		...
		public virtual Field33A setComponent1(DateTime component1)
		{
		...
		public virtual Field33A setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field33A setDate(DateTime component1)
		{
		...
		public virtual Field33A setComponent2(string component2)
		{
		...
		public virtual Field33A setComponent2(Currency component2)
		{
		...
		public virtual Field33A setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field33A setCurrency(Currency component2)
		{
		...
		public virtual Field33A setComponent3(string component3)
		{
		...
		public virtual Field33A setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field33A setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field33A setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field33A.NAME </returns>
		...
		/// <returns> the static value of Field33A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33A get(final SwiftTagListBlock block)
		public static Field33A get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field33A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33A get(final SwiftMessage msg)
		public static Field33A get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33A> getAll(final SwiftMessage msg)
		public static IList<Field33A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33A> getAll(final SwiftTagListBlock block)
		public static IList<Field33A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field33A> result = new java.util.ArrayList<>(arr.length);
				IList<Field33A> result = new List<Field33A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 33A");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field33A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33A fromJson(final String json)
		public static Field33A fromJson(string json)
		{
