...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field132 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field132 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "132";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_132 = "132";
...
//ORIGINAL LINE: public Field132(final String value)
		public Field132(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field132(final com.prowidesoftware.swift.model.Tag tag)
		public Field132(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "132"))
			{
				throw new System.ArgumentException("cannot create field 132 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field132 setComponent1(string component1)
		{
		...
		public virtual Field132 setBroadcastIndicator(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field132 setComponent2(string component2)
		{
		...
		public virtual Field132 setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		public virtual Field132 setBroadcastNumber(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field132.NAME </returns>
		...
		/// <returns> the static value of Field132.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field132 get(final SwiftTagListBlock block)
		public static Field132 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field132 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field132 get(final SwiftMessage msg)
		public static Field132 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field132> getAll(final SwiftMessage msg)
		public static IList<Field132> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field132> getAll(final SwiftTagListBlock block)
		public static IList<Field132> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field132> result = new java.util.ArrayList<>(arr.length);
				IList<Field132> result = new List<Field132>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 132");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field132 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field132 fromJson(final String json)
		public static Field132 fromJson(string json)
		{
