...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field179 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field179 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "179";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_179 = "179";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "T";

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field179() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field179(final String value)
		public Field179(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field179(final com.prowidesoftware.swift.model.Tag tag)
		public Field179(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "179"))
			{
				throw new System.ArgumentException("cannot create field 179 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field179 setComponent1(string component1)
		{
		...
		public virtual Field179 setComponent1(DateTime component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field179.NAME </returns>
		...
		/// <returns> the static value of Field179.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field179 get(final SwiftTagListBlock block)
		public static Field179 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field179 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field179 get(final SwiftMessage msg)
		public static Field179 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field179> getAll(final SwiftMessage msg)
		public static IList<Field179> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field179> getAll(final SwiftTagListBlock block)
		public static IList<Field179> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field179> result = new java.util.ArrayList<>(arr.length);
				IList<Field179> result = new List<Field179>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 179");
			}
			if (component == 1)
			{
				//time with seconds
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field179 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field179 fromJson(final String json)
		public static Field179 fromJson(string json)
		{
