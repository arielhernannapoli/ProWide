...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field313 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field313 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "313";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_313 = "313";
...
//ORIGINAL LINE: public Field313(final String value)
		public Field313(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field313(final com.prowidesoftware.swift.model.Tag tag)
		public Field313(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "313"))
			{
				throw new System.ArgumentException("cannot create field 313 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Count (component1). </summary>
		/// <returns> the Count from component1 </returns>
		...
		/// <summary>
		/// Get the Count (component1) as Number </summary>
		/// <returns> the Count from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number CountAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field313 setComponent1(string component1)
		{
		...
		public virtual Field313 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Count (component1). </summary>
		/// <param name="component1"> the Count to set </param>
		public virtual Field313 setCount(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Count (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Count content to set </param>
		public virtual Field313 setCount(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field313.NAME </returns>
		...
		/// <returns> the static value of Field313.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field313 get(final SwiftTagListBlock block)
		public static Field313 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field313 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field313 get(final SwiftMessage msg)
		public static Field313 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field313> getAll(final SwiftMessage msg)
		public static IList<Field313> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field313> getAll(final SwiftTagListBlock block)
		public static IList<Field313> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field313> result = new java.util.ArrayList<>(arr.length);
				IList<Field313> result = new List<Field313>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 313");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field313 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field313 fromJson(final String json)
		public static Field313 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("count").AsString);
			}
			return field;
		}
