...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field106 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field106 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const int? MIR_Renamed = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field106() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field106(final String value)
		public Field106(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field106(final com.prowidesoftware.swift.model.Tag tag)
		public Field106(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "106"))
			{
				throw new System.ArgumentException("cannot create field 106 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the MIR (component1). </summary>
		/// <returns> the MIR from component1 </returns>
		...
		public virtual Field106 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the MIR (component1). </summary>
		/// <param name="component1"> the MIR to set </param>
		public virtual Field106 setMIR(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field106.NAME </returns>
		...
		/// <returns> the static value of Field106.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field106 get(final SwiftTagListBlock block)
		public static Field106 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field106 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field106 get(final SwiftMessage msg)
		public static Field106 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field106> getAll(final SwiftMessage msg)
		public static IList<Field106> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field106> getAll(final SwiftTagListBlock block)
		public static IList<Field106> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field106> result = new java.util.ArrayList<>(arr.length);
				IList<Field106> result = new List<Field106>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 106");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field106 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field106 fromJson(final String json)
		public static Field106 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("mIR").AsString;
			}
			return field;
		}
