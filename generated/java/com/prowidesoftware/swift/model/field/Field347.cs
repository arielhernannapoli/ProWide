...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field347 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field347 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "347";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_347 = "347";
		...
		/// </summary>
		public const int? FIELD_10 = 10;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field347() : base(10)
		{
		}
...
//ORIGINAL LINE: public Field347(final String value)
		public Field347(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field347(final com.prowidesoftware.swift.model.Tag tag)
		public Field347(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "347"))
			{
				throw new System.ArgumentException("cannot create field 347 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Field 1 (component1). </summary>
		/// <returns> the Field 1 from component1 </returns>
		...
		public virtual Field347 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Field 1 (component1). </summary>
		/// <param name="component1"> the Field 1 to set </param>
		public virtual Field347 setField1(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Field 2 (component2). </summary>
		/// <returns> the Field 2 from component2 </returns>
		...
		public virtual Field347 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Field 2 (component2). </summary>
		/// <param name="component2"> the Field 2 to set </param>
		public virtual Field347 setField2(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Field 3 (component3). </summary>
		/// <returns> the Field 3 from component3 </returns>
		...
		public virtual Field347 setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Field 3 (component3). </summary>
		/// <param name="component3"> the Field 3 to set </param>
		public virtual Field347 setField3(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		/// <summary>
		/// Gets the Field 4 (component4). </summary>
		/// <returns> the Field 4 from component4 </returns>
		...
		public virtual Field347 setComponent4(string component4)
		{
		...
		/// <summary>
		/// Set the Field 4 (component4). </summary>
		/// <param name="component4"> the Field 4 to set </param>
		public virtual Field347 setField4(string component4)
		{
			setComponent(4, component4);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		/// <summary>
		/// Gets the Field 5 (component5). </summary>
		/// <returns> the Field 5 from component5 </returns>
		...
		public virtual Field347 setComponent5(string component5)
		{
		...
		/// <summary>
		/// Set the Field 5 (component5). </summary>
		/// <param name="component5"> the Field 5 to set </param>
		public virtual Field347 setField5(string component5)
		{
			setComponent(5, component5);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent6AsString()
		...
		/// <summary>
		/// Gets the Field 6 (component6). </summary>
		/// <returns> the Field 6 from component6 </returns>
		public virtual string Field6
		{
			get
			{
				return getComponent(6);
		...
		public virtual Field347 setComponent6(string component6)
		{
		...
		/// <summary>
		/// Set the Field 6 (component6). </summary>
		/// <param name="component6"> the Field 6 to set </param>
		public virtual Field347 setField6(string component6)
		{
			setComponent(6, component6);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent7AsString()
		...
		/// <summary>
		/// Gets the Field 7 (component7). </summary>
		/// <returns> the Field 7 from component7 </returns>
		public virtual string Field7
		{
			get
			{
				return getComponent(7);
		...
		public virtual Field347 setComponent7(string component7)
		{
		...
		/// <summary>
		/// Set the Field 7 (component7). </summary>
		/// <param name="component7"> the Field 7 to set </param>
		public virtual Field347 setField7(string component7)
		{
			setComponent(7, component7);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent8AsString()
		...
		/// <summary>
		/// Gets the Field 8 (component8). </summary>
		/// <returns> the Field 8 from component8 </returns>
		public virtual string Field8
		{
			get
			{
				return getComponent(8);
		...
		public virtual Field347 setComponent8(string component8)
		{
		...
		/// <summary>
		/// Set the Field 8 (component8). </summary>
		/// <param name="component8"> the Field 8 to set </param>
		public virtual Field347 setField8(string component8)
		{
			setComponent(8, component8);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent9AsString()
		...
		/// <summary>
		/// Gets the Field 9 (component9). </summary>
		/// <returns> the Field 9 from component9 </returns>
		public virtual string Field9
		{
			get
			{
				return getComponent(9);
		...
		public virtual Field347 setComponent9(string component9)
		{
		...
		/// <summary>
		/// Set the Field 9 (component9). </summary>
		/// <param name="component9"> the Field 9 to set </param>
		public virtual Field347 setField9(string component9)
		{
			setComponent(9, component9);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent10AsString()
		...
		/// <summary>
		/// Gets the Field 10 (component10). </summary>
		/// <returns> the Field 10 from component10 </returns>
		public virtual string Field10
		{
			get
			{
				return getComponent(10);
		...
		public virtual Field347 setComponent10(string component10)
		{
		...
		/// <summary>
		/// Set the Field 10 (component10). </summary>
		/// <param name="component10"> the Field 10 to set </param>
		public virtual Field347 setField10(string component10)
		{
			setComponent(10, component10);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field347.NAME </returns>
		...
		/// <returns> the static value of Field347.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field347 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field347 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field347 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field347> getAll(final SwiftMessage msg)
		public static IList<Field347> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field347> getAll(final SwiftTagListBlock block)
		public static IList<Field347> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field347> result = new java.util.ArrayList<>(arr.length);
				IList<Field347> result = new List<Field347>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 347");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field347 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field347 fromJson(final String json)
		public static Field347 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("field1").AsString;
			}
			if (jsonObject.get("field2") != null)
			{
				field.Component2 = jsonObject.get("field2").AsString;
			}
			if (jsonObject.get("field3") != null)
			{
				field.Component3 = jsonObject.get("field3").AsString;
			}
			if (jsonObject.get("field4") != null)
			{
				field.Component4 = jsonObject.get("field4").AsString;
			}
			if (jsonObject.get("field5") != null)
			{
				field.Component5 = jsonObject.get("field5").AsString;
			}
			if (jsonObject.get("field6") != null)
			{
				field.Component6 = jsonObject.get("field6").AsString;
			}
			if (jsonObject.get("field7") != null)
			{
				field.Component7 = jsonObject.get("field7").AsString;
			}
			if (jsonObject.get("field8") != null)
			{
				field.Component8 = jsonObject.get("field8").AsString;
			}
			if (jsonObject.get("field9") != null)
			{
				field.Component9 = jsonObject.get("field9").AsString;
			}
			if (jsonObject.get("field10") != null)
			{
				field.Component10 = jsonObject.get("field10").AsString;
			}
			return field;
		}
