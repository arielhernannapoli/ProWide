...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field19Y extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field19Y : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "19Y";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_19Y = "19Y";
...
//ORIGINAL LINE: public Field19Y(final String value)
		public Field19Y(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field19Y(final com.prowidesoftware.swift.model.Tag tag)
		public Field19Y(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "19Y"))
			{
				throw new System.ArgumentException("cannot create field 19Y from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Amount (component1). </summary>
		/// <returns> the Amount from component1 </returns>
		...
		/// <summary>
		/// Get the Amount (component1) as Number </summary>
		/// <returns> the Amount from component1 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field19Y setComponent1(string component1)
		{
		...
		public virtual Field19Y setComponent1(java.lang.Number component1)
		{
		...
		/// <summary>
		/// Set the Amount (component1). </summary>
		/// <param name="component1"> the Amount to set </param>
		public virtual Field19Y setAmount(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field19Y setAmount(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field19Y.NAME </returns>
		...
		/// <returns> the static value of Field19Y.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field19Y get(final SwiftTagListBlock block)
		public static Field19Y get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field19Y in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field19Y get(final SwiftMessage msg)
		public static Field19Y get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field19Y> getAll(final SwiftMessage msg)
		public static IList<Field19Y> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field19Y> getAll(final SwiftTagListBlock block)
		public static IList<Field19Y> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field19Y> result = new java.util.ArrayList<>(arr.length);
				IList<Field19Y> result = new List<Field19Y>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 19Y");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field19Y object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field19Y fromJson(final String json)
		public static Field19Y fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("amount").AsString);
			}
			return field;
		}
