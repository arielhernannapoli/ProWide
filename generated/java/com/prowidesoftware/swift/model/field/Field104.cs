...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field104 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field104 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const int? MESSAGE_PRIORITY = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field104() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field104(final String value)
		public Field104(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field104(final com.prowidesoftware.swift.model.Tag tag)
		public Field104(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "104"))
			{
				throw new System.ArgumentException("cannot create field 104 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Message Priority (component1). </summary>
		/// <returns> the Message Priority from component1 </returns>
		...
		public virtual Field104 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Message Priority (component1). </summary>
		/// <param name="component1"> the Message Priority to set </param>
		public virtual Field104 setMessagePriority(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field104.NAME </returns>
		...
		/// <returns> the static value of Field104.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field104 get(final SwiftTagListBlock block)
		public static Field104 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field104 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field104 get(final SwiftMessage msg)
		public static Field104 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field104> getAll(final SwiftMessage msg)
		public static IList<Field104> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field104> getAll(final SwiftTagListBlock block)
		public static IList<Field104> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field104> result = new java.util.ArrayList<>(arr.length);
				IList<Field104> result = new List<Field104>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 104");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "messagePriority";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field104 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field104 fromJson(final String json)
		public static Field104 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("messagePriority").AsString;
			}
			return field;
		}
