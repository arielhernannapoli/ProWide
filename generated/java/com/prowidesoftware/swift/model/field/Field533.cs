...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field533 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field533 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "533";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_533 = "533";
		...
		/// </summary>
		public const int? CUT_OFF_TIME_COUNT = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field533() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field533(final String value)
		public Field533(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field533(final com.prowidesoftware.swift.model.Tag tag)
		public Field533(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "533"))
			{
				throw new System.ArgumentException("cannot create field 533 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Cut Off Time Count (component1). </summary>
		/// <returns> the Cut Off Time Count from component1 </returns>
		public virtual string getCutOffTimeCount()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Cut Off Time Count (component1) as Number </summary>
		/// <returns> the Cut Off Time Count from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number CutOffTimeCountAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field533 setComponent1(string component1)
		{
		...
		public virtual Field533 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Cut Off Time Count (component1). </summary>
		/// <param name="component1"> the Cut Off Time Count to set </param>
		public virtual Field533 setCutOffTimeCount(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Cut Off Time Count (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Cut Off Time Count content to set </param>
		public virtual Field533 setCutOffTimeCount(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field533.NAME </returns>
		...
		/// <returns> the static value of Field533.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field533 get(final SwiftTagListBlock block)
		public static Field533 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field533 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field533 get(final SwiftMessage msg)
		public static Field533 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field533> getAll(final SwiftMessage msg)
		public static IList<Field533> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field533> getAll(final SwiftTagListBlock block)
		public static IList<Field533> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field533> result = new java.util.ArrayList<>(arr.length);
				IList<Field533> result = new List<Field533>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 533");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "cutOffTimeCount";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field533 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field533 fromJson(final String json)
		public static Field533 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("cutOffTimeCount").AsString);
			}
			return field;
		}
