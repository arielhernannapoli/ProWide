...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field98C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field98C : Field, DateContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "98C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_98C = "98C";
		public const string PARSER_PATTERN = ":S//<DATE4><TIME2>";
		public const string COMPONENTS_PATTERN = "SDT";
...
//ORIGINAL LINE: public Field98C(final String value)
		public Field98C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field98C(final com.prowidesoftware.swift.model.Tag tag)
		public Field98C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "98C"))
			{
				throw new System.ArgumentException("cannot create field 98C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (toparse != null)
			{
				...
				if (toparse.Length > 8)
				{
					setComponent3(StringUtils.Substring(toparse, 8 - toparse));
				}
			}
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field98C setComponent1(string component1)
		{
		...
		public virtual Field98C setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field98C setComponent2(string component2)
		{
		...
		public virtual Field98C setComponent2(DateTime component2)
		{
		...
		public virtual Field98C setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field98C setDate(DateTime component2)
		{
		...
		public virtual Field98C setComponent3(string component3)
		{
		...
		public virtual Field98C setComponent3(DateTime component3)
		{
		...
		public virtual Field98C setTime(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field98C setTime(DateTime component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field98C.NAME </returns>
		...
		/// <returns> the static value of Field98C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98C get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field98C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98C get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98C> getAll(final SwiftMessage msg)
		public static IList<Field98C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98C> getAll(final SwiftTagListBlock block)
		public static IList<Field98C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field98C> result = new java.util.ArrayList<>(arr.length);
				IList<Field98C> result = new List<Field98C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 98C");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field98C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98C fromJson(final String json)
