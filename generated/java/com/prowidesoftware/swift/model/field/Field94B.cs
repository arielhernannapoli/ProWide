...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field94B extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field94B : Field, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "94B";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_94B = "94B";
		...
		/// </summary>
		public const int? PLACE_CODE = 3;

		/// <summary>
		/// Component number for the Narrative subfield
		/// </summary>
		public const int? NARRATIVE = 4;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field94B() : base(4)
		{
		}
...
//ORIGINAL LINE: public Field94B(final String value)
		public Field94B(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field94B(final com.prowidesoftware.swift.model.Tag tag)
		public Field94B(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "94B"))
			{
				throw new System.ArgumentException("cannot create field 94B from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
	...
	//ORIGINAL LINE: final StringBuilder result = new StringBuilder();
				...
				if (Component4 != null)
				{
					result.Append("/").Append(Component4);
				}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field94B setComponent1(string component1)
		{
		...
		public virtual Field94B setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field94B setComponent2(string component2)
		{
		...
		public virtual Field94B setDataSourceScheme(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Place Code (component3). </summary>
		/// <returns> the Place Code from component3 </returns>
		...
		public virtual Field94B setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Place Code (component3). </summary>
		/// <param name="component3"> the Place Code to set </param>
		public virtual Field94B setPlaceCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field94B setComponent4(string component4)
		{
		...
		public virtual Field94B setNarrative(string component4)
		{
			setComponent(4, component4);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field94B.NAME </returns>
		...
		/// <returns> the static value of Field94B.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field94B get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field94B in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field94B get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field94B> getAll(final SwiftMessage msg)
		public static IList<Field94B> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field94B> getAll(final SwiftTagListBlock block)
		public static IList<Field94B> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field94B> result = new java.util.ArrayList<>(arr.length);
				IList<Field94B> result = new List<Field94B>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 94B");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field94B object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field94B fromJson(final String json)
		public static Field94B fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("placeCode").AsString;
			}
			if (jsonObject.get("narrative") != null)
			{
				field.Component4 = jsonObject.get("narrative").AsString;
			}
			return field;
		}
