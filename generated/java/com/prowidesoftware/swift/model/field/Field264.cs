...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field264 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field264 : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "264";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_264 = "264";
...
//ORIGINAL LINE: public Field264(final String value)
		public Field264(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field264(final com.prowidesoftware.swift.model.Tag tag)
		public Field264(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "264"))
			{
				throw new System.ArgumentException("cannot create field 264 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field264 setComponent1(string component1)
		{
		...
		public virtual Field264 setLTAddress(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field264 setLTAddress(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
		...
		public virtual Field264 setComponent2(string component2)
		{
		...
		public virtual Field264 setComponent2(DateTime component2)
		{
		...
		public virtual Field264 setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field264 setDate(DateTime component2)
		{
		...
		public virtual Field264 setComponent3(string component3)
		{
		...
		public virtual Field264 setStartTime(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field264 setStartTime(DateTime component3)
		{
		...
		public virtual Field264 setComponent4(string component4)
		{
		...
		public virtual Field264 setComponent4(DateTime component4)
		{
		...
		public virtual Field264 setEndTime(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field264 setEndTime(DateTime component4)
		{
		...
		public virtual Field264 setComponent5(string component5)
		{
		...
		public virtual Field264 setComponent5(java.lang.Number component5)
		{
			if (component5 != null)
			{
		...
		public virtual Field264 setSessionNumber(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		public virtual Field264 setSessionNumber(java.lang.Number component5)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field264.NAME </returns>
		...
		/// <returns> the static value of Field264.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field264 get(final SwiftTagListBlock block)
		public static Field264 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field264 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field264 get(final SwiftMessage msg)
		public static Field264 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field264> getAll(final SwiftMessage msg)
		public static IList<Field264> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field264> getAll(final SwiftTagListBlock block)
		public static IList<Field264> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field264> result = new java.util.ArrayList<>(arr.length);
				IList<Field264> result = new List<Field264>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 264");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field264 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field264 fromJson(final String json)
		public static Field264 fromJson(string json)
		{
