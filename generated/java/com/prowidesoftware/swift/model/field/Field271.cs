...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field271 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field271 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "271";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_271 = "271";
		...
		/// </summary>
		public const int? LOGOUT_BLOCK = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field271() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field271(final String value)
		public Field271(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field271(final com.prowidesoftware.swift.model.Tag tag)
		public Field271(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "271"))
			{
				throw new System.ArgumentException("cannot create field 271 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field271 setComponent1(string component1)
		{
		...
		public virtual Field271 setComponent1(DateTime component1)
		{
		...
		public virtual Field271 setTimestamp(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field271 setTimestamp(DateTime component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Logout Block (component2). </summary>
		/// <returns> the Logout Block from component2 </returns>
		public virtual string LogoutBlock
		{
			get
			{
				return getComponent(2);
		...
		public virtual Field271 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Logout Block (component2). </summary>
		/// <param name="component2"> the Logout Block to set </param>
		public virtual Field271 setLogoutBlock(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field271.NAME </returns>
		...
		/// <returns> the static value of Field271.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field271 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field271 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field271 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field271> getAll(final SwiftMessage msg)
		public static IList<Field271> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field271> getAll(final SwiftTagListBlock block)
		public static IList<Field271> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field271> result = new java.util.ArrayList<>(arr.length);
				IList<Field271> result = new List<Field271>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 271");
			}
			if (component == 1)
			{
				//date + time
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "timestamp";
				result[2] = "logoutBlock";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field271 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field271 fromJson(final String json)
		public static Field271 fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("logoutBlock").AsString;
			}
			return field;
		}
