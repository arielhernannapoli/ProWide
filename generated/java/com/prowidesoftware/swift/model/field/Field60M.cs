...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field60M extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field60M : Field, DateContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "60M";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_60M = "60M";
		public const string PARSER_PATTERN = "[c]<DATE2>SN";
		public const string COMPONENTS_PATTERN = "SECN";
...
//ORIGINAL LINE: public Field60M(final String value)
		public Field60M(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field60M(final com.prowidesoftware.swift.model.Tag tag)
		public Field60M(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "60M"))
			{
				throw new System.ArgumentException("cannot create field 60M from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field60M setComponent1(string component1)
		{
		...
		public virtual Field60M setDCMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field60M setComponent2(string component2)
		{
		...
		public virtual Field60M setComponent2(DateTime component2)
		{
		...
		public virtual Field60M setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field60M setDate(DateTime component2)
		{
		...
		public virtual Field60M setComponent3(string component3)
		{
		...
		public virtual Field60M setComponent3(java.util.Currency component3)
		{
		...
		public virtual Field60M setCurrency(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field60M setCurrency(java.util.Currency component3)
		{
		...
		public virtual Field60M setComponent4(string component4)
		{
		...
		public virtual Field60M setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field60M setAmount(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field60M setAmount(java.lang.Number component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field60M.NAME </returns>
		...
		/// <returns> the static value of Field60M.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field60M get(final SwiftTagListBlock block)
		public static Field60M get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field60M in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field60M get(final SwiftMessage msg)
		public static Field60M get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field60M> getAll(final SwiftMessage msg)
		public static IList<Field60M> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field60M> getAll(final SwiftTagListBlock block)
		public static IList<Field60M> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field60M> result = new java.util.ArrayList<>(arr.length);
				IList<Field60M> result = new List<Field60M>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 60M");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field60M object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field60M fromJson(final String json)
		public static Field60M fromJson(string json)
		{
