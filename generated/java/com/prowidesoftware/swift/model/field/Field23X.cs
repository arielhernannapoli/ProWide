...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field23X extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field23X : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "23X";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_23X = "23X";
		...
		/// </summary>
		public const int? FILE_NAME_OR_REFERENCE = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field23X() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field23X(final String value)
		public Field23X(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field23X(final com.prowidesoftware.swift.model.Tag tag)
		public Field23X(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "23X"))
			{
				throw new System.ArgumentException("cannot create field 23X from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field23X setComponent1(string component1)
		{
		...
		public virtual Field23X setCode(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the File Name Or Reference (component2). </summary>
		/// <returns> the File Name Or Reference from component2 </returns>
		public virtual string FileNameOrReference
		{
			get
			{
				return getComponent(2);
		...
		public virtual Field23X setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the File Name Or Reference (component2). </summary>
		/// <param name="component2"> the File Name Or Reference to set </param>
		public virtual Field23X setFileNameOrReference(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field23X.NAME </returns>
		...
		/// <returns> the static value of Field23X.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field23X get(final SwiftTagListBlock block)
		public static Field23X get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field23X in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field23X get(final SwiftMessage msg)
		public static Field23X get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field23X> getAll(final SwiftMessage msg)
		public static IList<Field23X> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field23X> getAll(final SwiftTagListBlock block)
		public static IList<Field23X> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field23X> result = new java.util.ArrayList<>(arr.length);
				IList<Field23X> result = new List<Field23X>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 23X");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "code";
				result[2] = "fileNameOrReference";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field23X object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field23X fromJson(final String json)
