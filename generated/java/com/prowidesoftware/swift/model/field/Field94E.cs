...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field94E extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.GenericField, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field94E : Field, com.prowidesoftware.swift.model.field.GenericField, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "94E";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_94E = "94E";
...
//ORIGINAL LINE: public Field94E(final String value)
		public Field94E(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field94E(final com.prowidesoftware.swift.model.Tag tag)
		public Field94E(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "94E"))
			{
				throw new System.ArgumentException("cannot create field 94E from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field94E setComponent1(string component1)
		{
		...
		public virtual Field94E setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Address (component2). </summary>
		/// <returns> the Address from component2 </returns>
		...
		/// <summary>
		/// Gets the Address (component3). </summary>
		/// <returns> the Address from component3 </returns>
		...
		/// <summary>
		/// Gets the Address (component4). </summary>
		/// <returns> the Address from component4 </returns>
		...
		/// <summary>
		/// Gets the Address (component5). </summary>
		/// <returns> the Address from component5 </returns>
		...
		/// <summary>
		/// Gets the Address (component6). </summary>
		/// <returns> the Address from component6 </returns>
		...
		/// <summary>
		/// Gets the Address (component7). </summary>
		/// <returns> the Address from component7 </returns>
		public virtual string AddressLine6
		{
			get
			{
		...
		/// <summary>
		/// Gets the Address (component8). </summary>
		/// <returns> the Address from component8 </returns>
		public virtual string AddressLine7
		{
			get
			{
		...
		/// <summary>
		/// Gets the Address (component9). </summary>
		/// <returns> the Address from component9 </returns>
		public virtual string AddressLine8
		{
			get
			{
		...
		/// <summary>
		/// Gets the Address (component10). </summary>
		/// <returns> the Address from component10 </returns>
		public virtual string AddressLine9
		{
			get
			{
		...
		/// <summary>
		/// Gets the Address (component11). </summary>
		/// <returns> the Address from component11 </returns>
		public virtual string AddressLine10
		{
			get
			{
		...
		/// <summary>
		/// Gets the Address as a concatenation of component2 to component11. </summary>
		/// <returns> the Address from components </returns>
		...
		public virtual Field94E setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Address (component2). </summary>
		/// <param name="component2"> the Address to set </param>
		public virtual Field94E setAddressLine1(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Address (component3). </summary>
		/// <param name="component3"> the Address to set </param>
		public virtual Field94E setAddressLine2(string component3)
		{
		...
		/// <summary>
		/// Set the Address (component4). </summary>
		/// <param name="component4"> the Address to set </param>
		public virtual Field94E setAddressLine3(string component4)
		{
		...
		/// <summary>
		/// Set the Address (component5). </summary>
		/// <param name="component5"> the Address to set </param>
		public virtual Field94E setAddressLine4(string component5)
		{
		...
		/// <summary>
		/// Set the Address (component6). </summary>
		/// <param name="component6"> the Address to set </param>
		public virtual Field94E setAddressLine5(string component6)
		{
		...
		/// <summary>
		/// Set the Address (component7). </summary>
		/// <param name="component7"> the Address to set </param>
		public virtual Field94E setAddressLine6(string component7)
		{
		...
		/// <summary>
		/// Set the Address (component8). </summary>
		/// <param name="component8"> the Address to set </param>
		public virtual Field94E setAddressLine7(string component8)
		{
		...
		/// <summary>
		/// Set the Address (component9). </summary>
		/// <param name="component9"> the Address to set </param>
		public virtual Field94E setAddressLine8(string component9)
		{
		...
		/// <summary>
		/// Set the Address (component10). </summary>
		/// <param name="component10"> the Address to set </param>
		public virtual Field94E setAddressLine9(string component10)
		{
		...
		/// <summary>
		/// Set the Address (component11). </summary>
		/// <param name="component11"> the Address to set </param>
		public virtual Field94E setAddressLine10(string component11)
		{
		...
		/// <summary>
		/// Set the Address splitting the parameter lines into components 2 to 11. </summary>
		/// <param name="value"> the Address to set, may contain line ends and each line will be set to its correspondent component attribute </param>
		public virtual Field94E setAddress(string value)
		{
			IList<string> lines = SwiftParseUtils.getLines(value);
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field94E setComponent3(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field94E setComponent4(string component4)
		{
			setComponent(4, component4);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		public virtual Field94E setComponent5(string component5)
		{
			setComponent(5, component5);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent6AsString()
		...
		public virtual Field94E setComponent6(string component6)
		{
			setComponent(6, component6);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent7AsString()
		...
		public virtual Field94E setComponent7(string component7)
		{
			setComponent(7, component7);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent8AsString()
		...
		public virtual Field94E setComponent8(string component8)
		{
			setComponent(8, component8);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent9AsString()
		...
		public virtual Field94E setComponent9(string component9)
		{
			setComponent(9, component9);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent10AsString()
		...
		public virtual Field94E setComponent10(string component10)
		{
			setComponent(10, component10);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent11AsString()
		...
		public virtual Field94E setComponent11(string component11)
		{
			setComponent(11, component11);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field94E.NAME </returns>
		...
		/// <returns> the static value of Field94E.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field94E get(final SwiftTagListBlock block)
		public static Field94E get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field94E in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field94E get(final SwiftMessage msg)
		public static Field94E get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field94E> getAll(final SwiftMessage msg)
		public static IList<Field94E> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field94E> getAll(final SwiftTagListBlock block)
		public static IList<Field94E> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field94E> result = new java.util.ArrayList<>(arr.length);
				IList<Field94E> result = new List<Field94E>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 94E");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field94E object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field94E fromJson(final String json)
		public static Field94E fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("address").AsString;
			}
			if (jsonObject.get("address2") != null)
			{
				field.Component3 = jsonObject.get("address2").AsString;
			}
			if (jsonObject.get("address3") != null)
			{
				field.Component4 = jsonObject.get("address3").AsString;
			}
			if (jsonObject.get("address4") != null)
			{
				field.Component5 = jsonObject.get("address4").AsString;
			}
			if (jsonObject.get("address5") != null)
			{
				field.Component6 = jsonObject.get("address5").AsString;
			}
			if (jsonObject.get("address6") != null)
			{
				field.Component7 = jsonObject.get("address6").AsString;
			}
			if (jsonObject.get("address7") != null)
			{
				field.Component8 = jsonObject.get("address7").AsString;
			}
			if (jsonObject.get("address8") != null)
			{
				field.Component9 = jsonObject.get("address8").AsString;
			}
			if (jsonObject.get("address9") != null)
			{
				field.Component10 = jsonObject.get("address9").AsString;
			}
			if (jsonObject.get("address10") != null)
			{
				field.Component11 = jsonObject.get("address10").AsString;
			}
			return field;
		}
