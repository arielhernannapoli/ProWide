...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field433 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field433 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "433";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_433 = "433";
		...
		/// </summary>
		public const int? SCREENING_RESULTS = 1;
...
//ORIGINAL LINE: public Field433(final String value)
		public Field433(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field433(final com.prowidesoftware.swift.model.Tag tag)
		public Field433(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "433"))
			{
				throw new System.ArgumentException("cannot create field 433 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Screening Results (component1). </summary>
		/// <returns> the Screening Results from component1 </returns>
		public virtual string ScreeningResults
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field433 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Screening Results (component1). </summary>
		/// <param name="component1"> the Screening Results to set </param>
		public virtual Field433 setScreeningResults(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Additional Information (component2). </summary>
		/// <returns> the Additional Information from component2 </returns>
		...
		public virtual Field433 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Additional Information (component2). </summary>
		/// <param name="component2"> the Additional Information to set </param>
		public virtual Field433 setAdditionalInformation(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field433.NAME </returns>
		...
		/// <returns> the static value of Field433.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field433 get(final SwiftTagListBlock block)
		public static Field433 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field433 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field433 get(final SwiftMessage msg)
		public static Field433 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field433> getAll(final SwiftMessage msg)
		public static IList<Field433> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field433> getAll(final SwiftTagListBlock block)
		public static IList<Field433> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field433> result = new java.util.ArrayList<>(arr.length);
				IList<Field433> result = new List<Field433>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 433");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "screeningResults";
				result[2] = "additionalInformation";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field433 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field433 fromJson(final String json)
		public static Field433 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("screeningResults").AsString;
			}
