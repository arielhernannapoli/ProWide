...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field206 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field206 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "206";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_206 = "206";
		...
		/// </summary>
		public const int? VALUE_DATE_ORDERING = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field206() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field206(final String value)
		public Field206(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field206(final com.prowidesoftware.swift.model.Tag tag)
		public Field206(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "206"))
			{
				throw new System.ArgumentException("cannot create field 206 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Value Date Ordering (component1). </summary>
		/// <returns> the Value Date Ordering from component1 </returns>
		public virtual string getValueDateOrdering()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Value Date Ordering (component1) as Boolean </summary>
		/// <returns> the Value Date Ordering from component1 converted to Boolean or null if cannot be converted </returns>
		public virtual bool? ValueDateOrderingAsBoolean
		{
			get
			{
				return SwiftFormatUtils.getBoolean(getComponent(1));
		...
		public virtual Field206 setComponent1(string component1)
		{
		...
		public virtual Field206 setComponent1(bool? component1)
		{
		...
		/// <summary>
		/// Set the Value Date Ordering (component1). </summary>
		/// <param name="component1"> the Value Date Ordering to set </param>
		public virtual Field206 setValueDateOrdering(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Value Date Ordering (component1) from a Boolean object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Boolean) </seealso>
		/// <param name="component1"> Boolean with the Value Date Ordering content to set </param>
		public virtual Field206 setValueDateOrdering(bool? component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field206.NAME </returns>
		...
		/// <returns> the static value of Field206.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field206 get(final SwiftTagListBlock block)
		public static Field206 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field206 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field206 get(final SwiftMessage msg)
		public static Field206 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field206> getAll(final SwiftMessage msg)
		public static IList<Field206> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field206> getAll(final SwiftTagListBlock block)
		public static IList<Field206> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field206> result = new java.util.ArrayList<>(arr.length);
				IList<Field206> result = new List<Field206>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 206");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "valueDateOrdering";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field206 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field206 fromJson(final String json)
		public static Field206 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("valueDateOrdering").AsString);
			}
			return field;
		}
