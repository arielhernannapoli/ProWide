...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field35B extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field35B : Field, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "35B";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_35B = "35B";
		public const string PARSER_PATTERN = "[<ISIN><SPACE>S][$S]0-4";
		...
		/// </summary>
		public const int? ISIN_Renamed = 2;
...
//ORIGINAL LINE: public Field35B(final String value)
		public Field35B(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field35B(final com.prowidesoftware.swift.model.Tag tag)
		public Field35B(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "35B"))
			{
				throw new System.ArgumentException("cannot create field 35B from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (lines.Count > 0 && StringUtils.StartsWith(lines[0], "ISIN "))
			{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field35B setComponent1(string component1)
		{
		...
		public virtual Field35B setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the ISIN (component2). </summary>
		/// <returns> the ISIN from component2 </returns>
		...
		public virtual Field35B setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the ISIN (component2). </summary>
		/// <param name="component2"> the ISIN to set </param>
		public virtual Field35B setISIN(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Description (component3). </summary>
		/// <returns> the Description from component3 </returns>
		...
		/// <summary>
		/// Gets the Description (component4). </summary>
		/// <returns> the Description from component4 </returns>
		...
		/// <summary>
		/// Gets the Description (component5). </summary>
		/// <returns> the Description from component5 </returns>
		public virtual string DescriptionLine3
		{
			get
			{
		...
		/// <summary>
		/// Gets the Description (component6). </summary>
		/// <returns> the Description from component6 </returns>
		public virtual string DescriptionLine4
		{
			get
			{
		...
		/// <summary>
		/// Gets the Description as a concatenation of component3 to component6. </summary>
		/// <returns> the Description from components </returns>
		...
		public virtual Field35B setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Description (component3). </summary>
		/// <param name="component3"> the Description to set </param>
		public virtual Field35B setDescriptionLine1(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Description (component4). </summary>
		/// <param name="component4"> the Description to set </param>
		public virtual Field35B setDescriptionLine2(string component4)
		{
		...
		/// <summary>
		/// Set the Description (component5). </summary>
		/// <param name="component5"> the Description to set </param>
		public virtual Field35B setDescriptionLine3(string component5)
		{
		...
		/// <summary>
		/// Set the Description (component6). </summary>
		/// <param name="component6"> the Description to set </param>
		public virtual Field35B setDescriptionLine4(string component6)
		{
		...
		/// <summary>
		/// Set the Description splitting the parameter lines into components 3 to 6. </summary>
		/// <param name="value"> the Description to set, may contain line ends and each line will be set to its correspondent component attribute </param>
		public virtual Field35B setDescription(string value)
		{
			IList<string> lines = SwiftParseUtils.getLines(value);
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field35B setComponent4(string component4)
		{
			setComponent(4, component4);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		public virtual Field35B setComponent5(string component5)
		{
			setComponent(5, component5);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent6AsString()
		...
		public virtual Field35B setComponent6(string component6)
		{
			setComponent(6, component6);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field35B.NAME </returns>
		...
		/// <returns> the static value of Field35B.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35B get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field35B in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35B get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field35B> getAll(final SwiftMessage msg)
		public static IList<Field35B> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field35B> getAll(final SwiftTagListBlock block)
		public static IList<Field35B> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field35B> result = new java.util.ArrayList<>(arr.length);
				IList<Field35B> result = new List<Field35B>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 35B");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[4] = "description2";
				result[5] = "description3";
				result[6] = "description4";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field35B object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35B fromJson(final String json)
		public static Field35B fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("iSIN").AsString;
			}
			if (jsonObject.get("description") != null)
			{
				field.Component3 = jsonObject.get("description").AsString;
			}
			if (jsonObject.get("description2") != null)
			{
				field.Component4 = jsonObject.get("description2").AsString;
			}
			if (jsonObject.get("description3") != null)
			{
				field.Component5 = jsonObject.get("description3").AsString;
			}
			if (jsonObject.get("description4") != null)
			{
				field.Component6 = jsonObject.get("description4").AsString;
			}
			return field;
		}
		 ...
		 */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deprecated @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public static final Integer IDENTIFICATION = 2;
		[Obsolete]
		public const int? IDENTIFICATION = 2;
