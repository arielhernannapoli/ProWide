...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field59A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field59A : Field, BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "59A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_59A = "59A";
...
//ORIGINAL LINE: public Field59A(final String value)
		public Field59A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field59A(final com.prowidesoftware.swift.model.Tag tag)
		public Field59A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "59A"))
			{
				throw new System.ArgumentException("cannot create field 59A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field59A setComponent1(string component1)
		{
		...
		public virtual Field59A setAccount(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field59A setComponent2(string component2)
		{
		...
		public virtual Field59A setComponent2(BIC component2)
		{
		...
		public virtual Field59A setBIC(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field59A setBIC(BIC component2)
		{
...
//ORIGINAL LINE: final java.util.List<String> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field59A.NAME </returns>
		...
		/// <returns> the static value of Field59A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field59A get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field59A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field59A get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field59A> getAll(final SwiftMessage msg)
		public static IList<Field59A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field59A> getAll(final SwiftTagListBlock block)
		public static IList<Field59A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field59A> result = new java.util.ArrayList<>(arr.length);
				IList<Field59A> result = new List<Field59A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 59A");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field59A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field59A fromJson(final String json)
