...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field60F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field60F : Field, DateContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "60F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_60F = "60F";
...
//ORIGINAL LINE: public Field60F(final String value)
		public Field60F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field60F(final com.prowidesoftware.swift.model.Tag tag)
		public Field60F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "60F"))
			{
				throw new System.ArgumentException("cannot create field 60F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field60F setComponent1(string component1)
		{
		...
		public virtual Field60F setDCMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field60F setComponent2(string component2)
		{
		...
		public virtual Field60F setComponent2(DateTime component2)
		{
		...
		public virtual Field60F setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field60F setDate(DateTime component2)
		{
		...
		public virtual Field60F setComponent3(string component3)
		{
		...
		public virtual Field60F setComponent3(java.util.Currency component3)
		{
		...
		public virtual Field60F setCurrency(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field60F setCurrency(java.util.Currency component3)
		{
		...
		public virtual Field60F setComponent4(string component4)
		{
		...
		public virtual Field60F setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field60F setAmount(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field60F setAmount(java.lang.Number component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field60F.NAME </returns>
		...
		/// <returns> the static value of Field60F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field60F get(final SwiftTagListBlock block)
		public static Field60F get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field60F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field60F get(final SwiftMessage msg)
		public static Field60F get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field60F> getAll(final SwiftMessage msg)
		public static IList<Field60F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field60F> getAll(final SwiftTagListBlock block)
		public static IList<Field60F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field60F> result = new java.util.ArrayList<>(arr.length);
				IList<Field60F> result = new List<Field60F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 60F");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field60F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field60F fromJson(final String json)
		public static Field60F fromJson(string json)
		{
