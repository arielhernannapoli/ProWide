...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field92H extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	...
	public class Field92H : Field, CurrencyContainer, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		...
		/// </summary>
		public const string NAME = "92H";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_92H = "92H";
		public const string PARSER_PATTERN = ":S//SN/S";
		public const string COMPONENTS_PATTERN = "SCNS";
...
//ORIGINAL LINE: public Field92H(final String value)
		public Field92H(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field92H(final com.prowidesoftware.swift.model.Tag tag)
		public Field92H(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "92H"))
			{
				throw new System.ArgumentException("cannot create field 92H from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field92H setComponent1(string component1)
		{
		...
		public virtual Field92H setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field92H setComponent2(string component2)
		{
		...
		public virtual Field92H setComponent2(Currency component2)
		{
		...
		public virtual Field92H setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field92H setCurrency(Currency component2)
		{
		...
		public virtual Field92H setComponent3(string component3)
		{
		...
		public virtual Field92H setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field92H setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field92H setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field92H setComponent4(string component4)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field92H.NAME </returns>
		...
		/// <returns> the static value of Field92H.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92H get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field92H in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92H get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92H> getAll(final SwiftMessage msg)
		public static IList<Field92H> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92H> getAll(final SwiftTagListBlock block)
		public static IList<Field92H> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field92H> result = new java.util.ArrayList<>(arr.length);
				IList<Field92H> result = new List<Field92H>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 92H");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field92H object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92H fromJson(final String json)
		public static Field92H fromJson(string json)
		{
			...
			{
				field.Component4 = jsonObject.get("?").AsString;
			}
			return field;
		}
