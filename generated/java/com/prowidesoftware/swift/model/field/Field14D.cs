...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field14D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field14D : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "14D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_14D = "14D";
		...
		/// </summary>
		public const int? DAY_COUNT_FRACTION = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field14D() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field14D(final String value)
		public Field14D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field14D(final com.prowidesoftware.swift.model.Tag tag)
		public Field14D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "14D"))
			{
				throw new System.ArgumentException("cannot create field 14D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Day Count Fraction (component1). </summary>
		/// <returns> the Day Count Fraction from component1 </returns>
		public virtual string DayCountFraction
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field14D setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Day Count Fraction (component1). </summary>
		/// <param name="component1"> the Day Count Fraction to set </param>
		public virtual Field14D setDayCountFraction(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field14D.NAME </returns>
		...
		/// <returns> the static value of Field14D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14D get(final SwiftTagListBlock block)
		public static Field14D get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field14D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14D get(final SwiftMessage msg)
		public static Field14D get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field14D> getAll(final SwiftMessage msg)
		public static IList<Field14D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field14D> getAll(final SwiftTagListBlock block)
		public static IList<Field14D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field14D> result = new java.util.ArrayList<>(arr.length);
				IList<Field14D> result = new List<Field14D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 14D");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "dayCountFraction";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field14D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14D fromJson(final String json)
		public static Field14D fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("dayCountFraction").AsString;
			}
			return field;
		}
