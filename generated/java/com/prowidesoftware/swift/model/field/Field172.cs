...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field172 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field172 : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "172";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_172 = "172";
		public const string PARSER_PATTERN = "<DATE1><DATE1>";
		public const string COMPONENTS_PATTERN = "JJ";
		...
		/// </summary>
		public const int? END_DATE = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field172() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field172(final String value)
		public Field172(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field172(final com.prowidesoftware.swift.model.Tag tag)
		public Field172(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "172"))
			{
				throw new System.ArgumentException("cannot create field 172 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 4)
				{
					setComponent2(StringUtils.Substring(value, 4 - value));
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Start Date (component1). </summary>
		/// <returns> the Start Date from component1 </returns>
		...
		/// <summary>
		/// Get the Start Date (component1) as Calendar </summary>
		/// <returns> the Start Date from component1 converted to Calendar or null if cannot be converted </returns>
		...
		public virtual Field172 setComponent1(string component1)
		{
		...
		public virtual Field172 setComponent1(DateTime component1)
		{
		...
		/// <summary>
		/// Set the Start Date (component1). </summary>
		/// <param name="component1"> the Start Date to set </param>
		public virtual Field172 setStartDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Start Date (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Start Date content to set </param>
		public virtual Field172 setStartDate(DateTime component1)
		{
		...
		/// <summary>
		/// Gets the End Date (component2). </summary>
		/// <returns> the End Date from component2 </returns>
		...
		/// <summary>
		/// Get the End Date (component2) as Calendar </summary>
		/// <returns> the End Date from component2 converted to Calendar or null if cannot be converted </returns>
		...
		public virtual Field172 setComponent2(string component2)
		{
		...
		public virtual Field172 setComponent2(DateTime component2)
		{
		...
		/// <summary>
		/// Set the End Date (component2). </summary>
		/// <param name="component2"> the End Date to set </param>
		public virtual Field172 setEndDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the End Date (component2) from a Calendar object. </summary>
		/// <seealso cref= #setComponent2(java.util.Calendar) </seealso>
		/// <param name="component2"> Calendar with the End Date content to set </param>
		public virtual Field172 setEndDate(DateTime component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field172.NAME </returns>
		...
		/// <returns> the static value of Field172.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field172 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field172 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field172 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field172> getAll(final SwiftMessage msg)
		public static IList<Field172> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field172> getAll(final SwiftTagListBlock block)
		public static IList<Field172> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field172> result = new java.util.ArrayList<>(arr.length);
				IList<Field172> result = new List<Field172>(arr.Length);
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field172 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field172 fromJson(final String json)
		public static Field172 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("startDate").AsString);
			}
			if (jsonObject.get("endDate") != null)
			{
				field.setComponent2(jsonObject.get("endDate").AsString);
			}
			return field;
		}
