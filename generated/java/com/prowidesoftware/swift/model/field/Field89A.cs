...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field89A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field89A : Field, BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "89A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_89A = "89A";
		public const string PARSER_PATTERN = "[[/c][/S]$]S";
		public const string COMPONENTS_PATTERN = "SSB";
...
//ORIGINAL LINE: public Field89A(final String value)
		public Field89A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field89A(final com.prowidesoftware.swift.model.Tag tag)
		public Field89A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "89A"))
			{
				throw new System.ArgumentException("cannot create field 89A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (lines[0].StartsWith("/", StringComparison.Ordinal))
			{
				...
				if (lines.Count > 1)
				{
					setComponent3(lines[1]);
				}
			}
			else
			{
				setComponent3(lines[0]);
			}
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field89A setComponent1(string component1)
		{
		...
		public virtual Field89A setDCMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field89A setComponent2(string component2)
		{
		...
		public virtual Field89A setAccount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Get the component3 as BIC </summary>
		/// <returns> the component3 converted to BIC or null if cannot be converted </returns>
		public virtual BIC Component3AsBIC
		{
			get
			{
		...
		/// <summary>
		/// Gets the BIC (component3). </summary>
		/// <returns> the BIC from component3 </returns>
		...
		/// <summary>
		/// Get the BIC (component3) as BIC </summary>
		/// <returns> the BIC from component3 converted to BIC or null if cannot be converted </returns>
		...
		public virtual Field89A setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the component3 from a BIC object. </summary>
		/// <param name="component3"> the BIC with the component3 content to set </param>
		public virtual Field89A setComponent3(BIC component3)
		{
		...
		/// <summary>
		/// Set the BIC (component3). </summary>
		/// <param name="component3"> the BIC to set </param>
		public virtual Field89A setBIC(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the BIC (component3) from a BIC object. </summary>
		/// <seealso cref= #setComponent3(com.prowidesoftware.swift.model.BIC) </seealso>
		/// <param name="component3"> BIC with the BIC content to set </param>
		public virtual Field89A setBIC(BIC component3)
		{
...
//ORIGINAL LINE: final java.util.List<String> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field89A.NAME </returns>
		...
		/// <returns> the static value of Field89A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field89A get(final SwiftTagListBlock block)
		public static Field89A get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field89A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field89A get(final SwiftMessage msg)
		public static Field89A get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field89A> getAll(final SwiftMessage msg)
		public static IList<Field89A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field89A> getAll(final SwiftTagListBlock block)
		public static IList<Field89A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field89A> result = new java.util.ArrayList<>(arr.length);
				IList<Field89A> result = new List<Field89A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 89A");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field89A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field89A fromJson(final String json)
		public static Field89A fromJson(string json)
		{
			...
			{
				field.setComponent3(jsonObject.get("bIC").AsString);
			}
			return field;
		}
