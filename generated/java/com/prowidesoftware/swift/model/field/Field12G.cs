...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field12G extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field12G : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "12G";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_12G = "12G";
		...
		/// </summary>
		public const int? EARLY_TERMINATION__STYLE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field12G() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field12G(final String value)
		public Field12G(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field12G(final com.prowidesoftware.swift.model.Tag tag)
		public Field12G(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "12G"))
			{
				throw new System.ArgumentException("cannot create field 12G from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Early Termination  Style (component1). </summary>
		/// <returns> the Early Termination  Style from component1 </returns>
		public virtual string EarlyTerminationStyle
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field12G setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Early Termination  Style (component1). </summary>
		/// <param name="component1"> the Early Termination  Style to set </param>
		public virtual Field12G setEarlyTerminationStyle(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field12G.NAME </returns>
		...
		/// <returns> the static value of Field12G.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12G get(final SwiftTagListBlock block)
		public static Field12G get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field12G in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12G get(final SwiftMessage msg)
		public static Field12G get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12G> getAll(final SwiftMessage msg)
		public static IList<Field12G> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12G> getAll(final SwiftTagListBlock block)
		public static IList<Field12G> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field12G> result = new java.util.ArrayList<>(arr.length);
				IList<Field12G> result = new List<Field12G>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 12G");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "earlyTerminationStyle";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field12G object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12G fromJson(final String json)
		public static Field12G fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("earlyTerminationStyle").AsString;
			}
			return field;
		}
