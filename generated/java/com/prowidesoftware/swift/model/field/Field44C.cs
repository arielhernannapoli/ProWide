...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field44C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field44C : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "44C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_44C = "44C";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "E";
...
//ORIGINAL LINE: public Field44C(final String value)
		public Field44C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field44C(final com.prowidesoftware.swift.model.Tag tag)
		public Field44C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "44C"))
			{
				throw new System.ArgumentException("cannot create field 44C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field44C setComponent1(string component1)
		{
		...
		public virtual Field44C setComponent1(DateTime component1)
		{
		...
		public virtual Field44C setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field44C setDate(DateTime component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field44C.NAME </returns>
		...
		/// <returns> the static value of Field44C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field44C get(final SwiftTagListBlock block)
		public static Field44C get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field44C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field44C get(final SwiftMessage msg)
		public static Field44C get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field44C> getAll(final SwiftMessage msg)
		public static IList<Field44C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field44C> getAll(final SwiftTagListBlock block)
		public static IList<Field44C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field44C> result = new java.util.ArrayList<>(arr.length);
				IList<Field44C> result = new List<Field44C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 44C");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field44C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field44C fromJson(final String json)
		public static Field44C fromJson(string json)
		{
