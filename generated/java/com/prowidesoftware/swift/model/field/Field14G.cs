...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field14G extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field14G : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "14G";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_14G = "14G";
...
//ORIGINAL LINE: public Field14G(final String value)
		public Field14G(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field14G(final com.prowidesoftware.swift.model.Tag tag)
		public Field14G(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "14G"))
			{
				throw new System.ArgumentException("cannot create field 14G from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Frequency (component1). </summary>
		/// <returns> the Frequency from component1 </returns>
		...
		public virtual Field14G setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Frequency (component1). </summary>
		/// <param name="component1"> the Frequency to set </param>
		public virtual Field14G setFrequency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Method (component2). </summary>
		/// <returns> the Method from component2 </returns>
		...
		public virtual Field14G setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Method (component2). </summary>
		/// <param name="component2"> the Method to set </param>
		public virtual Field14G setMethod(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field14G.NAME </returns>
		...
		/// <returns> the static value of Field14G.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14G get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field14G in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14G get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field14G> getAll(final SwiftMessage msg)
		public static IList<Field14G> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field14G> getAll(final SwiftTagListBlock block)
		public static IList<Field14G> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field14G> result = new java.util.ArrayList<>(arr.length);
				IList<Field14G> result = new List<Field14G>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 14G");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field14G object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14G fromJson(final String json)
		public static Field14G fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("frequency").AsString;
			}
			if (jsonObject.get("method") != null)
			{
				field.Component2 = jsonObject.get("method").AsString;
			}
			return field;
		}
