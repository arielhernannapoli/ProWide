...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field349 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field349 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "349";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_349 = "349";
		...
		/// </summary>
		public const int? COMBINED_CRITERIA = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field349() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field349(final String value)
		public Field349(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field349(final com.prowidesoftware.swift.model.Tag tag)
		public Field349(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "349"))
			{
				throw new System.ArgumentException("cannot create field 349 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Combined Criteria (component1). </summary>
		/// <returns> the Combined Criteria from component1 </returns>
		public virtual string getCombinedCriteria()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Combined Criteria (component1) as Number </summary>
		/// <returns> the Combined Criteria from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number CombinedCriteriaAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field349 setComponent1(string component1)
		{
		...
		public virtual Field349 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Combined Criteria (component1). </summary>
		/// <param name="component1"> the Combined Criteria to set </param>
		public virtual Field349 setCombinedCriteria(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Combined Criteria (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Combined Criteria content to set </param>
		public virtual Field349 setCombinedCriteria(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field349.NAME </returns>
		...
		/// <returns> the static value of Field349.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field349 get(final SwiftTagListBlock block)
		public static Field349 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field349 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field349 get(final SwiftMessage msg)
		public static Field349 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field349> getAll(final SwiftMessage msg)
		public static IList<Field349> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field349> getAll(final SwiftTagListBlock block)
		public static IList<Field349> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field349> result = new java.util.ArrayList<>(arr.length);
				IList<Field349> result = new List<Field349>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 349");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "combinedCriteria";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field349 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field349 fromJson(final String json)
		public static Field349 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("combinedCriteria").AsString);
			}
			return field;
		}
