...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field92R extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field92R : Field, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "92R";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_92R = "92R";
...
//ORIGINAL LINE: public Field92R(final String value)
		public Field92R(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field92R(final com.prowidesoftware.swift.model.Tag tag)
		public Field92R(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "92R"))
			{
				throw new System.ArgumentException("cannot create field 92R from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field92R setComponent1(string component1)
		{
		...
		public virtual Field92R setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field92R setComponent2(string component2)
		{
		...
		public virtual Field92R setDataSourceScheme(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field92R setComponent3(string component3)
		{
		...
		public virtual Field92R setCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field92R setComponent4(string component4)
		{
		...
		public virtual Field92R setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field92R setAmount(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field92R setAmount(java.lang.Number component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field92R.NAME </returns>
		...
		/// <returns> the static value of Field92R.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92R get(final SwiftTagListBlock block)
		public static Field92R get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field92R in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92R get(final SwiftMessage msg)
		public static Field92R get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92R> getAll(final SwiftMessage msg)
		public static IList<Field92R> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92R> getAll(final SwiftTagListBlock block)
		public static IList<Field92R> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field92R> result = new java.util.ArrayList<>(arr.length);
				IList<Field92R> result = new List<Field92R>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 92R");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field92R object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92R fromJson(final String json)
		public static Field92R fromJson(string json)
		{
