...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field98D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field98D : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "98D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_98D = "98D";
		public const string PARSER_PATTERN = "<DATE4><TIME2>[,S][/[c]<TIME3>]";
		public const string COMPONENTS_PATTERN = "DTNCW";
		...
		/// </summary>
		public const int? UTC_INDICATOR = 5;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field98D() : base(5)
		{
		}
...
//ORIGINAL LINE: public Field98D(final String value)
		public Field98D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field98D(final com.prowidesoftware.swift.model.Tag tag)
		public Field98D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "98D"))
			{
				throw new System.ArgumentException("cannot create field 98D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 14)
				{
					string toparse2 = StringUtils.Substring(value, 14 - value);
					...
					if (toparse3 != null)
					{
						...
						else if (toparse3.Length == 3 || toparse3.Length == 5)
						{
							...
							setComponent5(StringUtils.Substring(toparse3, 1 - toparse3));
						}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field98D setComponent1(string component1)
		{
		...
		public virtual Field98D setComponent1(DateTime component1)
		{
		...
		public virtual Field98D setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field98D setDate(DateTime component1)
		{
		...
		public virtual Field98D setComponent2(string component2)
		{
		...
		public virtual Field98D setComponent2(DateTime component2)
		{
		...
		public virtual Field98D setTime(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field98D setTime(DateTime component2)
		{
		...
		/// <summary>
		/// Gets the Decimals (component3). </summary>
		/// <returns> the Decimals from component3 </returns>
		...
		/// <summary>
		/// Get the Decimals (component3) as Number </summary>
		/// <returns> the Decimals from component3 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field98D setComponent3(string component3)
		{
		...
		public virtual Field98D setComponent3(java.lang.Number component3)
		{
			if (component3 != null)
			{
		...
		/// <summary>
		/// Set the Decimals (component3). </summary>
		/// <param name="component3"> the Decimals to set </param>
		public virtual Field98D setDecimals(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Decimals (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Decimals content to set </param>
		public virtual Field98D setDecimals(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Gets the Sign (component4). </summary>
		/// <returns> the Sign from component4 </returns>
		...
		/// <summary>
		/// Get the Sign (component4) as Currency </summary>
		/// <returns> the Sign from component4 converted to Currency or null if cannot be converted </returns>
		...
		public virtual Field98D setComponent4(string component4)
		{
		...
		public virtual Field98D setComponent4(java.util.Currency component4)
		{
		...
		/// <summary>
		/// Set the Sign (component4). </summary>
		/// <param name="component4"> the Sign to set </param>
		public virtual Field98D setSign(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Set the Sign (component4) from a Currency object. </summary>
		/// <seealso cref= #setComponent4(java.util.Currency) </seealso>
		/// <param name="component4"> Currency with the Sign content to set </param>
		public virtual Field98D setSign(java.util.Currency component4)
		{
		...
		/// <summary>
		/// Gets the UTC Indicator (component5). </summary>
		/// <returns> the UTC Indicator from component5 </returns>
		...
		/// <summary>
		/// Get the UTC Indicator (component5) as Calendar </summary>
		/// <returns> the UTC Indicator from component5 converted to Calendar or null if cannot be converted </returns>
		...
		public virtual Field98D setComponent5(string component5)
		{
		...
		public virtual Field98D setComponent5(DateTime component5)
		{
		...
		/// <summary>
		/// Set the UTC Indicator (component5). </summary>
		/// <param name="component5"> the UTC Indicator to set </param>
		public virtual Field98D setUTCIndicator(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		/// <summary>
		/// Set the UTC Indicator (component5) from a Calendar object. </summary>
		/// <seealso cref= #setComponent5(java.util.Calendar) </seealso>
		/// <param name="component5"> Calendar with the UTC Indicator content to set </param>
		public virtual Field98D setUTCIndicator(DateTime component5)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field98D.NAME </returns>
		...
		/// <returns> the static value of Field98D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98D get(final SwiftTagListBlock block)
		public static Field98D get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field98D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98D get(final SwiftMessage msg)
		public static Field98D get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98D> getAll(final SwiftMessage msg)
		public static IList<Field98D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98D> getAll(final SwiftTagListBlock block)
		public static IList<Field98D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field98D> result = new java.util.ArrayList<>(arr.length);
				IList<Field98D> result = new List<Field98D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 98D");
			}
			if (component == 1)
			{
				//date
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[3] = "decimals";
				result[4] = "sign";
				result[5] = "uTCIndicator";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field98D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98D fromJson(final String json)
		public static Field98D fromJson(string json)
		{
			...
			{
				field.setComponent3(jsonObject.get("decimals").AsString);
			}
			if (jsonObject.get("sign") != null)
			{
				field.setComponent4(jsonObject.get("sign").AsString);
			}
			if (jsonObject.get("uTCIndicator") != null)
			{
				field.setComponent5(jsonObject.get("uTCIndicator").AsString);
			}
			return field;
		}
