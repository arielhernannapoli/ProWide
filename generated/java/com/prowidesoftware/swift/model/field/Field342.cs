...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field342 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field342 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "342";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_342 = "342";
...
//ORIGINAL LINE: public Field342(final String value)
		public Field342(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field342(final com.prowidesoftware.swift.model.Tag tag)
		public Field342(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "342"))
			{
				throw new System.ArgumentException("cannot create field 342 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field342 setComponent1(string component1)
		{
		...
		public virtual Field342 setRegion(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field342 setComponent2(string component2)
		{
		...
		public virtual Field342 setComponent2(DateTime component2)
		{
		...
		public virtual Field342 setTime(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field342 setTime(DateTime component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field342.NAME </returns>
		...
		/// <returns> the static value of Field342.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field342 get(final SwiftTagListBlock block)
		public static Field342 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field342 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field342 get(final SwiftMessage msg)
		public static Field342 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field342> getAll(final SwiftMessage msg)
		public static IList<Field342> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field342> getAll(final SwiftTagListBlock block)
		public static IList<Field342> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field342> result = new java.util.ArrayList<>(arr.length);
				IList<Field342> result = new List<Field342>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 342");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field342 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field342 fromJson(final String json)
		public static Field342 fromJson(string json)
		{
