...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field25P extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field25P : Field, BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "25P";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_25P = "25P";
...
//ORIGINAL LINE: public Field25P(final String value)
		public Field25P(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field25P(final com.prowidesoftware.swift.model.Tag tag)
		public Field25P(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "25P"))
			{
				throw new System.ArgumentException("cannot create field 25P from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field25P setComponent1(string component1)
		{
		...
		public virtual Field25P setAccount(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field25P setComponent2(string component2)
		{
		...
		public virtual Field25P setComponent2(BIC component2)
		{
		...
		public virtual Field25P setBIC(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field25P setBIC(BIC component2)
		{
...
//ORIGINAL LINE: final java.util.List<String> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field25P.NAME </returns>
		...
		/// <returns> the static value of Field25P.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field25P get(final SwiftTagListBlock block)
		public static Field25P get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field25P in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field25P get(final SwiftMessage msg)
		public static Field25P get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field25P> getAll(final SwiftMessage msg)
		public static IList<Field25P> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field25P> getAll(final SwiftTagListBlock block)
		public static IList<Field25P> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field25P> result = new java.util.ArrayList<>(arr.length);
				IList<Field25P> result = new List<Field25P>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 25P");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field25P object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field25P fromJson(final String json)
		public static Field25P fromJson(string json)
		{
