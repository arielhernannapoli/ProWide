...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field144 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field144 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "144";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_144 = "144";
...
//ORIGINAL LINE: public Field144(final String value)
		public Field144(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field144(final com.prowidesoftware.swift.model.Tag tag)
		public Field144(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "144"))
			{
				throw new System.ArgumentException("cannot create field 144 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field144 setComponent1(string component1)
		{
		...
		public virtual Field144 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		public virtual Field144 setStatusCode(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field144.NAME </returns>
		...
		/// <returns> the static value of Field144.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field144 get(final SwiftTagListBlock block)
		public static Field144 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field144 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field144 get(final SwiftMessage msg)
		public static Field144 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field144> getAll(final SwiftMessage msg)
		public static IList<Field144> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field144> getAll(final SwiftTagListBlock block)
		public static IList<Field144> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field144> result = new java.util.ArrayList<>(arr.length);
				IList<Field144> result = new List<Field144>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 144");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field144 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field144 fromJson(final String json)
		public static Field144 fromJson(string json)
		{
