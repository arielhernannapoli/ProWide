...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22R extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22R : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22R";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22R = "22R";
		...
		/// </summary>
		public const int? PRIOR_TRANSACTION_IDENTIFIER = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field22R() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field22R(final String value)
		public Field22R(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22R(final com.prowidesoftware.swift.model.Tag tag)
		public Field22R(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22R"))
			{
				throw new System.ArgumentException("cannot create field 22R from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Prior Transaction Identifier (component1). </summary>
		/// <returns> the Prior Transaction Identifier from component1 </returns>
		public virtual string PriorTransactionIdentifier
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field22R setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Prior Transaction Identifier (component1). </summary>
		/// <param name="component1"> the Prior Transaction Identifier to set </param>
		public virtual Field22R setPriorTransactionIdentifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22R.NAME </returns>
		...
		/// <returns> the static value of Field22R.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22R get(final SwiftTagListBlock block)
		public static Field22R get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22R in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22R get(final SwiftMessage msg)
		public static Field22R get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22R> getAll(final SwiftMessage msg)
		public static IList<Field22R> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22R> getAll(final SwiftTagListBlock block)
		public static IList<Field22R> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22R> result = new java.util.ArrayList<>(arr.length);
				IList<Field22R> result = new List<Field22R>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22R");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "priorTransactionIdentifier";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field22R object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22R fromJson(final String json)
		public static Field22R fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("priorTransactionIdentifier").AsString;
			}
			return field;
		}
