...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field29L extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field29L : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "29L";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_29L = "29L";
...
//ORIGINAL LINE: public Field29L(final String value)
		public Field29L(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field29L(final com.prowidesoftware.swift.model.Tag tag)
		public Field29L(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "29L"))
			{
				throw new System.ArgumentException("cannot create field 29L from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field29L setComponent1(string component1)
		{
		...
		public virtual Field29L setComponent1(DateTime component1)
		{
		...
		public virtual Field29L setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field29L setDate(DateTime component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field29L setComponent2(string component2)
		{
		...
		public virtual Field29L setLocation(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field29L setComponent3(string component3)
		{
		...
		public virtual Field29L setComponent3(DateTime component3)
		{
		...
		public virtual Field29L setTime(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field29L setTime(DateTime component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field29L.NAME </returns>
		...
		/// <returns> the static value of Field29L.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29L get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field29L in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29L get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field29L> getAll(final SwiftMessage msg)
		public static IList<Field29L> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field29L> getAll(final SwiftTagListBlock block)
		public static IList<Field29L> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field29L> result = new java.util.ArrayList<>(arr.length);
				IList<Field29L> result = new List<Field29L>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 29L");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field29L object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29L fromJson(final String json)
