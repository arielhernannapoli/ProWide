...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field98G extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field98G : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "98G";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_98G = "98G";
		...
		/// </summary>
		public const int? N_Renamed = 4;

		/// <summary>
		/// Component number for the Time 2 subfield
		/// </summary>
		public const int? TIME_2 = 5;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field98G() : base(5)
		{
		}
...
//ORIGINAL LINE: public Field98G(final String value)
		public Field98G(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field98G(final com.prowidesoftware.swift.model.Tag tag)
		public Field98G(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "98G"))
			{
				throw new System.ArgumentException("cannot create field 98G from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field98G setComponent1(string component1)
		{
		...
		public virtual Field98G setComponent1(DateTime component1)
		{
		...
		public virtual Field98G setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field98G setDate(DateTime component1)
		{
		...
		public virtual Field98G setComponent2(string component2)
		{
		...
		public virtual Field98G setComponent2(DateTime component2)
		{
		...
		public virtual Field98G setTime(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field98G setTime(DateTime component2)
		{
		...
		/// <summary>
		/// Gets the Number (component3). </summary>
		/// <returns> the Number from component3 </returns>
		...
		/// <summary>
		/// Get the Number (component3) as Number </summary>
		/// <returns> the Number from component3 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field98G setComponent3(string component3)
		{
		...
		public virtual Field98G setComponent3(java.lang.Number component3)
		{
			if (component3 != null)
			{
		...
		/// <summary>
		/// Set the Number (component3). </summary>
		/// <param name="component3"> the Number to set </param>
		public virtual Field98G setNumber(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Number (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Number content to set </param>
		public virtual Field98G setNumber(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Gets the N (component4). </summary>
		/// <returns> the N from component4 </returns>
		...
		/// <summary>
		/// Get the N (component4) as Currency </summary>
		/// <returns> the N from component4 converted to Currency or null if cannot be converted </returns>
		...
		public virtual Field98G setComponent4(string component4)
		{
		...
		public virtual Field98G setComponent4(java.util.Currency component4)
		{
		...
		/// <summary>
		/// Set the N (component4). </summary>
		/// <param name="component4"> the N to set </param>
		public virtual Field98G setN(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Set the N (component4) from a Currency object. </summary>
		/// <seealso cref= #setComponent4(java.util.Currency) </seealso>
		/// <param name="component4"> Currency with the N content to set </param>
		public virtual Field98G setN(java.util.Currency component4)
		{
		...
		/// <summary>
		/// Gets the Time 2 (component5). </summary>
		/// <returns> the Time 2 from component5 </returns>
		...
		/// <summary>
		/// Get the Time 2 (component5) as Calendar </summary>
		/// <returns> the Time 2 from component5 converted to Calendar or null if cannot be converted </returns>
		...
		public virtual Field98G setComponent5(string component5)
		{
		...
		public virtual Field98G setComponent5(DateTime component5)
		{
		...
		/// <summary>
		/// Set the Time 2 (component5). </summary>
		/// <param name="component5"> the Time 2 to set </param>
		public virtual Field98G setTime2(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		/// <summary>
		/// Set the Time 2 (component5) from a Calendar object. </summary>
		/// <seealso cref= #setComponent5(java.util.Calendar) </seealso>
		/// <param name="component5"> Calendar with the Time 2 content to set </param>
		public virtual Field98G setTime2(DateTime component5)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field98G.NAME </returns>
		...
		/// <returns> the static value of Field98G.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98G get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field98G in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98G get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98G> getAll(final SwiftMessage msg)
		public static IList<Field98G> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98G> getAll(final SwiftTagListBlock block)
		public static IList<Field98G> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field98G> result = new java.util.ArrayList<>(arr.length);
				IList<Field98G> result = new List<Field98G>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 98G");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field98G object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98G fromJson(final String json)
		public static Field98G fromJson(string json)
		{
			...
			{
				field.setComponent3(jsonObject.get("number").AsString);
			}
			if (jsonObject.get("n") != null)
			{
				field.setComponent4(jsonObject.get("n").AsString);
			}
			if (jsonObject.get("time2") != null)
			{
				field.setComponent5(jsonObject.get("time2").AsString);
			}
			return field;
		}
