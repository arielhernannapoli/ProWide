...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37H extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37H : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37H";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37H = "37H";
		public const string PARSER_PATTERN = "c[c]N";
...
//ORIGINAL LINE: public Field37H(final String value)
		public Field37H(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37H(final com.prowidesoftware.swift.model.Tag tag)
		public Field37H(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37H"))
			{
				throw new System.ArgumentException("cannot create field 37H from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			{
				Component1 = StringUtils.Substring(toparse, 0, toparse.Length - 1);
				Component2 = StringUtils.Substring(toparse, toparse.Length - 1 - toparse);
			}
			else
			{
				Component1 = toparse;
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field37H setComponent1(string component1)
		{
		...
		public virtual Field37H setDCMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field37H setComponent2(string component2)
		{
		...
		public virtual Field37H setSign(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Gets the Rate (component3). </summary>
		/// <returns> the Rate from component3 </returns>
		...
		/// <summary>
		/// Get the Rate (component3) as Number </summary>
		/// <returns> the Rate from component3 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field37H setComponent3(string component3)
		{
		...
		public virtual Field37H setComponent3(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Set the Rate (component3). </summary>
		/// <param name="component3"> the Rate to set </param>
		public virtual Field37H setRate(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Rate (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Rate content to set </param>
		public virtual Field37H setRate(java.lang.Number component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37H.NAME </returns>
		...
		/// <returns> the static value of Field37H.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37H get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37H in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37H get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37H> getAll(final SwiftMessage msg)
		public static IList<Field37H> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37H> getAll(final SwiftTagListBlock block)
		public static IList<Field37H> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37H> result = new java.util.ArrayList<>(arr.length);
				IList<Field37H> result = new List<Field37H>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37H");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37H object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37H fromJson(final String json)
		public static Field37H fromJson(string json)
		{
			...
			{
				field.setComponent3(jsonObject.get("rate").AsString);
			}
			return field;
		}
