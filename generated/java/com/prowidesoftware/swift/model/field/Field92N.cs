...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field92N extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	...
	public class Field92N : Field, CurrencyContainer, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		...
		/// </summary>
		public const string NAME = "92N";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_92N = "92N";
		public const string PARSER_PATTERN = ":S//N/SN";
		public const string COMPONENTS_PATTERN = "SNCN";
...
//ORIGINAL LINE: public Field92N(final String value)
		public Field92N(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field92N(final com.prowidesoftware.swift.model.Tag tag)
		public Field92N(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "92N"))
			{
				throw new System.ArgumentException("cannot create field 92N from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field92N setComponent1(string component1)
		{
		...
		public virtual Field92N setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Quantity (component2). </summary>
		/// <returns> the Quantity from component2 </returns>
		...
		/// <summary>
		/// Get the Quantity (component2) as Number </summary>
		/// <returns> the Quantity from component2 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field92N setComponent2(string component2)
		{
		...
		public virtual Field92N setComponent2(java.lang.Number component2)
		{
		...
		/// <summary>
		/// Set the Quantity (component2). </summary>
		/// <param name="component2"> the Quantity to set </param>
		public virtual Field92N setQuantity(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Quantity (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the Quantity content to set </param>
		public virtual Field92N setQuantity(java.lang.Number component2)
		{
		...
		public virtual Field92N setComponent3(string component3)
		{
		...
		public virtual Field92N setComponent3(Currency component3)
		{
		...
		public virtual Field92N setCurrency(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field92N setCurrency(Currency component3)
		{
		...
		public virtual Field92N setComponent4(string component4)
		{
		...
		public virtual Field92N setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field92N setAmount(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field92N setAmount(java.lang.Number component4)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field92N.NAME </returns>
		...
		/// <returns> the static value of Field92N.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92N get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field92N in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92N get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92N> getAll(final SwiftMessage msg)
		public static IList<Field92N> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92N> getAll(final SwiftTagListBlock block)
		public static IList<Field92N> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field92N> result = new java.util.ArrayList<>(arr.length);
				IList<Field92N> result = new List<Field92N>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 92N");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field92N object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92N fromJson(final String json)
		public static Field92N fromJson(string json)
		{
			...
			{
				field.setComponent2(jsonObject.get("quantity").AsString);
			}
