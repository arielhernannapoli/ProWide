...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field142 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field142 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "142";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_142 = "142";
		...
		/// </summary>
		public const int? START_DATE_TIME = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field142() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field142(final String value)
		public Field142(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field142(final com.prowidesoftware.swift.model.Tag tag)
		public Field142(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "142"))
			{
				throw new System.ArgumentException("cannot create field 142 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Start Date Time (component1). </summary>
		/// <returns> the Start Date Time from component1 </returns>
		public virtual string getStartDateTime()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Start Date Time (component1) as Calendar </summary>
		/// <returns> the Start Date Time from component1 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime StartDateTimeAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getDateTime(getComponent(1));
		...
		public virtual Field142 setComponent1(string component1)
		{
		...
		public virtual Field142 setComponent1(DateTime component1)
		{
		...
		/// <summary>
		/// Set the Start Date Time (component1). </summary>
		/// <param name="component1"> the Start Date Time to set </param>
		public virtual Field142 setStartDateTime(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Start Date Time (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Start Date Time content to set </param>
		public virtual Field142 setStartDateTime(DateTime component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field142.NAME </returns>
		...
		/// <returns> the static value of Field142.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field142 get(final SwiftTagListBlock block)
		public static Field142 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field142 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field142 get(final SwiftMessage msg)
		public static Field142 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field142> getAll(final SwiftMessage msg)
		public static IList<Field142> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field142> getAll(final SwiftTagListBlock block)
		public static IList<Field142> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field142> result = new java.util.ArrayList<>(arr.length);
				IList<Field142> result = new List<Field142>(arr.Length);
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field142 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field142 fromJson(final String json)
		public static Field142 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("startDateTime").AsString);
			}
			return field;
		}
