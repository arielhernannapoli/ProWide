...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22U extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22U : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22U";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22U = "22U";
		...
		/// </summary>
		public const int? PRODUCT_IDENTIFIER = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field22U() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field22U(final String value)
		public Field22U(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22U(final com.prowidesoftware.swift.model.Tag tag)
		public Field22U(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22U"))
			{
				throw new System.ArgumentException("cannot create field 22U from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Product Identifier (component1). </summary>
		/// <returns> the Product Identifier from component1 </returns>
		...
		public virtual Field22U setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Product Identifier (component1). </summary>
		/// <param name="component1"> the Product Identifier to set </param>
		public virtual Field22U setProductIdentifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22U.NAME </returns>
		...
		/// <returns> the static value of Field22U.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22U get(final SwiftTagListBlock block)
		public static Field22U get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22U in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22U get(final SwiftMessage msg)
		public static Field22U get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22U> getAll(final SwiftMessage msg)
		public static IList<Field22U> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22U> getAll(final SwiftTagListBlock block)
		public static IList<Field22U> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22U> result = new java.util.ArrayList<>(arr.length);
				IList<Field22U> result = new List<Field22U>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22U");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "productIdentifier";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field22U object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22U fromJson(final String json)
		public static Field22U fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("productIdentifier").AsString;
			}
			return field;
		}
