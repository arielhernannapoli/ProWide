...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field93B extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field93B : Field, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "93B";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_93B = "93B";
		public const string PARSER_PATTERN = ":S/[S]/S/[c]N";
		public const string COMPONENTS_PATTERN = "SSSSN";
		...
		/// </summary>
		public const int? QUANTITY_TYPE_CODE = 3;
		...
		/// </summary>
		public const int? BALANCE_AMOUNT = 5;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field93B() : base(5)
		{
		}
...
//ORIGINAL LINE: public Field93B(final String value)
		public Field93B(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field93B(final com.prowidesoftware.swift.model.Tag tag)
		public Field93B(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "93B"))
			{
				throw new System.ArgumentException("cannot create field 93B from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			Component3 = SwiftParseUtils.getTokenFirst(toparse, null, "/");
			string toparse2 = SwiftParseUtils.getTokenSecond(toparse, "/");
			Component4 = SwiftParseUtils.getAlphaPrefix(toparse2);
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field93B setComponent1(string component1)
		{
		...
		public virtual Field93B setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field93B setComponent2(string component2)
		{
		...
		public virtual Field93B setDataSourceScheme(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Quantity Type Code (component3). </summary>
		/// <returns> the Quantity Type Code from component3 </returns>
		...
		public virtual Field93B setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Quantity Type Code (component3). </summary>
		/// <param name="component3"> the Quantity Type Code to set </param>
		public virtual Field93B setQuantityTypeCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field93B setComponent4(string component4)
		{
		...
		public virtual Field93B setSign(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Gets the Balance Amount (component5). </summary>
		/// <returns> the Balance Amount from component5 </returns>
		public virtual string getBalanceAmount()
		{
			return getComponent(5);
		}

		/// <summary>
		/// Get the Balance Amount (component5) as Number </summary>
		/// <returns> the Balance Amount from component5 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number BalanceAmountAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(5));
		...
		public virtual Field93B setComponent5(string component5)
		{
		...
		public virtual Field93B setComponent5(java.lang.Number component5)
		{
		...
		/// <summary>
		/// Set the Balance Amount (component5). </summary>
		/// <param name="component5"> the Balance Amount to set </param>
		public virtual Field93B setBalanceAmount(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		/// <summary>
		/// Set the Balance Amount (component5) from a Number object. </summary>
		/// <seealso cref= #setComponent5(java.lang.Number) </seealso>
		/// <param name="component5"> Number with the Balance Amount content to set </param>
		public virtual Field93B setBalanceAmount(java.lang.Number component5)
		{
	   ...
	   public override bool DSSPresent
	   {
		...
		/// </summary>
		public const int? CONDITIONAL_QUALIFIER = 3;
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field93B.NAME </returns>
		...
		/// <returns> the static value of Field93B.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field93B get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field93B in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field93B get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field93B> getAll(final SwiftMessage msg)
		public static IList<Field93B> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field93B> getAll(final SwiftTagListBlock block)
		public static IList<Field93B> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field93B> result = new java.util.ArrayList<>(arr.length);
				IList<Field93B> result = new List<Field93B>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 93B");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[3] = "quantityTypeCode";
				result[4] = "sign";
				result[5] = "balanceAmount";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field93B object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field93B fromJson(final String json)
		public static Field93B fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("quantityTypeCode").AsString;
			}
			if (jsonObject.get("sign") != null)
			{
				field.Component4 = jsonObject.get("sign").AsString;
			}
			if (jsonObject.get("balanceAmount") != null)
			{
				field.setComponent5(jsonObject.get("balanceAmount").AsString);
			}
			return field;
		}
