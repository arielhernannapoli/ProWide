...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37G extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37G : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37G";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37G = "37G";
...
//ORIGINAL LINE: public Field37G(final String value)
		public Field37G(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37G(final com.prowidesoftware.swift.model.Tag tag)
		public Field37G(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37G"))
			{
				throw new System.ArgumentException("cannot create field 37G from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field37G setComponent1(string component1)
		{
		...
		public virtual Field37G setSign(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field37G setComponent2(string component2)
		{
		...
		public virtual Field37G setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field37G setRate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field37G setRate(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37G.NAME </returns>
		...
		/// <returns> the static value of Field37G.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37G get(final SwiftTagListBlock block)
		public static Field37G get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37G in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37G get(final SwiftMessage msg)
		public static Field37G get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37G> getAll(final SwiftMessage msg)
		public static IList<Field37G> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37G> getAll(final SwiftTagListBlock block)
		public static IList<Field37G> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37G> result = new java.util.ArrayList<>(arr.length);
				IList<Field37G> result = new List<Field37G>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37G");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37G object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37G fromJson(final String json)
		public static Field37G fromJson(string json)
		{
