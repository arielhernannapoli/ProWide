...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field35N extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field35N : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "35N";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_35N = "35N";
...
//ORIGINAL LINE: public Field35N(final String value)
		public Field35N(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field35N(final com.prowidesoftware.swift.model.Tag tag)
		public Field35N(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "35N"))
			{
				throw new System.ArgumentException("cannot create field 35N from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field35N setComponent1(string component1)
		{
		...
		public virtual Field35N setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field35N setComponent2(string component2)
		{
		...
		public virtual Field35N setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field35N setAmount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field35N setAmount(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field35N.NAME </returns>
		...
		/// <returns> the static value of Field35N.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35N get(final SwiftTagListBlock block)
		public static Field35N get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field35N in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35N get(final SwiftMessage msg)
		public static Field35N get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field35N> getAll(final SwiftMessage msg)
		public static IList<Field35N> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field35N> getAll(final SwiftTagListBlock block)
		public static IList<Field35N> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field35N> result = new java.util.ArrayList<>(arr.length);
				IList<Field35N> result = new List<Field35N>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 35N");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field35N object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35N fromJson(final String json)
		public static Field35N fromJson(string json)
		{
