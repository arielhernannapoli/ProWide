...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37P extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37P : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37P";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37P = "37P";
...
//ORIGINAL LINE: public Field37P(final String value)
		public Field37P(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37P(final com.prowidesoftware.swift.model.Tag tag)
		public Field37P(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37P"))
			{
				throw new System.ArgumentException("cannot create field 37P from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field37P setComponent1(string component1)
		{
		...
		public virtual Field37P setComponent1(java.lang.Number component1)
		{
		...
		public virtual Field37P setRate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field37P setRate(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37P.NAME </returns>
		...
		/// <returns> the static value of Field37P.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37P get(final SwiftTagListBlock block)
		public static Field37P get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37P in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37P get(final SwiftMessage msg)
		public static Field37P get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37P> getAll(final SwiftMessage msg)
		public static IList<Field37P> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37P> getAll(final SwiftTagListBlock block)
		public static IList<Field37P> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37P> result = new java.util.ArrayList<>(arr.length);
				IList<Field37P> result = new List<Field37P>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37P");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37P object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37P fromJson(final String json)
		public static Field37P fromJson(string json)
		{
