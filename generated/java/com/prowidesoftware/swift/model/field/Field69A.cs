...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field69A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field69A : Field, DateContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "69A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_69A = "69A";
		public const string PARSER_PATTERN = ":S//S/S";
		public const string COMPONENTS_PATTERN = "SDD";
		...
		/// </summary>
		public const int? DATE1 = 2;

		/// <summary>
		/// Component number for the Date2 subfield
		/// </summary>
		public const int? DATE2 = 3;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field69A() : base(3)
		{
		}
...
//ORIGINAL LINE: public Field69A(final String value)
		public Field69A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field69A(final com.prowidesoftware.swift.model.Tag tag)
		public Field69A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "69A"))
			{
				throw new System.ArgumentException("cannot create field 69A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field69A setComponent1(string component1)
		{
		...
		public virtual Field69A setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Date1 (component2). </summary>
		/// <returns> the Date1 from component2 </returns>
		public virtual string getDate1()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Date1 (component2) as Calendar </summary>
		/// <returns> the Date1 from component2 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime Date1AsCalendar
		{
			get
			{
				return SwiftFormatUtils.getDate4(getComponent(2));
		...
		public virtual Field69A setComponent2(string component2)
		{
		...
		public virtual Field69A setComponent2(DateTime component2)
		{
		...
		/// <summary>
		/// Set the Date1 (component2). </summary>
		/// <param name="component2"> the Date1 to set </param>
		public virtual Field69A setDate1(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Date1 (component2) from a Calendar object. </summary>
		/// <seealso cref= #setComponent2(java.util.Calendar) </seealso>
		/// <param name="component2"> Calendar with the Date1 content to set </param>
		public virtual Field69A setDate1(DateTime component2)
		{
		...
		/// <summary>
		/// Gets the Date2 (component3). </summary>
		/// <returns> the Date2 from component3 </returns>
		public virtual string getDate2()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the Date2 (component3) as Calendar </summary>
		/// <returns> the Date2 from component3 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime Date2AsCalendar
		{
			get
			{
				return SwiftFormatUtils.getDate4(getComponent(3));
		...
		public virtual Field69A setComponent3(string component3)
		{
		...
		public virtual Field69A setComponent3(DateTime component3)
		{
		...
		/// <summary>
		/// Set the Date2 (component3). </summary>
		/// <param name="component3"> the Date2 to set </param>
		public virtual Field69A setDate2(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Date2 (component3) from a Calendar object. </summary>
		/// <seealso cref= #setComponent3(java.util.Calendar) </seealso>
		/// <param name="component3"> Calendar with the Date2 content to set </param>
		public virtual Field69A setDate2(DateTime component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field69A.NAME </returns>
		...
		/// <returns> the static value of Field69A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69A get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field69A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69A get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field69A> getAll(final SwiftMessage msg)
		public static IList<Field69A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field69A> getAll(final SwiftTagListBlock block)
		public static IList<Field69A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field69A> result = new java.util.ArrayList<>(arr.length);
				IList<Field69A> result = new List<Field69A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 69A");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field69A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69A fromJson(final String json)
		public static Field69A fromJson(string json)
		{
			...
			{
				field.setComponent2(jsonObject.get("date1").AsString);
			}
			if (jsonObject.get("date2") != null)
			{
				field.setComponent3(jsonObject.get("date2").AsString);
			}
			return field;
		}
