...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field137 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field137 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "137";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_137 = "137";
...
//ORIGINAL LINE: public Field137(final String value)
		public Field137(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field137(final com.prowidesoftware.swift.model.Tag tag)
		public Field137(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "137"))
			{
				throw new System.ArgumentException("cannot create field 137 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field137 setComponent1(string component1)
		{
		...
		public virtual Field137 setBroadcastIndicator(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field137 setComponent2(string component2)
		{
		...
		public virtual Field137 setUnsequencedBroadcast(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field137 setComponent3(string component3)
		{
		...
		public virtual Field137 setBroadcastIssuer(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field137 setComponent4(string component4)
		{
		...
		public virtual Field137 setComponent4(java.lang.Number component4)
		{
			if (component4 != null)
			{
		...
		public virtual Field137 setBroadcastNumber(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field137 setBroadcastNumber(java.lang.Number component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field137.NAME </returns>
		...
		/// <returns> the static value of Field137.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field137 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field137 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field137 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field137> getAll(final SwiftMessage msg)
		public static IList<Field137> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field137> getAll(final SwiftTagListBlock block)
		public static IList<Field137> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field137> result = new java.util.ArrayList<>(arr.length);
				IList<Field137> result = new List<Field137>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 137");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field137 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field137 fromJson(final String json)
