...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field33C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	...
	public class Field33C : Field, CurrencyContainer, DateContainer, AmountContainer
	{
		...
		/// </summary>
		public const string NAME = "33C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_33C = "33C";
...
//ORIGINAL LINE: public Field33C(final String value)
		public Field33C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field33C(final com.prowidesoftware.swift.model.Tag tag)
		public Field33C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "33C"))
			{
				throw new System.ArgumentException("cannot create field 33C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field33C setComponent1(string component1)
		{
		...
		public virtual Field33C setComponent1(DateTime component1)
		{
		...
		public virtual Field33C setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field33C setDate(DateTime component1)
		{
		...
		public virtual Field33C setComponent2(string component2)
		{
		...
		public virtual Field33C setComponent2(Currency component2)
		{
		...
		public virtual Field33C setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field33C setCurrency(Currency component2)
		{
		...
		public virtual Field33C setComponent3(string component3)
		{
		...
		public virtual Field33C setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field33C setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field33C setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field33C.NAME </returns>
		...
		/// <returns> the static value of Field33C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33C get(final SwiftTagListBlock block)
		public static Field33C get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field33C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33C get(final SwiftMessage msg)
		public static Field33C get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33C> getAll(final SwiftMessage msg)
		public static IList<Field33C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33C> getAll(final SwiftTagListBlock block)
		public static IList<Field33C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field33C> result = new java.util.ArrayList<>(arr.length);
				IList<Field33C> result = new List<Field33C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 33C");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field33C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33C fromJson(final String json)
		public static Field33C fromJson(string json)
		{
