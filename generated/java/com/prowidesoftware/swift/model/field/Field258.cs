...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field258 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field258 : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "258";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_258 = "258";
...
//ORIGINAL LINE: public Field258(final String value)
		public Field258(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field258(final com.prowidesoftware.swift.model.Tag tag)
		public Field258(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "258"))
			{
				throw new System.ArgumentException("cannot create field 258 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field258 setComponent1(string component1)
		{
		...
		public virtual Field258 setComponent1(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
		...
		public virtual Field258 setLTAddress(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field258 setLTAddress(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
		...
		public virtual Field258 setComponent2(string component2)
		{
		...
		public virtual Field258 setSessionNumber(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field258 setSessionNumber(java.lang.Number component2)
		{
		...
		public virtual Field258 setComponent3(string component3)
		{
		...
		public virtual Field258 setMessageType(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field258 setComponent4(string component4)
		{
		...
		public virtual Field258 setDate(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field258 setDate(DateTime component4)
		{
		...
		public virtual Field258 setComponent5(string component5)
		{
		...
		public virtual Field258 setComponent5(DateTime component5)
		{
		...
		public virtual Field258 setStartTime(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		public virtual Field258 setStartTime(DateTime component5)
		{
		...
		public virtual Field258 setComponent6(string component6)
		{
		...
		public virtual Field258 setEndTime(string component6)
		{
			setComponent(6, component6);
			return this;
		}
		...
		public virtual Field258 setEndTime(DateTime component6)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field258.NAME </returns>
		...
		/// <returns> the static value of Field258.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field258 get(final SwiftTagListBlock block)
		public static Field258 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field258 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field258 get(final SwiftMessage msg)
		public static Field258 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field258> getAll(final SwiftMessage msg)
		public static IList<Field258> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field258> getAll(final SwiftTagListBlock block)
		public static IList<Field258> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field258> result = new java.util.ArrayList<>(arr.length);
				IList<Field258> result = new List<Field258>(arr.Length);
