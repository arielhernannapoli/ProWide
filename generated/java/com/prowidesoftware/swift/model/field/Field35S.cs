...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field35S extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field35S : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "35S";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_35S = "35S";
...
//ORIGINAL LINE: public Field35S(final String value)
		public Field35S(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field35S(final com.prowidesoftware.swift.model.Tag tag)
		public Field35S(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "35S"))
			{
				throw new System.ArgumentException("cannot create field 35S from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field35S setComponent1(string component1)
		{
		...
		public virtual Field35S setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field35S setComponent2(string component2)
		{
		...
		public virtual Field35S setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field35S setAmount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field35S setAmount(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field35S.NAME </returns>
		...
		/// <returns> the static value of Field35S.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35S get(final SwiftTagListBlock block)
		public static Field35S get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field35S in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35S get(final SwiftMessage msg)
		public static Field35S get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field35S> getAll(final SwiftMessage msg)
		public static IList<Field35S> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field35S> getAll(final SwiftTagListBlock block)
		public static IList<Field35S> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field35S> result = new java.util.ArrayList<>(arr.length);
				IList<Field35S> result = new List<Field35S>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 35S");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field35S object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35S fromJson(final String json)
		public static Field35S fromJson(string json)
		{
