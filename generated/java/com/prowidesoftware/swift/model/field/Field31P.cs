...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field31P extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field31P : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "31P";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_31P = "31P";
		public const string PARSER_PATTERN = "<DATE2>[S]";
		public const string COMPONENTS_PATTERN = "ES";
...
//ORIGINAL LINE: public Field31P(final String value)
		public Field31P(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field31P(final com.prowidesoftware.swift.model.Tag tag)
		public Field31P(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "31P"))
			{
				throw new System.ArgumentException("cannot create field 31P from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 6)
				{
					Component2 = StringUtils.Substring(value, 6 - value);
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field31P setComponent1(string component1)
		{
		...
		public virtual Field31P setComponent1(DateTime component1)
		{
		...
		public virtual Field31P setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field31P setDate(DateTime component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Place (component2). </summary>
		/// <returns> the Place from component2 </returns>
		...
		public virtual Field31P setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Place (component2). </summary>
		/// <param name="component2"> the Place to set </param>
		public virtual Field31P setPlace(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field31P.NAME </returns>
		...
		/// <returns> the static value of Field31P.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field31P get(final SwiftTagListBlock block)
		public static Field31P get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field31P in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field31P get(final SwiftMessage msg)
		public static Field31P get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field31P> getAll(final SwiftMessage msg)
		public static IList<Field31P> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field31P> getAll(final SwiftTagListBlock block)
		public static IList<Field31P> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field31P> result = new java.util.ArrayList<>(arr.length);
				IList<Field31P> result = new List<Field31P>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 31P");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field31P object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field31P fromJson(final String json)
		public static Field31P fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("place").AsString;
			}
			return field;
		}
