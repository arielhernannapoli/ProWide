...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field119 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field119 : Field
	{
		...
		/// </summary>
		public const string NAME = "119";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_119 = "119";
		...
		/// </summary>
		public const int? VALIDATION_FLAG = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field119() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field119(final String value)
		public Field119(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field119(final com.prowidesoftware.swift.model.Tag tag)
		public Field119(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "119"))
			{
				throw new System.ArgumentException("cannot create field 119 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Validation Flag (component1). </summary>
		/// <returns> the Validation Flag from component1 </returns>
		public virtual string ValidationFlag
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field119 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Validation Flag (component1). </summary>
		/// <param name="component1"> the Validation Flag to set </param>
		public virtual Field119 setValidationFlag(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field119.NAME </returns>
		...
		/// <returns> the static value of Field119.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field119 get(final SwiftTagListBlock block)
		public static Field119 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field119 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field119 get(final SwiftMessage msg)
		public static Field119 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field119> getAll(final SwiftMessage msg)
		public static IList<Field119> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field119> getAll(final SwiftTagListBlock block)
		public static IList<Field119> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field119> result = new java.util.ArrayList<>(arr.length);
				IList<Field119> result = new List<Field119>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 119");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "validationFlag";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field119 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field119 fromJson(final String json)
		public static Field119 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("validationFlag").AsString;
			}
			return field;
		}
