...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field209 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field209 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "209";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_209 = "209";
...
//ORIGINAL LINE: public Field209(final String value)
		public Field209(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field209(final com.prowidesoftware.swift.model.Tag tag)
		public Field209(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "209"))
			{
				throw new System.ArgumentException("cannot create field 209 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Type (component1). </summary>
		/// <returns> the Type from component1 </returns>
		...
		/// <summary>
		/// Get the Type (component1) as Number </summary>
		/// <returns> the Type from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number TypeAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field209 setComponent1(string component1)
		{
		...
		public virtual Field209 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Type (component1). </summary>
		/// <param name="component1"> the Type to set </param>
		public virtual Field209 setType(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field209 setType(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field209.NAME </returns>
		...
		/// <returns> the static value of Field209.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field209 get(final SwiftTagListBlock block)
		public static Field209 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field209 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field209 get(final SwiftMessage msg)
		public static Field209 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field209> getAll(final SwiftMessage msg)
		public static IList<Field209> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field209> getAll(final SwiftTagListBlock block)
		public static IList<Field209> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field209> result = new java.util.ArrayList<>(arr.length);
				IList<Field209> result = new List<Field209>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 209");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field209 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field209 fromJson(final String json)
		public static Field209 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("type").AsString);
			}
			return field;
		}
