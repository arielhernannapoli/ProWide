...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field13K extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field13K : Field, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "13K";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_13K = "13K";
...
//ORIGINAL LINE: public Field13K(final String value)
		public Field13K(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field13K(final com.prowidesoftware.swift.model.Tag tag)
		public Field13K(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "13K"))
			{
				throw new System.ArgumentException("cannot create field 13K from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field13K setComponent1(string component1)
		{
		...
		public virtual Field13K setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Number Id (component2). </summary>
		/// <returns> the Number Id from component2 </returns>
		...
		public virtual Field13K setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Number Id (component2). </summary>
		/// <param name="component2"> the Number Id to set </param>
		public virtual Field13K setNumberId(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field13K setComponent3(string component3)
		{
		...
		public virtual Field13K setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field13K setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field13K setAmount(java.lang.Number component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field13K.NAME </returns>
		...
		/// <returns> the static value of Field13K.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field13K get(final SwiftTagListBlock block)
		public static Field13K get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field13K in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field13K get(final SwiftMessage msg)
		public static Field13K get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field13K> getAll(final SwiftMessage msg)
		public static IList<Field13K> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field13K> getAll(final SwiftTagListBlock block)
		public static IList<Field13K> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field13K> result = new java.util.ArrayList<>(arr.length);
				IList<Field13K> result = new List<Field13K>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 13K");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field13K object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field13K fromJson(final String json)
		public static Field13K fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("numberId").AsString;
			}
