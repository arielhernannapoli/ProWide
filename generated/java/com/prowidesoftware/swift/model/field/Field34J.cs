...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field34J extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field34J : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "34J";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_34J = "34J";
...
//ORIGINAL LINE: public Field34J(final String value)
		public Field34J(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field34J(final com.prowidesoftware.swift.model.Tag tag)
		public Field34J(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "34J"))
			{
				throw new System.ArgumentException("cannot create field 34J from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field34J setComponent1(string component1)
		{
		...
		public virtual Field34J setSign(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field34J setComponent2(string component2)
		{
		...
		public virtual Field34J setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field34J setComponent3(string component3)
		{
		...
		public virtual Field34J setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field34J setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field34J setAmount(java.lang.Number component3)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field34J.NAME </returns>
		...
		/// <returns> the static value of Field34J.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34J get(final SwiftTagListBlock block)
		public static Field34J get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field34J in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34J get(final SwiftMessage msg)
		public static Field34J get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34J> getAll(final SwiftMessage msg)
		public static IList<Field34J> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34J> getAll(final SwiftTagListBlock block)
		public static IList<Field34J> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field34J> result = new java.util.ArrayList<>(arr.length);
				IList<Field34J> result = new List<Field34J>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 34J");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field34J object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34J fromJson(final String json)
		public static Field34J fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("currency").AsString;
			}
