...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field97B extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field97B : Field, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "97B";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_97B = "97B";
		...
		/// </summary>
		public const int? ACCOUNT_TYPE_CODE = 3;

		/// <summary>
		/// Component number for the Account Number subfield
		/// </summary>
		public const int? ACCOUNT_NUMBER = 4;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field97B() : base(4)
		{
		}
...
//ORIGINAL LINE: public Field97B(final String value)
		public Field97B(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field97B(final com.prowidesoftware.swift.model.Tag tag)
		public Field97B(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "97B"))
			{
				throw new System.ArgumentException("cannot create field 97B from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			Component4 = SwiftParseUtils.getTokenForthLast(value, "/");
		}
	...
	//ORIGINAL LINE: final StringBuilder result = new StringBuilder();
				...
				append(result, 1);
				result.Append("/");
				if (StringUtils.isNotEmpty(Component2))
				{
					append(result, 2);
				}
				result.Append("/");
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field97B setComponent1(string component1)
		{
		...
		public virtual Field97B setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field97B setComponent2(string component2)
		{
		...
		public virtual Field97B setDataSourceScheme(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Account Type Code (component3). </summary>
		/// <returns> the Account Type Code from component3 </returns>
		public virtual string AccountTypeCode
		{
			get
			{
				return getComponent(3);
		...
		public virtual Field97B setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Account Type Code (component3). </summary>
		/// <param name="component3"> the Account Type Code to set </param>
		public virtual Field97B setAccountTypeCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		/// <summary>
		/// Gets the Account Number (component4). </summary>
		/// <returns> the Account Number from component4 </returns>
		...
		public virtual Field97B setComponent4(string component4)
		{
		...
		/// <summary>
		/// Set the Account Number (component4). </summary>
		/// <param name="component4"> the Account Number to set </param>
		public virtual Field97B setAccountNumber(string component4)
		{
			setComponent(4, component4);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field97B.NAME </returns>
		...
		/// <returns> the static value of Field97B.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field97B get(final SwiftTagListBlock block)
		public static Field97B get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field97B in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field97B get(final SwiftMessage msg)
		public static Field97B get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field97B> getAll(final SwiftMessage msg)
		public static IList<Field97B> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field97B> getAll(final SwiftTagListBlock block)
		public static IList<Field97B> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field97B> result = new java.util.ArrayList<>(arr.length);
				IList<Field97B> result = new List<Field97B>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 97B");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[3] = "accountTypeCode";
				result[4] = "accountNumber";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field97B object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field97B fromJson(final String json)
		public static Field97B fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("accountTypeCode").AsString;
			}
			if (jsonObject.get("accountNumber") != null)
			{
				field.Component4 = jsonObject.get("accountNumber").AsString;
			}
			return field;
		}
