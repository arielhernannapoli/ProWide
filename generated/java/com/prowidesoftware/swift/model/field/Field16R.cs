...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field16R extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field16R : Field
	{
		...
		/// </summary>
		public const string NAME = "16R";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_16R = "16R";
		...
		/// </summary>
		public const int? BLOCKNAME = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field16R() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field16R(final String value)
		public Field16R(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field16R(final com.prowidesoftware.swift.model.Tag tag)
		public Field16R(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "16R"))
			{
				throw new System.ArgumentException("cannot create field 16R from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the BlockName (component1). </summary>
		/// <returns> the BlockName from component1 </returns>
		...
		public virtual Field16R setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the BlockName (component1). </summary>
		/// <param name="component1"> the BlockName to set </param>
		public virtual Field16R setBlockName(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field16R.NAME </returns>
		...
		/// <returns> the static value of Field16R.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field16R get(final SwiftTagListBlock block)
		public static Field16R get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field16R in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field16R get(final SwiftMessage msg)
		public static Field16R get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field16R> getAll(final SwiftMessage msg)
		public static IList<Field16R> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field16R> getAll(final SwiftTagListBlock block)
		public static IList<Field16R> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field16R> result = new java.util.ArrayList<>(arr.length);
				IList<Field16R> result = new List<Field16R>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 16R");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field16R object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field16R fromJson(final String json)
		public static Field16R fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("blockName").AsString;
			}
			return field;
		}
