...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field92B extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	...
	public class Field92B : Field, CurrencyContainer, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		...
		/// </summary>
		public const string NAME = "92B";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_92B = "92B";
		public const string PARSER_PATTERN = ":S//S/S/N";
		public const string COMPONENTS_PATTERN = "SCCN";
		...
		/// </summary>
		public const int? FIRST_CURRENCY_CODE = 2;

		/// <summary>
		/// Component number for the Second Currency Code subfield
		/// </summary>
		public const int? SECOND_CURRENCY_CODE = 3;
...
//ORIGINAL LINE: public Field92B(final String value)
		public Field92B(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field92B(final com.prowidesoftware.swift.model.Tag tag)
		public Field92B(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "92B"))
			{
				throw new System.ArgumentException("cannot create field 92B from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field92B setComponent1(string component1)
		{
		...
		public virtual Field92B setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the First Currency Code (component2). </summary>
		/// <returns> the First Currency Code from component2 </returns>
		public virtual string getFirstCurrencyCode()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the First Currency Code (component2) as Currency </summary>
		/// <returns> the First Currency Code from component2 converted to Currency or null if cannot be converted </returns>
		public virtual Currency FirstCurrencyCodeAsCurrency
		{
			get
			{
				return SwiftFormatUtils.getCurrency(getComponent(2));
		...
		public virtual Field92B setComponent2(string component2)
		{
		...
		public virtual Field92B setComponent2(Currency component2)
		{
		...
		/// <summary>
		/// Set the First Currency Code (component2). </summary>
		/// <param name="component2"> the First Currency Code to set </param>
		public virtual Field92B setFirstCurrencyCode(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the First Currency Code (component2) from a Currency object. </summary>
		/// <seealso cref= #setComponent2(java.util.Currency) </seealso>
		/// <param name="component2"> Currency with the First Currency Code content to set </param>
		public virtual Field92B setFirstCurrencyCode(Currency component2)
		{
		...
		/// <summary>
		/// Gets the Second Currency Code (component3). </summary>
		/// <returns> the Second Currency Code from component3 </returns>
		public virtual string getSecondCurrencyCode()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the Second Currency Code (component3) as Currency </summary>
		/// <returns> the Second Currency Code from component3 converted to Currency or null if cannot be converted </returns>
		public virtual Currency SecondCurrencyCodeAsCurrency
		{
			get
			{
				return SwiftFormatUtils.getCurrency(getComponent(3));
		...
		public virtual Field92B setComponent3(string component3)
		{
		...
		public virtual Field92B setComponent3(Currency component3)
		{
		...
		/// <summary>
		/// Set the Second Currency Code (component3). </summary>
		/// <param name="component3"> the Second Currency Code to set </param>
		public virtual Field92B setSecondCurrencyCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Second Currency Code (component3) from a Currency object. </summary>
		/// <seealso cref= #setComponent3(java.util.Currency) </seealso>
		/// <param name="component3"> Currency with the Second Currency Code content to set </param>
		public virtual Field92B setSecondCurrencyCode(Currency component3)
		{
		...
		/// <summary>
		/// Gets the Rate (component4). </summary>
		/// <returns> the Rate from component4 </returns>
		...
		/// <summary>
		/// Get the Rate (component4) as Number </summary>
		/// <returns> the Rate from component4 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field92B setComponent4(string component4)
		{
		...
		public virtual Field92B setComponent4(java.lang.Number component4)
		{
		...
		/// <summary>
		/// Set the Rate (component4). </summary>
		/// <param name="component4"> the Rate to set </param>
		public virtual Field92B setRate(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Set the Rate (component4) from a Number object. </summary>
		/// <seealso cref= #setComponent4(java.lang.Number) </seealso>
		/// <param name="component4"> Number with the Rate content to set </param>
		public virtual Field92B setRate(java.lang.Number component4)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field92B.NAME </returns>
		...
		/// <returns> the static value of Field92B.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92B get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field92B in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92B get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92B> getAll(final SwiftMessage msg)
		public static IList<Field92B> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92B> getAll(final SwiftTagListBlock block)
		public static IList<Field92B> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field92B> result = new java.util.ArrayList<>(arr.length);
				IList<Field92B> result = new List<Field92B>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 92B");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "qualifier";
				result[2] = "firstCurrencyCode";
				result[3] = "secondCurrencyCode";
				result[4] = "rate";
				return result;
			}
		}
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field92B object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92B fromJson(final String json)
		public static Field92B fromJson(string json)
		{
			...
			{
				field.setComponent2(jsonObject.get("firstCurrencyCode").AsString);
			}
			if (jsonObject.get("secondCurrencyCode") != null)
			{
				field.setComponent3(jsonObject.get("secondCurrencyCode").AsString);
			}
			if (jsonObject.get("rate") != null)
			{
				field.setComponent4(jsonObject.get("rate").AsString);
			}
			return field;
		}
