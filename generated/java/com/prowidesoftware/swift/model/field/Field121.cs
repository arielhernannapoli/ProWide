...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field121 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field121 : Field
	{
		...
		/// </summary>
		public const string NAME = "121";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_121 = "121";
		...
		/// </summary>
		public const int? UNIQUE_REFERENCE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field121() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field121(final String value)
		public Field121(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field121(final com.prowidesoftware.swift.model.Tag tag)
		public Field121(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "121"))
			{
				throw new System.ArgumentException("cannot create field 121 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Unique Reference (component1). </summary>
		/// <returns> the Unique Reference from component1 </returns>
		public virtual string UniqueReference
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field121 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Unique Reference (component1). </summary>
		/// <param name="component1"> the Unique Reference to set </param>
		public virtual Field121 setUniqueReference(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field121.NAME </returns>
		...
		/// <returns> the static value of Field121.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field121 get(final SwiftTagListBlock block)
		public static Field121 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field121 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field121 get(final SwiftMessage msg)
		public static Field121 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field121> getAll(final SwiftMessage msg)
		public static IList<Field121> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field121> getAll(final SwiftTagListBlock block)
		public static IList<Field121> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field121> result = new java.util.ArrayList<>(arr.length);
				IList<Field121> result = new List<Field121>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 121");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "uniqueReference";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field121 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field121 fromJson(final String json)
		public static Field121 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("uniqueReference").AsString;
			}
			return field;
		}
