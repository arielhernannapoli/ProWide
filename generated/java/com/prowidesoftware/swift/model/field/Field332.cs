...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field332 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field332 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "332";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_332 = "332";
		public const string PARSER_PATTERN = "6!N6!N";
		public const string COMPONENTS_PATTERN = "NN";

		/// <summary>
		/// Component number for the Total Messages Sent subfield
		/// </summary>
		public const int? TOTAL_MESSAGES_SENT = 1;

		/// <summary>
		/// Component number for the Total Messages Received subfield
		/// </summary>
		public const int? TOTAL_MESSAGES_RECEIVED = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field332() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field332(final String value)
		public Field332(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field332(final com.prowidesoftware.swift.model.Tag tag)
		public Field332(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "332"))
			{
				throw new System.ArgumentException("cannot create field 332 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 6)
				{
					setComponent2(StringUtils.Substring(value, 6 - value));
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Total Messages Sent (component1). </summary>
		/// <returns> the Total Messages Sent from component1 </returns>
		public virtual string getTotalMessagesSent()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Total Messages Sent (component1) as Number </summary>
		/// <returns> the Total Messages Sent from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number TotalMessagesSentAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field332 setComponent1(string component1)
		{
		...
		public virtual Field332 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Total Messages Sent (component1). </summary>
		/// <param name="component1"> the Total Messages Sent to set </param>
		public virtual Field332 setTotalMessagesSent(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Total Messages Sent (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Total Messages Sent content to set </param>
		public virtual Field332 setTotalMessagesSent(java.lang.Number component1)
		{
		...
		/// <summary>
		/// Gets the Total Messages Received (component2). </summary>
		/// <returns> the Total Messages Received from component2 </returns>
		public virtual string getTotalMessagesReceived()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Total Messages Received (component2) as Number </summary>
		/// <returns> the Total Messages Received from component2 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number TotalMessagesReceivedAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(2));
		...
		public virtual Field332 setComponent2(string component2)
		{
		...
		public virtual Field332 setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		/// <summary>
		/// Set the Total Messages Received (component2). </summary>
		/// <param name="component2"> the Total Messages Received to set </param>
		public virtual Field332 setTotalMessagesReceived(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Total Messages Received (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the Total Messages Received content to set </param>
		public virtual Field332 setTotalMessagesReceived(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field332.NAME </returns>
		...
		/// <returns> the static value of Field332.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field332 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field332 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field332 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field332> getAll(final SwiftMessage msg)
		public static IList<Field332> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field332> getAll(final SwiftTagListBlock block)
		public static IList<Field332> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field332> result = new java.util.ArrayList<>(arr.length);
				IList<Field332> result = new List<Field332>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 332");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "totalMessagesSent";
				result[2] = "totalMessagesReceived";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field332 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field332 fromJson(final String json)
		public static Field332 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("totalMessagesSent").AsString);
			}
			if (jsonObject.get("totalMessagesReceived") != null)
			{
				field.setComponent2(jsonObject.get("totalMessagesReceived").AsString);
			}
			return field;
		}
