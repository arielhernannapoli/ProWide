...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field101 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field101 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const int? APPLICATION_IDENTIFIER = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field101() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field101(final String value)
		public Field101(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field101(final com.prowidesoftware.swift.model.Tag tag)
		public Field101(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "101"))
			{
				throw new System.ArgumentException("cannot create field 101 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Application Identifier (component1). </summary>
		/// <returns> the Application Identifier from component1 </returns>
		...
		public virtual Field101 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Application Identifier (component1). </summary>
		/// <param name="component1"> the Application Identifier to set </param>
		public virtual Field101 setApplicationIdentifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field101.NAME </returns>
		...
		/// <returns> the static value of Field101.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field101 get(final SwiftTagListBlock block)
		public static Field101 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field101 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field101 get(final SwiftMessage msg)
		public static Field101 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field101> getAll(final SwiftMessage msg)
		public static IList<Field101> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field101> getAll(final SwiftTagListBlock block)
		public static IList<Field101> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field101> result = new java.util.ArrayList<>(arr.length);
				IList<Field101> result = new List<Field101>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 101");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "applicationIdentifier";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field101 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field101 fromJson(final String json)
		public static Field101 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("applicationIdentifier").AsString;
			}
			return field;
		}
