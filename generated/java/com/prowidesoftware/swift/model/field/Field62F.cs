...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field62F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field62F : Field, DateContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "62F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_62F = "62F";
...
//ORIGINAL LINE: public Field62F(final String value)
		public Field62F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field62F(final com.prowidesoftware.swift.model.Tag tag)
		public Field62F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "62F"))
			{
				throw new System.ArgumentException("cannot create field 62F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field62F setComponent1(string component1)
		{
		...
		public virtual Field62F setDCMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field62F setComponent2(string component2)
		{
		...
		public virtual Field62F setComponent2(DateTime component2)
		{
		...
		public virtual Field62F setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field62F setDate(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field62F setComponent3(string component3)
		{
		...
		public virtual Field62F setCurrency(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field62F setComponent4(string component4)
		{
		...
		public virtual Field62F setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field62F setAmount(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field62F setAmount(java.lang.Number component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field62F.NAME </returns>
		...
		/// <returns> the static value of Field62F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field62F get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field62F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field62F get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field62F> getAll(final SwiftMessage msg)
		public static IList<Field62F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field62F> getAll(final SwiftTagListBlock block)
		public static IList<Field62F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field62F> result = new java.util.ArrayList<>(arr.length);
				IList<Field62F> result = new List<Field62F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 62F");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field62F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field62F fromJson(final String json)
