...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field128 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.BICContainer
	[Serializable]
	public class Field128 : Field, BICContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "128";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_128 = "128";
		public const string PARSER_PATTERN = "S/S";
		public const string COMPONENTS_PATTERN = "cB";
...
//ORIGINAL LINE: public Field128(final String value)
		public Field128(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field128(final com.prowidesoftware.swift.model.Tag tag)
		public Field128(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "128"))
			{
				throw new System.ArgumentException("cannot create field 128 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field128 setComponent1(string component1)
		{
		...
		public virtual Field128 setPriority(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field128 setComponent2(string component2)
		{
		...
		public virtual Field128 setComponent2(BIC component2)
		{
		...
		public virtual Field128 setBIC(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field128 setBIC(BIC component2)
		{
...
//ORIGINAL LINE: final java.util.List<String> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field128.NAME </returns>
		...
		/// <returns> the static value of Field128.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field128 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field128 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field128 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field128> getAll(final SwiftMessage msg)
		public static IList<Field128> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field128> getAll(final SwiftTagListBlock block)
		public static IList<Field128> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field128> result = new java.util.ArrayList<>(arr.length);
				IList<Field128> result = new List<Field128>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 128");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field128 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field128 fromJson(final String json)
