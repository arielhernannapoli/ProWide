...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field98F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field98F : Field, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "98F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_98F = "98F";
		public const string PARSER_PATTERN = ":S/[S]/S<TIME2>";
		public const string COMPONENTS_PATTERN = "SSST";
...
//ORIGINAL LINE: public Field98F(final String value)
		public Field98F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field98F(final com.prowidesoftware.swift.model.Tag tag)
		public Field98F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "98F"))
			{
				throw new System.ArgumentException("cannot create field 98F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (toparse2 != null)
			{
				...
				{
					Component3 = StringUtils.Substring(toparse2, 0, toparse2.Length - 6);
					setComponent4(StringUtils.Substring(toparse2, toparse2.Length - 6 - toparse2));
				}
				else
				{
					Component3 = toparse2;
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field98F setComponent1(string component1)
		{
		...
		public virtual Field98F setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field98F setComponent2(string component2)
		{
		...
		public virtual Field98F setDataSourceScheme(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field98F setComponent3(string component3)
		{
		...
		public virtual Field98F setCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field98F setComponent4(string component4)
		{
		...
		public virtual Field98F setComponent4(DateTime component4)
		{
		...
		public virtual Field98F setTime(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field98F setTime(DateTime component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field98F.NAME </returns>
		...
		/// <returns> the static value of Field98F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98F get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field98F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98F get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98F> getAll(final SwiftMessage msg)
		public static IList<Field98F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98F> getAll(final SwiftTagListBlock block)
		public static IList<Field98F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field98F> result = new java.util.ArrayList<>(arr.length);
				IList<Field98F> result = new List<Field98F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 98F");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field98F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98F fromJson(final String json)
		public static Field98F fromJson(string json)
		{
