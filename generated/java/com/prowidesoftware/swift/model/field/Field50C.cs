...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field50C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.BICContainer
	[Serializable]
	public class Field50C : Field, BICContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "50C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_50C = "50C";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "B";
...
//ORIGINAL LINE: public Field50C(final String value)
		public Field50C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field50C(final com.prowidesoftware.swift.model.Tag tag)
		public Field50C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "50C"))
			{
				throw new System.ArgumentException("cannot create field 50C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field50C setComponent1(string component1)
		{
		...
		public virtual Field50C setComponent1(BIC component1)
		{
		...
		public virtual Field50C setBIC(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field50C setBIC(BIC component1)
		{
...
//ORIGINAL LINE: final java.util.List<String> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field50C.NAME </returns>
		...
		/// <returns> the static value of Field50C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field50C get(final SwiftTagListBlock block)
		public static Field50C get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field50C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field50C get(final SwiftMessage msg)
		public static Field50C get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field50C> getAll(final SwiftMessage msg)
		public static IList<Field50C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field50C> getAll(final SwiftTagListBlock block)
		public static IList<Field50C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field50C> result = new java.util.ArrayList<>(arr.length);
				IList<Field50C> result = new List<Field50C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 50C");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field50C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field50C fromJson(final String json)
		public static Field50C fromJson(string json)
		{
