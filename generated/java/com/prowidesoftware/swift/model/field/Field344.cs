...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field344 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field344 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "344";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_344 = "344";
		public const string PARSER_PATTERN = "c[N]";
		...
		/// </summary>
		public const int? MESSAGE_CATEGORIES = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field344() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field344(final String value)
		public Field344(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field344(final com.prowidesoftware.swift.model.Tag tag)
		public Field344(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "344"))
			{
				throw new System.ArgumentException("cannot create field 344 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				if (value.Length >= 1)
				{
					Component1 = StringUtils.Substring(value, 0, 1);
				}
				if (value.Length > 1)
				{
					setComponent2(StringUtils.Substring(value, 1 - value));
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Priority (component1). </summary>
		/// <returns> the Priority from component1 </returns>
		...
		public virtual Field344 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Priority (component1). </summary>
		/// <param name="component1"> the Priority to set </param>
		public virtual Field344 setPriority(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Message Categories (component2). </summary>
		/// <returns> the Message Categories from component2 </returns>
		public virtual string getMessageCategories()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Message Categories (component2) as Number </summary>
		/// <returns> the Message Categories from component2 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number MessageCategoriesAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(2));
		...
		public virtual Field344 setComponent2(string component2)
		{
		...
		public virtual Field344 setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		/// <summary>
		/// Set the Message Categories (component2). </summary>
		/// <param name="component2"> the Message Categories to set </param>
		public virtual Field344 setMessageCategories(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Message Categories (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the Message Categories content to set </param>
		public virtual Field344 setMessageCategories(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field344.NAME </returns>
		...
		/// <returns> the static value of Field344.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field344 get(final SwiftTagListBlock block)
		public static Field344 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field344 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field344 get(final SwiftMessage msg)
		public static Field344 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field344> getAll(final SwiftMessage msg)
		public static IList<Field344> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field344> getAll(final SwiftTagListBlock block)
		public static IList<Field344> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field344> result = new java.util.ArrayList<>(arr.length);
				IList<Field344> result = new List<Field344>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 344");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "priority";
				result[2] = "messageCategories";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field344 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field344 fromJson(final String json)
		public static Field344 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("priority").AsString;
			}
			if (jsonObject.get("messageCategories") != null)
			{
				field.setComponent2(jsonObject.get("messageCategories").AsString);
			}
			return field;
		}
