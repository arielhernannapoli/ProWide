...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22N extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22N : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22N";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22N = "22N";
		...
		/// </summary>
		public const int? TRANSACTION_IDENTIFIER = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field22N() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field22N(final String value)
		public Field22N(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22N(final com.prowidesoftware.swift.model.Tag tag)
		public Field22N(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22N"))
			{
				throw new System.ArgumentException("cannot create field 22N from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Transaction Identifier (component1). </summary>
		/// <returns> the Transaction Identifier from component1 </returns>
		...
		public virtual Field22N setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Transaction Identifier (component1). </summary>
		/// <param name="component1"> the Transaction Identifier to set </param>
		public virtual Field22N setTransactionIdentifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22N.NAME </returns>
		...
		/// <returns> the static value of Field22N.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22N get(final SwiftTagListBlock block)
		public static Field22N get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22N in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22N get(final SwiftMessage msg)
		public static Field22N get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22N> getAll(final SwiftMessage msg)
		public static IList<Field22N> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22N> getAll(final SwiftTagListBlock block)
		public static IList<Field22N> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22N> result = new java.util.ArrayList<>(arr.length);
				IList<Field22N> result = new List<Field22N>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22N");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "transactionIdentifier";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field22N object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22N fromJson(final String json)
		public static Field22N fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("transactionIdentifier").AsString;
			}
			return field;
		}
