...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field38H extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field38H : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "38H";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_38H = "38H";
...
//ORIGINAL LINE: public Field38H(final String value)
		public Field38H(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field38H(final com.prowidesoftware.swift.model.Tag tag)
		public Field38H(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "38H"))
			{
				throw new System.ArgumentException("cannot create field 38H from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field38H setComponent1(string component1)
		{
		...
		public virtual Field38H setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		public virtual Field38H setNumberFrom(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field38H setNumberFrom(java.lang.Number component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field38H setComponent2(string component2)
		{
		...
		public virtual Field38H setPeriodFrom(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field38H setComponent3(string component3)
		{
		...
		public virtual Field38H setComponent3(java.lang.Number component3)
		{
			if (component3 != null)
			{
		...
		public virtual Field38H setNumberTo(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field38H setNumberTo(java.lang.Number component3)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field38H setComponent4(string component4)
		{
		...
		public virtual Field38H setPeriodTo(string component4)
		{
			setComponent(4, component4);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field38H.NAME </returns>
		...
		/// <returns> the static value of Field38H.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field38H get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field38H in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field38H get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field38H> getAll(final SwiftMessage msg)
		public static IList<Field38H> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field38H> getAll(final SwiftTagListBlock block)
		public static IList<Field38H> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field38H> result = new java.util.ArrayList<>(arr.length);
				IList<Field38H> result = new List<Field38H>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 38H");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field38H object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field38H fromJson(final String json)
