...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field115 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field115 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "115";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_115 = "115";
		...
		/// </summary>
		public const int? PAYMENT_RELEASE_INFORMATION_RECEIVER = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field115() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field115(final String value)
		public Field115(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field115(final com.prowidesoftware.swift.model.Tag tag)
		public Field115(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "115"))
			{
				throw new System.ArgumentException("cannot create field 115 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Payment Release Information Receiver (component1). </summary>
		/// <returns> the Payment Release Information Receiver from component1 </returns>
		public virtual string PaymentReleaseInformationReceiver
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field115 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Payment Release Information Receiver (component1). </summary>
		/// <param name="component1"> the Payment Release Information Receiver to set </param>
		public virtual Field115 setPaymentReleaseInformationReceiver(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field115.NAME </returns>
		...
		/// <returns> the static value of Field115.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field115 get(final SwiftTagListBlock block)
		public static Field115 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field115 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field115 get(final SwiftMessage msg)
		public static Field115 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field115> getAll(final SwiftMessage msg)
		public static IList<Field115> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field115> getAll(final SwiftTagListBlock block)
		public static IList<Field115> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field115> result = new java.util.ArrayList<>(arr.length);
				IList<Field115> result = new List<Field115>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 115");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "paymentReleaseInformationReceiver";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field115 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field115 fromJson(final String json)
		public static Field115 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("paymentReleaseInformationReceiver").AsString;
			}
			return field;
		}
