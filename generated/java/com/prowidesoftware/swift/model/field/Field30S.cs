...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field30S extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field30S : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "30S";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_30S = "30S";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "D";
...
//ORIGINAL LINE: public Field30S(final String value)
		public Field30S(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field30S(final com.prowidesoftware.swift.model.Tag tag)
		public Field30S(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "30S"))
			{
				throw new System.ArgumentException("cannot create field 30S from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field30S setComponent1(string component1)
		{
		...
		public virtual Field30S setComponent1(DateTime component1)
		{
		...
		public virtual Field30S setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field30S setDate(DateTime component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field30S.NAME </returns>
		...
		/// <returns> the static value of Field30S.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field30S get(final SwiftTagListBlock block)
		public static Field30S get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field30S in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field30S get(final SwiftMessage msg)
		public static Field30S get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field30S> getAll(final SwiftMessage msg)
		public static IList<Field30S> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field30S> getAll(final SwiftTagListBlock block)
		public static IList<Field30S> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field30S> result = new java.util.ArrayList<>(arr.length);
				IList<Field30S> result = new List<Field30S>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 30S");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field30S object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field30S fromJson(final String json)
		public static Field30S fromJson(string json)
		{
