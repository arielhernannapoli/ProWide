...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field173 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field173 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string F_173 = "173";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "P";

		/// <summary>
		/// Component number for the Day Time subfield
		/// </summary>
		public const int? DAY_TIME = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field173() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field173(final String value)
		public Field173(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field173(final com.prowidesoftware.swift.model.Tag tag)
		public Field173(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "173"))
			{
				throw new System.ArgumentException("cannot create field 173 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Day Time (component1). </summary>
		/// <returns> the Day Time from component1 </returns>
		public virtual string getDayTime()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Day Time (component1) as Calendar </summary>
		/// <returns> the Day Time from component1 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime DayTimeAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getDayTime(getComponent(1));
		...
		public virtual Field173 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Day Time (component1). </summary>
		/// <param name="component1"> the Day Time to set </param>
		public virtual Field173 setDayTime(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Day Time (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Day Time content to set </param>
		public virtual Field173 setDayTime(DateTime component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field173.NAME </returns>
		...
		/// <returns> the static value of Field173.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field173 get(final SwiftTagListBlock block)
		public static Field173 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field173 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field173 get(final SwiftMessage msg)
		public static Field173 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field173> getAll(final SwiftMessage msg)
		public static IList<Field173> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field173> getAll(final SwiftTagListBlock block)
		public static IList<Field173> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field173> result = new java.util.ArrayList<>(arr.length);
				IList<Field173> result = new List<Field173>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 173");
			}
			if (component == 1)
			{
				//day + time
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field173 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field173 fromJson(final String json)
		public static Field173 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("dayTime").AsString);
			}
			return field;
		}
