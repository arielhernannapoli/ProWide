...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field58D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field58D : Field, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "58D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_58D = "58D";
		public const string PARSER_PATTERN = "[[/c][/S]$]S[$S]0-3";
		...
		/// </summary>
		public const int? NAME_AND_ADDRESS = 3;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field58D() : base(6)
		{
		}
...
//ORIGINAL LINE: public Field58D(final String value)
		public Field58D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field58D(final com.prowidesoftware.swift.model.Tag tag)
		public Field58D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "58D"))
			{
				throw new System.ArgumentException("cannot create field 58D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field58D setComponent1(string component1)
		{
		...
		public virtual Field58D setDCMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field58D setComponent2(string component2)
		{
		...
		public virtual Field58D setAccount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Name And Address as a concatenation of component3 to component6. </summary>
		...
		public virtual Field58D setComponent3(string component3)
		{
		...
		public virtual Field58D setNameAndAddressLine1(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field58D setNameAndAddressLine2(string component4)
		{
		...
		public virtual Field58D setNameAndAddressLine3(string component5)
		{
		...
		public virtual Field58D setNameAndAddressLine4(string component6)
		{
		...
		/// <summary>
		/// Set the Name And Address splitting the parameter lines into components 3 to 6. </summary>
		...
		public virtual Field58D setNameAndAddress(string value)
		{
			IList<string> lines = SwiftParseUtils.getLines(value);
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field58D setComponent4(string component4)
		{
			setComponent(4, component4);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		public virtual Field58D setComponent5(string component5)
		{
			setComponent(5, component5);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent6AsString()
		...
		public virtual Field58D setComponent6(string component6)
		{
			setComponent(6, component6);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field58D.NAME </returns>
		...
		/// <returns> the static value of Field58D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field58D get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field58D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field58D get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field58D> getAll(final SwiftMessage msg)
		public static IList<Field58D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field58D> getAll(final SwiftTagListBlock block)
		public static IList<Field58D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field58D> result = new java.util.ArrayList<>(arr.length);
				IList<Field58D> result = new List<Field58D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 58D");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "dCMark";
				result[2] = "account";
				result[3] = "nameAndAddress";
				result[4] = "nameAndAddress2";
				result[5] = "nameAndAddress3";
				result[6] = "nameAndAddress4";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field58D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field58D fromJson(final String json)
		public static Field58D fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("nameAndAddress").AsString;
			}
			if (jsonObject.get("nameAndAddress2") != null)
			{
				field.Component4 = jsonObject.get("nameAndAddress2").AsString;
			}
			if (jsonObject.get("nameAndAddress3") != null)
			{
				field.Component5 = jsonObject.get("nameAndAddress3").AsString;
			}
			if (jsonObject.get("nameAndAddress4") != null)
			{
				field.Component6 = jsonObject.get("nameAndAddress4").AsString;
			}
			return field;
		}

		/// <seealso cref= #getDCMark() </seealso>
		/// @deprecated use getDCMark() instead 
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deprecated("use getDCMark() instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public String getDC()
		[Obsolete("use getDCMark() instead")]
		public virtual string DC
		{
			get
			{
				com.prowidesoftware.deprecation.DeprecationUtils.phase2(this.GetType(), "getDC()", "Use use getDCMark() instead.");
				return DCMark;
			}
			set
			{
				com.prowidesoftware.deprecation.DeprecationUtils.phase2(this.GetType(), "setDC(String)", "Use use setDCMark(String) instead.");
				DCMark = value;
			}
		}

		/// <seealso cref= #setDCMark(String component1) </seealso>
		/// @deprecated use setDCMark(String) instead 
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deprecated("use setDCMark(String) instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public void setDC(final String DC)
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
	}
