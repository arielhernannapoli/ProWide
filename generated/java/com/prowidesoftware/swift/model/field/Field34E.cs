...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field34E extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field34E : Field, CurrencyContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "34E";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_34E = "34E";
		public const string PARSER_PATTERN = "[c]<CUR>N";
...
//ORIGINAL LINE: public Field34E(final String value)
		public Field34E(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field34E(final com.prowidesoftware.swift.model.Tag tag)
		public Field34E(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "34E"))
			{
				throw new System.ArgumentException("cannot create field 34E from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field34E setComponent1(string component1)
		{
		...
		public virtual Field34E setSign(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field34E setComponent2(string component2)
		{
		...
		public virtual Field34E setComponent2(Currency component2)
		{
		...
		public virtual Field34E setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field34E setCurrency(Currency component2)
		{
		...
		public virtual Field34E setComponent3(string component3)
		{
		...
		public virtual Field34E setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field34E setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field34E setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field34E.NAME </returns>
		...
		/// <returns> the static value of Field34E.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34E get(final SwiftTagListBlock block)
		public static Field34E get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field34E in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34E get(final SwiftMessage msg)
		public static Field34E get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34E> getAll(final SwiftMessage msg)
		public static IList<Field34E> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34E> getAll(final SwiftTagListBlock block)
		public static IList<Field34E> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field34E> result = new java.util.ArrayList<>(arr.length);
				IList<Field34E> result = new List<Field34E>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 34E");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field34E object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34E fromJson(final String json)
		public static Field34E fromJson(string json)
		{
