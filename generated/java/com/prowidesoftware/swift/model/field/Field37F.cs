...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37F : Field, DateContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37F = "37F";
...
//ORIGINAL LINE: public Field37F(final String value)
		public Field37F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37F(final com.prowidesoftware.swift.model.Tag tag)
		public Field37F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37F"))
			{
				throw new System.ArgumentException("cannot create field 37F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field37F setComponent1(string component1)
		{
		...
		public virtual Field37F setComponent1(java.lang.Number component1)
		{
		...
		public virtual Field37F setRate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field37F setRate(java.lang.Number component1)
		{
		...
		public virtual Field37F setComponent2(string component2)
		{
		...
		public virtual Field37F setComponent2(DateTime component2)
		{
		...
		public virtual Field37F setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field37F setDate(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field37F setComponent3(string component3)
		{
		...
		public virtual Field37F setDMMark(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field37F setComponent4(string component4)
		{
		...
		public virtual Field37F setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field37F setNumberofDaysMonths(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field37F setNumberofDaysMonths(java.lang.Number component4)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		public virtual Field37F setComponent5(string component5)
		{
		...
		public virtual Field37F setInformation(string component5)
		{
			setComponent(5, component5);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37F.NAME </returns>
		...
		/// <returns> the static value of Field37F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37F get(final SwiftTagListBlock block)
		public static Field37F get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37F get(final SwiftMessage msg)
		public static Field37F get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37F> getAll(final SwiftMessage msg)
		public static IList<Field37F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37F> getAll(final SwiftTagListBlock block)
		public static IList<Field37F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37F> result = new java.util.ArrayList<>(arr.length);
				IList<Field37F> result = new List<Field37F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37F");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37F fromJson(final String json)
		public static Field37F fromJson(string json)
		{
