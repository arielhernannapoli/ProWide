...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field281 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field281 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "281";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_281 = "281";
		public const string PARSER_PATTERN = "<HHMM><MOR>cS";
		public const string COMPONENTS_PATTERN = "HVLS";

		/// <summary>
		/// Component number for the Output Time subfield
		/// </summary>
		public const int? OUTPUT_TIME = 1;

		/// <summary>
		/// Component number for the MOR subfield
		/// </summary>
		public const int? MOR_Renamed = 2;
...
//ORIGINAL LINE: public Field281(final String value)
		public Field281(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field281(final com.prowidesoftware.swift.model.Tag tag)
		public Field281(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "281"))
			{
				throw new System.ArgumentException("cannot create field 281 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 33)
				{
					Component4 = StringUtils.Substring(value, 33 - value);
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Output Time (component1). </summary>
		/// <returns> the Output Time from component1 </returns>
		public virtual string getOutputTime()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Output Time (component1) as Calendar </summary>
		/// <returns> the Output Time from component1 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime OutputTimeAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getTime3(getComponent(1));
		...
		public virtual Field281 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Output Time (component1). </summary>
		/// <param name="component1"> the Output Time to set </param>
		public virtual Field281 setOutputTime(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Output Time (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Output Time content to set </param>
		public virtual Field281 setOutputTime(DateTime component1)
		{
		...
		/// <summary>
		/// Get the component2 as MOR </summary>
		/// <returns> the component2 converted to MOR or null if cannot be converted </returns>
		public virtual com.prowidesoftware.swift.model.MOR Component2AsMOR
		{
			get
			{
		...
		/// <summary>
		/// Gets the MOR (component2). </summary>
		/// <returns> the MOR from component2 </returns>
		public virtual string getMOR()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the MOR (component2) as MOR </summary>
		/// <returns> the MOR from component2 converted to MOR or null if cannot be converted </returns>
		public virtual com.prowidesoftware.swift.model.MOR MORAsMOR
		{
			get
			{
				return SwiftFormatUtils.getMOR(getComponent(2));
		...
		public virtual Field281 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the MOR (component2). </summary>
		/// <param name="component2"> the MOR to set </param>
		public virtual Field281 setMOR(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Get the component3 as Boolean </summary>
		/// <returns> the component3 converted to Boolean or null if cannot be converted </returns>
		public virtual bool? Component3AsBoolean
		{
			get
			{
		...
		/// <summary>
		/// Gets the Accepted (component3). </summary>
		/// <returns> the Accepted from component3 </returns>
		public virtual string getAccepted()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the Accepted (component3) as Boolean </summary>
		/// <returns> the Accepted from component3 converted to Boolean or null if cannot be converted </returns>
		public virtual bool? AcceptedAsBoolean
		{
			get
			{
				return SwiftFormatUtils.getBoolean(getComponent(3));
		...
		public virtual Field281 setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Accepted (component3). </summary>
		/// <param name="component3"> the Accepted to set </param>
		public virtual Field281 setAccepted(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Accepted (component3) from a Boolean object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Boolean) </seealso>
		/// <param name="component3"> Boolean with the Accepted content to set </param>
		public virtual Field281 setAccepted(bool? component3)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		/// <summary>
		/// Gets the Error (component4). </summary>
		/// <returns> the Error from component4 </returns>
		...
		public virtual Field281 setComponent4(string component4)
		{
		...
		/// <summary>
		/// Set the Error (component4). </summary>
		/// <param name="component4"> the Error to set </param>
		public virtual Field281 setError(string component4)
		{
			setComponent(4, component4);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field281.NAME </returns>
		...
		/// <returns> the static value of Field281.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field281 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field281 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field281 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field281> getAll(final SwiftMessage msg)
		public static IList<Field281> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field281> getAll(final SwiftTagListBlock block)
		public static IList<Field281> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field281> result = new java.util.ArrayList<>(arr.length);
				IList<Field281> result = new List<Field281>(arr.Length);
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field281 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field281 fromJson(final String json)
		public static Field281 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("outputTime").AsString);
			}
			if (jsonObject.get("mOR") != null)
			{
				field.setComponent2(jsonObject.get("mOR").AsString);
			}
