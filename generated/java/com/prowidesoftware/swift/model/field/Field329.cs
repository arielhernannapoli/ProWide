...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field329 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field329 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "329";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_329 = "329";
		...
		/// </summary>
		public const int? RECONNECT_ALLOWED_OPTION = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field329() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field329(final String value)
		public Field329(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field329(final com.prowidesoftware.swift.model.Tag tag)
		public Field329(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "329"))
			{
				throw new System.ArgumentException("cannot create field 329 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Reconnect Allowed Option (component1). </summary>
		/// <returns> the Reconnect Allowed Option from component1 </returns>
		public virtual string getReconnectAllowedOption()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Reconnect Allowed Option (component1) as Boolean </summary>
		/// <returns> the Reconnect Allowed Option from component1 converted to Boolean or null if cannot be converted </returns>
		public virtual bool? ReconnectAllowedOptionAsBoolean
		{
			get
			{
				return SwiftFormatUtils.getBoolean(getComponent(1));
		...
		public virtual Field329 setComponent1(string component1)
		{
		...
		public virtual Field329 setComponent1(bool? component1)
		{
		...
		/// <summary>
		/// Set the Reconnect Allowed Option (component1). </summary>
		/// <param name="component1"> the Reconnect Allowed Option to set </param>
		public virtual Field329 setReconnectAllowedOption(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Reconnect Allowed Option (component1) from a Boolean object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Boolean) </seealso>
		/// <param name="component1"> Boolean with the Reconnect Allowed Option content to set </param>
		public virtual Field329 setReconnectAllowedOption(bool? component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field329.NAME </returns>
		...
		/// <returns> the static value of Field329.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field329 get(final SwiftTagListBlock block)
		public static Field329 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field329 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field329 get(final SwiftMessage msg)
		public static Field329 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field329> getAll(final SwiftMessage msg)
		public static IList<Field329> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field329> getAll(final SwiftTagListBlock block)
		public static IList<Field329> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field329> result = new java.util.ArrayList<>(arr.length);
				IList<Field329> result = new List<Field329>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 329");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "reconnectAllowedOption";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field329 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field329 fromJson(final String json)
		public static Field329 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("reconnectAllowedOption").AsString);
			}
			return field;
		}
