...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field14C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field14C : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "14C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_14C = "14C";
...
//ORIGINAL LINE: public Field14C(final String value)
		public Field14C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field14C(final com.prowidesoftware.swift.model.Tag tag)
		public Field14C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "14C"))
			{
				throw new System.ArgumentException("cannot create field 14C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Year (component1). </summary>
		/// <returns> the Year from component1 </returns>
		...
		/// <summary>
		/// Get the Year (component1) as Number </summary>
		/// <returns> the Year from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number YearAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field14C setComponent1(string component1)
		{
		...
		public virtual Field14C setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Year (component1). </summary>
		/// <param name="component1"> the Year to set </param>
		public virtual Field14C setYear(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Year (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Year content to set </param>
		public virtual Field14C setYear(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field14C.NAME </returns>
		...
		/// <returns> the static value of Field14C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14C get(final SwiftTagListBlock block)
		public static Field14C get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field14C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14C get(final SwiftMessage msg)
		public static Field14C get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field14C> getAll(final SwiftMessage msg)
		public static IList<Field14C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field14C> getAll(final SwiftTagListBlock block)
		public static IList<Field14C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field14C> result = new java.util.ArrayList<>(arr.length);
				IList<Field14C> result = new List<Field14C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 14C");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field14C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14C fromJson(final String json)
		public static Field14C fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("year").AsString);
			}
			return field;
		}
