...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field31F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field31F : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "31F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_31F = "31F";
		public const string PARSER_PATTERN = "<DATE2>[/<DATE2>][//S]";
		public const string COMPONENTS_PATTERN = "EES";
		...
		/// </summary>
		public const int? PERIOD_DATE = 2;

		/// <summary>
		/// Component number for the Period Details subfield
		/// </summary>
		public const int? PERIOD_DETAILS = 3;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field31F() : base(3)
		{
		}
...
//ORIGINAL LINE: public Field31F(final String value)
		public Field31F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field31F(final com.prowidesoftware.swift.model.Tag tag)
		public Field31F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "31F"))
			{
				throw new System.ArgumentException("cannot create field 31F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field31F setComponent1(string component1)
		{
		...
		public virtual Field31F setComponent1(DateTime component1)
		{
		...
		public virtual Field31F setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field31F setDate(DateTime component1)
		{
		...
		/// <summary>
		/// Gets the Period Date (component2). </summary>
		/// <returns> the Period Date from component2 </returns>
		public virtual string getPeriodDate()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Period Date (component2) as Calendar </summary>
		/// <returns> the Period Date from component2 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime PeriodDateAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getDate2(getComponent(2));
		...
		public virtual Field31F setComponent2(string component2)
		{
		...
		public virtual Field31F setComponent2(DateTime component2)
		{
		...
		/// <summary>
		/// Set the Period Date (component2). </summary>
		/// <param name="component2"> the Period Date to set </param>
		public virtual Field31F setPeriodDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Period Date (component2) from a Calendar object. </summary>
		/// <seealso cref= #setComponent2(java.util.Calendar) </seealso>
		/// <param name="component2"> Calendar with the Period Date content to set </param>
		public virtual Field31F setPeriodDate(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Period Details (component3). </summary>
		/// <returns> the Period Details from component3 </returns>
		public virtual string PeriodDetails
		{
			get
			{
				return getComponent(3);
		...
		public virtual Field31F setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Period Details (component3). </summary>
		/// <param name="component3"> the Period Details to set </param>
		public virtual Field31F setPeriodDetails(string component3)
		{
			setComponent(3, component3);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field31F.NAME </returns>
		...
		/// <returns> the static value of Field31F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field31F get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field31F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field31F get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field31F> getAll(final SwiftMessage msg)
		public static IList<Field31F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field31F> getAll(final SwiftTagListBlock block)
		public static IList<Field31F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field31F> result = new java.util.ArrayList<>(arr.length);
				IList<Field31F> result = new List<Field31F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 31F");
			}
			if (component == 1)
			{
				//date
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "date";
				result[2] = "periodDate";
				result[3] = "periodDetails";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field31F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field31F fromJson(final String json)
		public static Field31F fromJson(string json)
		{
			...
			{
				field.setComponent2(jsonObject.get("periodDate").AsString);
			}
			if (jsonObject.get("periodDetails") != null)
			{
				field.Component3 = jsonObject.get("periodDetails").AsString;
			}
			return field;
		}
