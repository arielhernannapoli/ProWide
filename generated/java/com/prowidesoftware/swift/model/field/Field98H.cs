...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field98H extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field98H : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "98H";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_98H = "98H";
		public const string PARSER_PATTERN = "<TIME2>[,S][/[c]<TIME3>]";
		public const string COMPONENTS_PATTERN = "TNCW";
		...
		/// </summary>
		public const int? N_Renamed = 3;

		/// <summary>
		/// Component number for the Time 2 subfield
		/// </summary>
		public const int? TIME_2 = 4;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field98H() : base(4)
		{
		}
...
//ORIGINAL LINE: public Field98H(final String value)
		public Field98H(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field98H(final com.prowidesoftware.swift.model.Tag tag)
		public Field98H(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "98H"))
			{
				throw new System.ArgumentException("cannot create field 98H from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
			...
			if (value != null)
			{
				...
				if (right != null)
				{
					...
					else if (right.Length == 3 || right.Length == 5)
					{
						...
						setComponent4(StringUtils.Substring(right, 1 - right));
					}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Time (component1). </summary>
		/// <returns> the Time from component1 </returns>
		...
		/// <summary>
		/// Get the Time (component1) as Calendar </summary>
		/// <returns> the Time from component1 converted to Calendar or null if cannot be converted </returns>
		...
		public virtual Field98H setComponent1(string component1)
		{
		...
		public virtual Field98H setComponent1(DateTime component1)
		{
		...
		/// <summary>
		/// Set the Time (component1). </summary>
		/// <param name="component1"> the Time to set </param>
		public virtual Field98H setTime(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Time (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Time content to set </param>
		public virtual Field98H setTime(DateTime component1)
		{
		...
		/// <summary>
		/// Gets the Number (component2). </summary>
		/// <returns> the Number from component2 </returns>
		...
		/// <summary>
		/// Get the Number (component2) as Number </summary>
		/// <returns> the Number from component2 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field98H setComponent2(string component2)
		{
		...
		public virtual Field98H setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		/// <summary>
		/// Set the Number (component2). </summary>
		/// <param name="component2"> the Number to set </param>
		public virtual Field98H setNumber(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Number (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the Number content to set </param>
		public virtual Field98H setNumber(java.lang.Number component2)
		{
		...
		public virtual java.util.Currency Component3AsCurrency
		{
			get
			{
		...
		/// <summary>
		/// Gets the N (component3). </summary>
		/// <returns> the N from component3 </returns>
		...
		/// <summary>
		/// Get the N (component3) as Currency </summary>
		/// <returns> the N from component3 converted to Currency or null if cannot be converted </returns>
		public virtual java.util.Currency NAsCurrency
		{
			get
			{
				return SwiftFormatUtils.getCurrency(getComponent(3));
		...
		public virtual Field98H setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the component3 from a Currency object. </summary>
		/// <param name="component3"> the Currency with the component3 content to set </param>
		public virtual Field98H setComponent3(java.util.Currency component3)
		{
		...
		/// <summary>
		/// Set the N (component3). </summary>
		/// <param name="component3"> the N to set </param>
		public virtual Field98H setN(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the N (component3) from a Currency object. </summary>
		/// <seealso cref= #setComponent3(java.util.Currency) </seealso>
		/// <param name="component3"> Currency with the N content to set </param>
		public virtual Field98H setN(java.util.Currency component3)
		{
		...
		/// <summary>
		/// Gets the Time 2 (component4). </summary>
		/// <returns> the Time 2 from component4 </returns>
		public virtual string getTime2()
		{
			return getComponent(4);
		}

		/// <summary>
		/// Get the Time 2 (component4) as Calendar </summary>
		/// <returns> the Time 2 from component4 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime Time2AsCalendar
		{
			get
			{
				return SwiftFormatUtils.getTime3(getComponent(4));
		...
		public virtual Field98H setComponent4(string component4)
		{
		...
		public virtual Field98H setComponent4(DateTime component4)
		{
		...
		/// <summary>
		/// Set the Time 2 (component4). </summary>
		/// <param name="component4"> the Time 2 to set </param>
		public virtual Field98H setTime2(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Set the Time 2 (component4) from a Calendar object. </summary>
		/// <seealso cref= #setComponent4(java.util.Calendar) </seealso>
		/// <param name="component4"> Calendar with the Time 2 content to set </param>
		public virtual Field98H setTime2(DateTime component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field98H.NAME </returns>
		...
		/// <returns> the static value of Field98H.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98H get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field98H in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98H get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98H> getAll(final SwiftMessage msg)
		public static IList<Field98H> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field98H> getAll(final SwiftTagListBlock block)
		public static IList<Field98H> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field98H> result = new java.util.ArrayList<>(arr.length);
				IList<Field98H> result = new List<Field98H>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 98H");
			}
			if (component == 1)
			{
				//time with seconds
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field98H object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field98H fromJson(final String json)
		public static Field98H fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("time").AsString);
			}
			...
			{
				field.setComponent3(jsonObject.get("n").AsString);
			}
			if (jsonObject.get("time2") != null)
			{
				field.setComponent4(jsonObject.get("time2").AsString);
			}
			return field;
		}
