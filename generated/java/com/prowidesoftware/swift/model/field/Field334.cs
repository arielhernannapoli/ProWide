...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field334 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field334 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "334";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_334 = "334";
		public const string PARSER_PATTERN = "S<HHMM>";
		...
		/// </summary>
		public const int? DELTA_TIME = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field334() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field334(final String value)
		public Field334(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field334(final com.prowidesoftware.swift.model.Tag tag)
		public Field334(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "334"))
			{
				throw new System.ArgumentException("cannot create field 334 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Region (component1). </summary>
		/// <returns> the Region from component1 </returns>
		...
		public virtual Field334 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Region (component1). </summary>
		/// <param name="component1"> the Region to set </param>
		public virtual Field334 setRegion(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Delta Time (component2). </summary>
		/// <returns> the Delta Time from component2 </returns>
		public virtual string getDeltaTime()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Delta Time (component2) as Calendar </summary>
		/// <returns> the Delta Time from component2 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime DeltaTimeAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getTime3(getComponent(2));
		...
		public virtual Field334 setComponent2(string component2)
		{
		...
		public virtual Field334 setComponent2(DateTime component2)
		{
		...
		/// <summary>
		/// Set the Delta Time (component2). </summary>
		/// <param name="component2"> the Delta Time to set </param>
		public virtual Field334 setDeltaTime(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Delta Time (component2) from a Calendar object. </summary>
		/// <seealso cref= #setComponent2(java.util.Calendar) </seealso>
		/// <param name="component2"> Calendar with the Delta Time content to set </param>
		public virtual Field334 setDeltaTime(DateTime component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field334.NAME </returns>
		...
		/// <returns> the static value of Field334.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field334 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field334 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field334 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field334> getAll(final SwiftMessage msg)
		public static IList<Field334> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field334> getAll(final SwiftTagListBlock block)
		public static IList<Field334> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field334> result = new java.util.ArrayList<>(arr.length);
				IList<Field334> result = new List<Field334>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 334");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field334 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field334 fromJson(final String json)
		public static Field334 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("region").AsString;
			}
			if (jsonObject.get("deltaTime") != null)
			{
				field.setComponent2(jsonObject.get("deltaTime").AsString);
			}
			return field;
		}
