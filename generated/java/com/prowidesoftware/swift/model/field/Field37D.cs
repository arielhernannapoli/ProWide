...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37D : Field, DateContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37D = "37D";
...
//ORIGINAL LINE: public Field37D(final String value)
		public Field37D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37D(final com.prowidesoftware.swift.model.Tag tag)
		public Field37D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37D"))
			{
				throw new System.ArgumentException("cannot create field 37D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field37D setComponent1(string component1)
		{
		...
		public virtual Field37D setComponent1(java.lang.Number component1)
		{
		...
		public virtual Field37D setRate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field37D setRate(java.lang.Number component1)
		{
		...
		public virtual Field37D setComponent2(string component2)
		{
		...
		public virtual Field37D setComponent2(DateTime component2)
		{
		...
		public virtual Field37D setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field37D setDate(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field37D setComponent3(string component3)
		{
		...
		public virtual Field37D setDMMark(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field37D setComponent4(string component4)
		{
		...
		public virtual Field37D setComponent4(java.lang.Number component4)
		{
		...
		public virtual Field37D setNumberofDaysMonths(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field37D setNumberofDaysMonths(java.lang.Number component4)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		public virtual Field37D setComponent5(string component5)
		{
		...
		public virtual Field37D setInformation(string component5)
		{
			setComponent(5, component5);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37D.NAME </returns>
		...
		/// <returns> the static value of Field37D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37D get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37D get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37D> getAll(final SwiftMessage msg)
		public static IList<Field37D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37D> getAll(final SwiftTagListBlock block)
		public static IList<Field37D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37D> result = new java.util.ArrayList<>(arr.length);
				IList<Field37D> result = new List<Field37D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37D");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37D fromJson(final String json)
		public static Field37D fromJson(string json)
		{
