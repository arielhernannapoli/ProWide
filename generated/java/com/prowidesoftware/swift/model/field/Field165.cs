...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field165 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field165 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "165";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_165 = "165";
		...
		/// </summary>
		public const int? SERVICE_CODE = 1;

		/// <summary>
		/// Component number for the Payment Information subfield
		/// </summary>
		public const int? PAYMENT_INFORMATION = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field165() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field165(final String value)
		public Field165(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field165(final com.prowidesoftware.swift.model.Tag tag)
		public Field165(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "165"))
			{
				throw new System.ArgumentException("cannot create field 165 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Service Code (component1). </summary>
		/// <returns> the Service Code from component1 </returns>
		...
		public virtual Field165 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Service Code (component1). </summary>
		/// <param name="component1"> the Service Code to set </param>
		public virtual Field165 setServiceCode(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Payment Information (component2). </summary>
		/// <returns> the Payment Information from component2 </returns>
		public virtual string PaymentInformation
		{
			get
			{
				return getComponent(2);
		...
		public virtual Field165 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Payment Information (component2). </summary>
		/// <param name="component2"> the Payment Information to set </param>
		public virtual Field165 setPaymentInformation(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field165.NAME </returns>
		...
		/// <returns> the static value of Field165.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field165 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field165 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field165 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field165> getAll(final SwiftMessage msg)
		public static IList<Field165> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field165> getAll(final SwiftTagListBlock block)
		public static IList<Field165> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field165> result = new java.util.ArrayList<>(arr.length);
				IList<Field165> result = new List<Field165>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 165");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "serviceCode";
				result[2] = "paymentInformation";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field165 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field165 fromJson(final String json)
