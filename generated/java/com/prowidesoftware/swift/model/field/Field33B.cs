...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field33B extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field33B : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "33B";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_33B = "33B";
...
//ORIGINAL LINE: public Field33B(final String value)
		public Field33B(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field33B(final com.prowidesoftware.swift.model.Tag tag)
		public Field33B(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "33B"))
			{
				throw new System.ArgumentException("cannot create field 33B from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field33B setComponent1(string component1)
		{
		...
		public virtual Field33B setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field33B setComponent2(string component2)
		{
		...
		public virtual Field33B setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field33B setAmount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field33B setAmount(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field33B.NAME </returns>
		...
		/// <returns> the static value of Field33B.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33B get(final SwiftTagListBlock block)
		public static Field33B get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field33B in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33B get(final SwiftMessage msg)
		public static Field33B get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33B> getAll(final SwiftMessage msg)
		public static IList<Field33B> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33B> getAll(final SwiftTagListBlock block)
		public static IList<Field33B> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field33B> result = new java.util.ArrayList<>(arr.length);
				IList<Field33B> result = new List<Field33B>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 33B");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field33B object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33B fromJson(final String json)
		public static Field33B fromJson(string json)
		{
