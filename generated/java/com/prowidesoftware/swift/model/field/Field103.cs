...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field103 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field103 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const int? FINCOPY_SERVICE_CODE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field103() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field103(final String value)
		public Field103(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field103(final com.prowidesoftware.swift.model.Tag tag)
		public Field103(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "103"))
			{
				throw new System.ArgumentException("cannot create field 103 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the FINCopy Service Code (component1). </summary>
		/// <returns> the FINCopy Service Code from component1 </returns>
		public virtual string FINCopyServiceCode
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field103 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the FINCopy Service Code (component1). </summary>
		/// <param name="component1"> the FINCopy Service Code to set </param>
		public virtual Field103 setFINCopyServiceCode(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field103.NAME </returns>
		...
		/// <returns> the static value of Field103.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field103 get(final SwiftTagListBlock block)
		public static Field103 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field103 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field103 get(final SwiftMessage msg)
		public static Field103 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field103> getAll(final SwiftMessage msg)
		public static IList<Field103> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field103> getAll(final SwiftTagListBlock block)
		public static IList<Field103> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field103> result = new java.util.ArrayList<>(arr.length);
				IList<Field103> result = new List<Field103>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 103");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "fINCopyServiceCode";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field103 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field103 fromJson(final String json)
		public static Field103 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("fINCopyServiceCode").AsString;
			}
			return field;
		}
