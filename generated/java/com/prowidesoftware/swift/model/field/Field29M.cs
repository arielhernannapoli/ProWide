...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field29M extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field29M : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "29M";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_29M = "29M";
...
//ORIGINAL LINE: public Field29M(final String value)
		public Field29M(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field29M(final com.prowidesoftware.swift.model.Tag tag)
		public Field29M(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "29M"))
			{
				throw new System.ArgumentException("cannot create field 29M from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field29M setComponent1(string component1)
		{
		...
		public virtual Field29M setLocation(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field29M setComponent2(string component2)
		{
		...
		public virtual Field29M setComponent2(DateTime component2)
		{
		...
		public virtual Field29M setTime(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field29M setTime(DateTime component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field29M.NAME </returns>
		...
		/// <returns> the static value of Field29M.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29M get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field29M in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29M get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field29M> getAll(final SwiftMessage msg)
		public static IList<Field29M> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field29M> getAll(final SwiftTagListBlock block)
		public static IList<Field29M> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field29M> result = new java.util.ArrayList<>(arr.length);
				IList<Field29M> result = new List<Field29M>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 29M");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field29M object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field29M fromJson(final String json)
