...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field330 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field330 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "330";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_330 = "330";
		public const string PARSER_PATTERN = "4!N6!N6!N6!N6!N1!N";
		public const string COMPONENTS_PATTERN = "NNNNNN";
...
//ORIGINAL LINE: public Field330(final String value)
		public Field330(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field330(final com.prowidesoftware.swift.model.Tag tag)
		public Field330(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "330"))
			{
				throw new System.ArgumentException("cannot create field 330 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 28)
				{
					setComponent6(StringUtils.Substring(value, 28 - value));
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field330 setComponent1(string component1)
		{
		...
		public virtual Field330 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		public virtual Field330 setSessionNumber(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field330 setSessionNumber(java.lang.Number component1)
		{
		...
		/// <summary>
		/// Gets the ISN (component2). </summary>
		/// <returns> the ISN from component2 </returns>
		...
		/// <summary>
		/// Get the ISN (component2) as Number </summary>
		/// <returns> the ISN from component2 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field330 setComponent2(string component2)
		{
		...
		public virtual Field330 setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		/// <summary>
		/// Set the ISN (component2). </summary>
		/// <param name="component2"> the ISN to set </param>
		public virtual Field330 setISN(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the ISN (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the ISN content to set </param>
		public virtual Field330 setISN(java.lang.Number component2)
		{
		...
		/// <summary>
		/// Gets the ISN NAK (component3). </summary>
		/// <returns> the ISN NAK from component3 </returns>
		public virtual string getISNNAK()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the ISN NAK (component3) as Number </summary>
		/// <returns> the ISN NAK from component3 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number ISNNAKAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(3));
		...
		public virtual Field330 setComponent3(string component3)
		{
		...
		public virtual Field330 setComponent3(java.lang.Number component3)
		{
			if (component3 != null)
			{
		...
		/// <summary>
		/// Set the ISN NAK (component3). </summary>
		/// <param name="component3"> the ISN NAK to set </param>
		public virtual Field330 setISNNAK(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the ISN NAK (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the ISN NAK content to set </param>
		public virtual Field330 setISNNAK(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Gets the OSN (component4). </summary>
		/// <returns> the OSN from component4 </returns>
		public virtual string getOSN()
		{
			return getComponent(4);
		}

		/// <summary>
		/// Get the OSN (component4) as Number </summary>
		/// <returns> the OSN from component4 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number OSNAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(4));
		...
		public virtual Field330 setComponent4(string component4)
		{
		...
		public virtual Field330 setComponent4(java.lang.Number component4)
		{
			if (component4 != null)
			{
		...
		/// <summary>
		/// Set the OSN (component4). </summary>
		/// <param name="component4"> the OSN to set </param>
		public virtual Field330 setOSN(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Set the OSN (component4) from a Number object. </summary>
		/// <seealso cref= #setComponent4(java.lang.Number) </seealso>
		/// <param name="component4"> Number with the OSN content to set </param>
		public virtual Field330 setOSN(java.lang.Number component4)
		{
		...
		/// <summary>
		/// Gets the OSN NAK (component5). </summary>
		/// <returns> the OSN NAK from component5 </returns>
		public virtual string getOSNNAK()
		{
			return getComponent(5);
		}

		/// <summary>
		/// Get the OSN NAK (component5) as Number </summary>
		/// <returns> the OSN NAK from component5 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number OSNNAKAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(5));
		...
		public virtual Field330 setComponent5(string component5)
		{
		...
		public virtual Field330 setComponent5(java.lang.Number component5)
		{
			if (component5 != null)
			{
		...
		/// <summary>
		/// Set the OSN NAK (component5). </summary>
		/// <param name="component5"> the OSN NAK to set </param>
		public virtual Field330 setOSNNAK(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		/// <summary>
		/// Set the OSN NAK (component5) from a Number object. </summary>
		/// <seealso cref= #setComponent5(java.lang.Number) </seealso>
		/// <param name="component5"> Number with the OSN NAK content to set </param>
		public virtual Field330 setOSNNAK(java.lang.Number component5)
		{
		...
		/// <summary>
		/// Gets the ACK Replay Indicator (component6). </summary>
		/// <returns> the ACK Replay Indicator from component6 </returns>
		public virtual string getACKReplayIndicator()
		{
			return getComponent(6);
		}

		/// <summary>
		/// Get the ACK Replay Indicator (component6) as Number </summary>
		/// <returns> the ACK Replay Indicator from component6 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number ACKReplayIndicatorAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(6));
		...
		public virtual Field330 setComponent6(string component6)
		{
		...
		public virtual Field330 setComponent6(java.lang.Number component6)
		{
			if (component6 != null)
			{
		...
		/// <summary>
		/// Set the ACK Replay Indicator (component6). </summary>
		/// <param name="component6"> the ACK Replay Indicator to set </param>
		public virtual Field330 setACKReplayIndicator(string component6)
		{
			setComponent(6, component6);
			return this;
		}
		...
		/// <summary>
		/// Set the ACK Replay Indicator (component6) from a Number object. </summary>
		/// <seealso cref= #setComponent6(java.lang.Number) </seealso>
		/// <param name="component6"> Number with the ACK Replay Indicator content to set </param>
		public virtual Field330 setACKReplayIndicator(java.lang.Number component6)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field330.NAME </returns>
		...
		/// <returns> the static value of Field330.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field330 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field330 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field330 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field330> getAll(final SwiftMessage msg)
		public static IList<Field330> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field330> getAll(final SwiftTagListBlock block)
		public static IList<Field330> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field330> result = new java.util.ArrayList<>(arr.length);
				IList<Field330> result = new List<Field330>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 330");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[4] = "oSN";
				result[5] = "oSNNAK";
				result[6] = "aCKReplayIndicator";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field330 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field330 fromJson(final String json)
		public static Field330 fromJson(string json)
		{
			...
			{
				field.setComponent2(jsonObject.get("iSN").AsString);
			}
			if (jsonObject.get("iSNNAK") != null)
			{
				field.setComponent3(jsonObject.get("iSNNAK").AsString);
			}
			if (jsonObject.get("oSN") != null)
			{
				field.setComponent4(jsonObject.get("oSN").AsString);
			}
			if (jsonObject.get("oSNNAK") != null)
			{
				field.setComponent5(jsonObject.get("oSNNAK").AsString);
			}
			if (jsonObject.get("aCKReplayIndicator") != null)
			{
				field.setComponent6(jsonObject.get("aCKReplayIndicator").AsString);
			}
			return field;
		}
