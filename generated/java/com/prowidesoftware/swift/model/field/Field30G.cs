...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field30G extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field30G : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "30G";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_30G = "30G";
		public const string PARSER_PATTERN = "S/S";
		public const string COMPONENTS_PATTERN = "DD";
...
//ORIGINAL LINE: public Field30G(final String value)
		public Field30G(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field30G(final com.prowidesoftware.swift.model.Tag tag)
		public Field30G(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "30G"))
			{
				throw new System.ArgumentException("cannot create field 30G from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field30G setComponent1(string component1)
		{
		...
		public virtual Field30G setComponent1(DateTime component1)
		{
		...
		public virtual Field30G setStartDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field30G setStartDate(DateTime component1)
		{
		...
		public virtual Field30G setComponent2(string component2)
		{
		...
		public virtual Field30G setComponent2(DateTime component2)
		{
		...
		public virtual Field30G setEndDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field30G setEndDate(DateTime component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field30G.NAME </returns>
		...
		/// <returns> the static value of Field30G.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field30G get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field30G in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field30G get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field30G> getAll(final SwiftMessage msg)
		public static IList<Field30G> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field30G> getAll(final SwiftTagListBlock block)
		public static IList<Field30G> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field30G> result = new java.util.ArrayList<>(arr.length);
				IList<Field30G> result = new List<Field30G>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 30G");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field30G object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field30G fromJson(final String json)
