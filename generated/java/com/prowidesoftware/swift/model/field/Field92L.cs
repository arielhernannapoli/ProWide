...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field92L extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	...
	public class Field92L : Field, CurrencyContainer, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		...
		/// </summary>
		public const string NAME = "92L";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_92L = "92L";
		public const string PARSER_PATTERN = ":S//SN/SN";
		public const string COMPONENTS_PATTERN = "SCNCN";
...
//ORIGINAL LINE: public Field92L(final String value)
		public Field92L(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field92L(final com.prowidesoftware.swift.model.Tag tag)
		public Field92L(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "92L"))
			{
				throw new System.ArgumentException("cannot create field 92L from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field92L setComponent1(string component1)
		{
		...
		public virtual Field92L setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Currency1 (component2). </summary>
		/// <returns> the Currency1 from component2 </returns>
		...
		/// <summary>
		/// Get the Currency1 (component2) as Currency </summary>
		/// <returns> the Currency1 from component2 converted to Currency or null if cannot be converted </returns>
		...
		public virtual Field92L setComponent2(string component2)
		{
		...
		public virtual Field92L setComponent2(Currency component2)
		{
		...
		/// <summary>
		/// Set the Currency1 (component2). </summary>
		/// <param name="component2"> the Currency1 to set </param>
		public virtual Field92L setCurrency1(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Currency1 (component2) from a Currency object. </summary>
		/// <seealso cref= #setComponent2(java.util.Currency) </seealso>
		/// <param name="component2"> Currency with the Currency1 content to set </param>
		public virtual Field92L setCurrency1(Currency component2)
		{
		...
		/// <summary>
		/// Gets the Amount1 (component3). </summary>
		/// <returns> the Amount1 from component3 </returns>
		...
		/// <summary>
		/// Get the Amount1 (component3) as Number </summary>
		/// <returns> the Amount1 from component3 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field92L setComponent3(string component3)
		{
		...
		public virtual Field92L setComponent3(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Set the Amount1 (component3). </summary>
		/// <param name="component3"> the Amount1 to set </param>
		public virtual Field92L setAmount1(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Amount1 (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Amount1 content to set </param>
		public virtual Field92L setAmount1(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Gets the Currency2 (component4). </summary>
		/// <returns> the Currency2 from component4 </returns>
		...
		/// <summary>
		/// Get the Currency2 (component4) as Currency </summary>
		/// <returns> the Currency2 from component4 converted to Currency or null if cannot be converted </returns>
		...
		public virtual Field92L setComponent4(string component4)
		{
		...
		public virtual Field92L setComponent4(Currency component4)
		{
		...
		/// <summary>
		/// Set the Currency2 (component4). </summary>
		/// <param name="component4"> the Currency2 to set </param>
		public virtual Field92L setCurrency2(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Set the Currency2 (component4) from a Currency object. </summary>
		/// <seealso cref= #setComponent4(java.util.Currency) </seealso>
		/// <param name="component4"> Currency with the Currency2 content to set </param>
		public virtual Field92L setCurrency2(Currency component4)
		{
		...
		/// <summary>
		/// Gets the Amount2 (component5). </summary>
		/// <returns> the Amount2 from component5 </returns>
		...
		/// <summary>
		/// Get the Amount2 (component5) as Number </summary>
		/// <returns> the Amount2 from component5 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field92L setComponent5(string component5)
		{
		...
		public virtual Field92L setComponent5(java.lang.Number component5)
		{
		...
		/// <summary>
		/// Set the Amount2 (component5). </summary>
		/// <param name="component5"> the Amount2 to set </param>
		public virtual Field92L setAmount2(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		/// <summary>
		/// Set the Amount2 (component5) from a Number object. </summary>
		/// <seealso cref= #setComponent5(java.lang.Number) </seealso>
		/// <param name="component5"> Number with the Amount2 content to set </param>
		public virtual Field92L setAmount2(java.lang.Number component5)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field92L.NAME </returns>
		...
		/// <returns> the static value of Field92L.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92L get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field92L in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92L get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92L> getAll(final SwiftMessage msg)
		public static IList<Field92L> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92L> getAll(final SwiftTagListBlock block)
		public static IList<Field92L> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field92L> result = new java.util.ArrayList<>(arr.length);
				IList<Field92L> result = new List<Field92L>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 92L");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field92L object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92L fromJson(final String json)
		public static Field92L fromJson(string json)
		{
			...
			{
				field.setComponent2(jsonObject.get("currency1").AsString);
			}
			if (jsonObject.get("amount1") != null)
			{
				field.setComponent3(jsonObject.get("amount1").AsString);
			}
			if (jsonObject.get("currency2") != null)
			{
				field.setComponent4(jsonObject.get("currency2").AsString);
			}
			if (jsonObject.get("amount2") != null)
			{
				field.setComponent5(jsonObject.get("amount2").AsString);
			}
			return field;
		}
