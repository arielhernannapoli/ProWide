...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field254 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field254 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "254";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_254 = "254";
		public const string PARSER_PATTERN = "<MOR><MOR>[<HHMM><HHMM>]";
		public const string COMPONENTS_PATTERN = "VVHH";

		/// <summary>
		/// Component number for the Start MOR subfield
		/// </summary>
		public const int? START_MOR = 1;

		/// <summary>
		/// Component number for the End MOR subfield
		/// </summary>
		public const int? END_MOR = 2;
...
//ORIGINAL LINE: public Field254(final String value)
		public Field254(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field254(final com.prowidesoftware.swift.model.Tag tag)
		public Field254(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "254"))
			{
				throw new System.ArgumentException("cannot create field 254 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Get the component1 as MOR </summary>
		/// <returns> the component1 converted to MOR or null if cannot be converted </returns>
		public virtual com.prowidesoftware.swift.model.MOR Component1AsMOR
		{
			get
			{
		...
		/// <summary>
		/// Gets the Start MOR (component1). </summary>
		/// <returns> the Start MOR from component1 </returns>
		public virtual string getStartMOR()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Start MOR (component1) as MOR </summary>
		/// <returns> the Start MOR from component1 converted to MOR or null if cannot be converted </returns>
		public virtual com.prowidesoftware.swift.model.MOR StartMORAsMOR
		{
			get
			{
				return SwiftFormatUtils.getMOR(getComponent(1));
		...
		public virtual Field254 setComponent1(string component1)
		{
		...
		public virtual Field254 setComponent1(com.prowidesoftware.swift.model.MOR component1)
		{
		...
		/// <summary>
		/// Set the Start MOR (component1). </summary>
		/// <param name="component1"> the Start MOR to set </param>
		public virtual Field254 setStartMOR(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the End MOR (component2). </summary>
		/// <returns> the End MOR from component2 </returns>
		public virtual string getEndMOR()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the End MOR (component2) as MOR </summary>
		/// <returns> the End MOR from component2 converted to MOR or null if cannot be converted </returns>
		public virtual com.prowidesoftware.swift.model.MOR EndMORAsMOR
		{
			get
			{
				return SwiftFormatUtils.getMOR(getComponent(2));
		...
		public virtual Field254 setComponent2(string component2)
		{
		...
		public virtual Field254 setComponent2(com.prowidesoftware.swift.model.MOR component2)
		{
		...
		/// <summary>
		/// Set the End MOR (component2). </summary>
		/// <param name="component2"> the End MOR to set </param>
		public virtual Field254 setEndMOR(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the End MOR (component2) from a MOR object. </summary>
		/// <seealso cref= #setComponent2(com.prowidesoftware.swift.model.MOR) </seealso>
		/// <param name="component2"> MOR with the End MOR content to set </param>
		public virtual Field254 setEndMOR(com.prowidesoftware.swift.model.MOR component2)
		{
		...
		public virtual Field254 setComponent3(string component3)
		{
		...
		public virtual Field254 setComponent3(DateTime component3)
		{
		...
		public virtual Field254 setStartTime(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field254 setStartTime(DateTime component3)
		{
		...
		public virtual Field254 setComponent4(string component4)
		{
		...
		public virtual Field254 setComponent4(DateTime component4)
		{
		...
		public virtual Field254 setEndTime(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field254 setEndTime(DateTime component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field254.NAME </returns>
		...
		/// <returns> the static value of Field254.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field254 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field254 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field254 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field254> getAll(final SwiftMessage msg)
		public static IList<Field254> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field254> getAll(final SwiftTagListBlock block)
		public static IList<Field254> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field254> result = new java.util.ArrayList<>(arr.length);
				IList<Field254> result = new List<Field254>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 254");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field254 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field254 fromJson(final String json)
		public static Field254 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("startMOR").AsString);
			}
			if (jsonObject.get("endMOR") != null)
			{
				field.setComponent2(jsonObject.get("endMOR").AsString);
			}
