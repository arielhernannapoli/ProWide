...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field312 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field312 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "312";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_312 = "312";
		...
		/// </summary>
		public const int? BROADCAST_TEXT = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field312() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field312(final String value)
		public Field312(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field312(final com.prowidesoftware.swift.model.Tag tag)
		public Field312(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "312"))
			{
				throw new System.ArgumentException("cannot create field 312 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Broadcast Text (component1). </summary>
		/// <returns> the Broadcast Text from component1 </returns>
		public virtual string BroadcastText
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field312 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Broadcast Text (component1). </summary>
		/// <param name="component1"> the Broadcast Text to set </param>
		public virtual Field312 setBroadcastText(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field312.NAME </returns>
		...
		/// <returns> the static value of Field312.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field312 get(final SwiftTagListBlock block)
		public static Field312 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field312 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field312 get(final SwiftMessage msg)
		public static Field312 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field312> getAll(final SwiftMessage msg)
		public static IList<Field312> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field312> getAll(final SwiftTagListBlock block)
		public static IList<Field312> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field312> result = new java.util.ArrayList<>(arr.length);
				IList<Field312> result = new List<Field312>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 312");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "broadcastText";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field312 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field312 fromJson(final String json)
		public static Field312 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("broadcastText").AsString;
			}
			return field;
		}
