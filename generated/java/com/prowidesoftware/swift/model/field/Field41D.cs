...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field41D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field41D : Field, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "41D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_41D = "41D";
		public const string PARSER_PATTERN = "S[$S]0-3$S";
		public const string COMPONENTS_PATTERN = "SSSSS";

		/// <summary>
		/// Component number for the Name And Address subfield
		/// </summary>
		public const int? NAME_AND_ADDRESS = 1;
...
//ORIGINAL LINE: public Field41D(final String value)
		public Field41D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field41D(final com.prowidesoftware.swift.model.Tag tag)
		public Field41D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "41D"))
			{
				throw new System.ArgumentException("cannot create field 41D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: final java.util.List<String> lines = com.prowidesoftware.swift.model.field.SwiftParseUtils.getLines(value);
			IList<string> lines = SwiftParseUtils.getLines(value);
			string c5 = null;
			if (lines.Count > 1)
			{
				c5 = lines.Remove(lines.Count > 5 ? 4 : lines.Count - 1);
			}
			if (lines.Count > 0)
			{
				Component1 = lines[0];
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Name And Address (component1). </summary>
		/// <returns> the Name And Address from component1 </returns>
		...
		/// <summary>
		/// Gets the Name And Address as a concatenation of component1 to component4. </summary>
		...
		public virtual Field41D setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Name And Address (component1). </summary>
		/// <param name="component1"> the Name And Address to set </param>
		public virtual Field41D setNameAndAddressLine1(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field41D setNameAndAddressLine2(string component2)
		{
		...
		public virtual Field41D setNameAndAddressLine3(string component3)
		{
		...
		public virtual Field41D setNameAndAddressLine4(string component4)
		{
		...
		/// <summary>
		/// Set the Name And Address splitting the parameter lines into components 1 to 4. </summary>
		...
		public virtual Field41D setNameAndAddress(string value)
		{
			IList<string> lines = SwiftParseUtils.getLines(value);
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field41D setComponent2(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field41D setCode(string component2)
		{
			setComponent(2, component2);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		public virtual Field41D setComponent3(string component3)
		{
			setComponent(3, component3);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field41D setComponent4(string component4)
		{
			setComponent(4, component4);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		public virtual Field41D setComponent5(string component5)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field41D.NAME </returns>
		...
		/// <returns> the static value of Field41D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field41D get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field41D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field41D get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field41D> getAll(final SwiftMessage msg)
		public static IList<Field41D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field41D> getAll(final SwiftTagListBlock block)
		public static IList<Field41D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field41D> result = new java.util.ArrayList<>(arr.length);
				IList<Field41D> result = new List<Field41D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 41D");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "nameAndAddress";
				result[2] = "nameAndAddress2";
				result[3] = "nameAndAddress3";
				result[4] = "nameAndAddress4";
				result[5] = "code";
				return result;
			}
		}
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field41D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field41D fromJson(final String json)
		public static Field41D fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("nameAndAddress").AsString;
			}
			if (jsonObject.get("nameAndAddress2") != null)
			{
				field.Component2 = jsonObject.get("nameAndAddress2").AsString;
			}
			if (jsonObject.get("nameAndAddress3") != null)
			{
				field.Component3 = jsonObject.get("nameAndAddress3").AsString;
			}
			if (jsonObject.get("nameAndAddress4") != null)
			{
				field.Component4 = jsonObject.get("nameAndAddress4").AsString;
			}
			if (jsonObject.get("code") != null)
			{
				field.Component5 = jsonObject.get("code").AsString;
			}
			return field;
		}
