...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field208 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field208 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "208";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_208 = "208";
		...
		/// </summary>
		public const int? LT_DIRECTED_QUEUE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field208() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field208(final String value)
		public Field208(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field208(final com.prowidesoftware.swift.model.Tag tag)
		public Field208(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "208"))
			{
				throw new System.ArgumentException("cannot create field 208 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the LT Directed Queue (component1). </summary>
		/// <returns> the LT Directed Queue from component1 </returns>
		public virtual string getLTDirectedQueue()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the LT Directed Queue (component1) as Boolean </summary>
		/// <returns> the LT Directed Queue from component1 converted to Boolean or null if cannot be converted </returns>
		public virtual bool? LTDirectedQueueAsBoolean
		{
			get
			{
				return SwiftFormatUtils.getBoolean(getComponent(1));
		...
		public virtual Field208 setComponent1(string component1)
		{
		...
		public virtual Field208 setComponent1(bool? component1)
		{
		...
		/// <summary>
		/// Set the LT Directed Queue (component1). </summary>
		/// <param name="component1"> the LT Directed Queue to set </param>
		public virtual Field208 setLTDirectedQueue(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the LT Directed Queue (component1) from a Boolean object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Boolean) </seealso>
		/// <param name="component1"> Boolean with the LT Directed Queue content to set </param>
		public virtual Field208 setLTDirectedQueue(bool? component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field208.NAME </returns>
		...
		/// <returns> the static value of Field208.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field208 get(final SwiftTagListBlock block)
		public static Field208 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field208 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field208 get(final SwiftMessage msg)
		public static Field208 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field208> getAll(final SwiftMessage msg)
		public static IList<Field208> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field208> getAll(final SwiftTagListBlock block)
		public static IList<Field208> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field208> result = new java.util.ArrayList<>(arr.length);
				IList<Field208> result = new List<Field208>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 208");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "lTDirectedQueue";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field208 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field208 fromJson(final String json)
		public static Field208 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("lTDirectedQueue").AsString);
			}
			return field;
		}
