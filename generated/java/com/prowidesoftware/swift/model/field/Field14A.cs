...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field14A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field14A : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "14A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_14A = "14A";
		...
		/// </summary>
		public const int? CONVENTION = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field14A() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field14A(final String value)
		public Field14A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field14A(final com.prowidesoftware.swift.model.Tag tag)
		public Field14A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "14A"))
			{
				throw new System.ArgumentException("cannot create field 14A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Convention (component1). </summary>
		/// <returns> the Convention from component1 </returns>
		public virtual string Convention
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field14A setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Convention (component1). </summary>
		/// <param name="component1"> the Convention to set </param>
		public virtual Field14A setConvention(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field14A.NAME </returns>
		...
		/// <returns> the static value of Field14A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14A get(final SwiftTagListBlock block)
		public static Field14A get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field14A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14A get(final SwiftMessage msg)
		public static Field14A get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field14A> getAll(final SwiftMessage msg)
		public static IList<Field14A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field14A> getAll(final SwiftTagListBlock block)
		public static IList<Field14A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field14A> result = new java.util.ArrayList<>(arr.length);
				IList<Field14A> result = new List<Field14A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 14A");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field14A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field14A fromJson(final String json)
		public static Field14A fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("convention").AsString;
			}
			return field;
		}
