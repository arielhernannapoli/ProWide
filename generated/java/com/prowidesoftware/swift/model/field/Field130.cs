...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field130 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field130 : Field, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "130";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_130 = "130";
...
//ORIGINAL LINE: public Field130(final String value)
		public Field130(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field130(final com.prowidesoftware.swift.model.Tag tag)
		public Field130(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "130"))
			{
				throw new System.ArgumentException("cannot create field 130 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
	...
	//ORIGINAL LINE: final StringBuilder result = new StringBuilder();
				...
				result.Append("/");
				append(result, 2);
				if (getComponent3() != null || Component4 != null)
				{
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Heading Code (component1). </summary>
		/// <returns> the Heading Code from component1 </returns>
		public virtual string getHeadingCode()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Heading Code (component1) as Number </summary>
		/// <returns> the Heading Code from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number HeadingCodeAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field130 setComponent1(string component1)
		{
		...
		public virtual Field130 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Heading Code (component1). </summary>
		/// <param name="component1"> the Heading Code to set </param>
		public virtual Field130 setHeadingCode(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Heading Code (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Heading Code content to set </param>
		public virtual Field130 setHeadingCode(java.lang.Number component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Heading Text (component2). </summary>
		/// <returns> the Heading Text from component2 </returns>
		...
		public virtual Field130 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Heading Text (component2). </summary>
		/// <param name="component2"> the Heading Text to set </param>
		public virtual Field130 setHeadingText(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Gets the Heading Code 2 (component3). </summary>
		/// <returns> the Heading Code 2 from component3 </returns>
		public virtual string getHeadingCode2()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the Heading Code 2 (component3) as Number </summary>
		/// <returns> the Heading Code 2 from component3 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number HeadingCode2AsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(3));
		...
		public virtual Field130 setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Heading Code 2 (component3). </summary>
		/// <param name="component3"> the Heading Code 2 to set </param>
		public virtual Field130 setHeadingCode2(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Heading Code 2 (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Heading Code 2 content to set </param>
		public virtual Field130 setHeadingCode2(java.lang.Number component3)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		/// <summary>
		/// Gets the Heading Text 2 (component4). </summary>
		/// <returns> the Heading Text 2 from component4 </returns>
		public virtual string HeadingText2
		{
			get
			{
				return getComponent(4);
		...
		public virtual Field130 setComponent4(string component4)
		{
		...
		/// <summary>
		/// Set the Heading Text 2 (component4). </summary>
		/// <param name="component4"> the Heading Text 2 to set </param>
		public virtual Field130 setHeadingText2(string component4)
		{
			setComponent(4, component4);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field130.NAME </returns>
		...
		/// <returns> the static value of Field130.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field130 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field130 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field130 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field130> getAll(final SwiftMessage msg)
		public static IList<Field130> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field130> getAll(final SwiftTagListBlock block)
		public static IList<Field130> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field130> result = new java.util.ArrayList<>(arr.length);
				IList<Field130> result = new List<Field130>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 130");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "headingCode";
				result[2] = "headingText";
				result[3] = "headingCode2";
				result[4] = "headingText2";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field130 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field130 fromJson(final String json)
