...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field118 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field118 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "118";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_118 = "118";
		...
		/// </summary>
		public const int? LT_SUBSETS_SHARED_FLAG = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field118() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field118(final String value)
		public Field118(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field118(final com.prowidesoftware.swift.model.Tag tag)
		public Field118(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "118"))
			{
				throw new System.ArgumentException("cannot create field 118 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the LT Subsets Shared Flag (component1). </summary>
		/// <returns> the LT Subsets Shared Flag from component1 </returns>
		public virtual string getLTSubsetsSharedFlag()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the LT Subsets Shared Flag (component1) as Boolean </summary>
		/// <returns> the LT Subsets Shared Flag from component1 converted to Boolean or null if cannot be converted </returns>
		public virtual bool? LTSubsetsSharedFlagAsBoolean
		{
			get
			{
				return SwiftFormatUtils.getBoolean(getComponent(1));
		...
		public virtual Field118 setComponent1(string component1)
		{
		...
		public virtual Field118 setComponent1(bool? component1)
		{
		...
		/// <summary>
		/// Set the LT Subsets Shared Flag (component1). </summary>
		/// <param name="component1"> the LT Subsets Shared Flag to set </param>
		public virtual Field118 setLTSubsetsSharedFlag(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the LT Subsets Shared Flag (component1) from a Boolean object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Boolean) </seealso>
		/// <param name="component1"> Boolean with the LT Subsets Shared Flag content to set </param>
		public virtual Field118 setLTSubsetsSharedFlag(bool? component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field118.NAME </returns>
		...
		/// <returns> the static value of Field118.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field118 get(final SwiftTagListBlock block)
		public static Field118 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field118 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field118 get(final SwiftMessage msg)
		public static Field118 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field118> getAll(final SwiftMessage msg)
		public static IList<Field118> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field118> getAll(final SwiftTagListBlock block)
		public static IList<Field118> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field118> result = new java.util.ArrayList<>(arr.length);
				IList<Field118> result = new List<Field118>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 118");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "lTSubsetsSharedFlag";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field118 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field118 fromJson(final String json)
		public static Field118 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("lTSubsetsSharedFlag").AsString);
			}
			return field;
		}
