...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field129 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field129 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "129";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_129 = "129";
...
//ORIGINAL LINE: public Field129(final String value)
		public Field129(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field129(final com.prowidesoftware.swift.model.Tag tag)
		public Field129(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "129"))
			{
				throw new System.ArgumentException("cannot create field 129 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Section (component1). </summary>
		/// <returns> the Section from component1 </returns>
		...
		/// <summary>
		/// Get the Section (component1) as Number </summary>
		/// <returns> the Section from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number SectionAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field129 setComponent1(string component1)
		{
		...
		public virtual Field129 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Section (component1). </summary>
		/// <param name="component1"> the Section to set </param>
		public virtual Field129 setSection(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Total (component2). </summary>
		/// <returns> the Total from component2 </returns>
		public virtual string getTotal()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Total (component2) as Number </summary>
		/// <returns> the Total from component2 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number TotalAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(2));
		...
		public virtual Field129 setComponent2(string component2)
		{
		...
		public virtual Field129 setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		/// <summary>
		/// Set the Total (component2). </summary>
		/// <param name="component2"> the Total to set </param>
		public virtual Field129 setTotal(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field129.NAME </returns>
		...
		/// <returns> the static value of Field129.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field129 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field129 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field129 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field129> getAll(final SwiftMessage msg)
		public static IList<Field129> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field129> getAll(final SwiftTagListBlock block)
		public static IList<Field129> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field129> result = new java.util.ArrayList<>(arr.length);
				IList<Field129> result = new List<Field129>(arr.Length);
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field129 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field129 fromJson(final String json)
		public static Field129 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("section").AsString);
			}
			if (jsonObject.get("total") != null)
			{
				field.setComponent2(jsonObject.get("total").AsString);
			}
			return field;
		}
