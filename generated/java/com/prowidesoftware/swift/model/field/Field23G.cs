...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field23G extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field23G : Field
	{
		...
		/// </summary>
		public const string NAME = "23G";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_23G = "23G";
		...
		/// </summary>
		public const int? SUBFUNCTION = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field23G() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field23G(final String value)
		public Field23G(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field23G(final com.prowidesoftware.swift.model.Tag tag)
		public Field23G(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "23G"))
			{
				throw new System.ArgumentException("cannot create field 23G from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Function (component1). </summary>
		/// <returns> the Function from component1 </returns>
		...
		public virtual Field23G setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Function (component1). </summary>
		/// <param name="component1"> the Function to set </param>
		public virtual Field23G setFunction(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Subfunction (component2). </summary>
		/// <returns> the Subfunction from component2 </returns>
		...
		public virtual Field23G setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Subfunction (component2). </summary>
		/// <param name="component2"> the Subfunction to set </param>
		public virtual Field23G setSubfunction(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field23G.NAME </returns>
		...
		/// <returns> the static value of Field23G.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field23G get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field23G in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field23G get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field23G> getAll(final SwiftMessage msg)
		public static IList<Field23G> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field23G> getAll(final SwiftTagListBlock block)
		public static IList<Field23G> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field23G> result = new java.util.ArrayList<>(arr.length);
				IList<Field23G> result = new List<Field23G>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 23G");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "function";
				result[2] = "subfunction";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field23G object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field23G fromJson(final String json)
		public static Field23G fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("function").AsString;
			}
			if (jsonObject.get("subfunction") != null)
			{
				field.Component2 = jsonObject.get("subfunction").AsString;
			}
			return field;
		}
