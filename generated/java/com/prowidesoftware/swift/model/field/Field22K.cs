...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22K extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22K : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22K";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22K = "22K";
		...
		/// </summary>
		public const int? TYPE_OF_EVENT = 1;
...
//ORIGINAL LINE: public Field22K(final String value)
		public Field22K(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22K(final com.prowidesoftware.swift.model.Tag tag)
		public Field22K(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22K"))
			{
				throw new System.ArgumentException("cannot create field 22K from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Type Of Event (component1). </summary>
		/// <returns> the Type Of Event from component1 </returns>
		public virtual string TypeOfEvent
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field22K setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Type Of Event (component1). </summary>
		/// <param name="component1"> the Type Of Event to set </param>
		public virtual Field22K setTypeOfEvent(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field22K setComponent2(string component2)
		{
		...
		public virtual Field22K setNarrative(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22K.NAME </returns>
		...
		/// <returns> the static value of Field22K.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22K get(final SwiftTagListBlock block)
		public static Field22K get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22K in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22K get(final SwiftMessage msg)
		public static Field22K get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22K> getAll(final SwiftMessage msg)
		public static IList<Field22K> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22K> getAll(final SwiftTagListBlock block)
		public static IList<Field22K> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22K> result = new java.util.ArrayList<>(arr.length);
				IList<Field22K> result = new List<Field22K>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22K");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field22K object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22K fromJson(final String json)
		public static Field22K fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("typeOfEvent").AsString;
			}
