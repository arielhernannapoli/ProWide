...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field13D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field13D : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "13D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_13D = "13D";
		public const string PARSER_PATTERN = "<DATE2><HHMM><SIGN><OFFSET>";
		public const string COMPONENTS_PATTERN = "EHGO";
...
//ORIGINAL LINE: public Field13D(final String value)
		public Field13D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field13D(final com.prowidesoftware.swift.model.Tag tag)
		public Field13D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "13D"))
			{
				throw new System.ArgumentException("cannot create field 13D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length >= 11)
				{
					Component3 = StringUtils.Substring(value, 10, 11);
				}
				if (value.Length > 11)
				{
					setComponent4(StringUtils.Substring(value, 11 - value));
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field13D setComponent1(string component1)
		{
		...
		public virtual Field13D setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field13D setDate(DateTime component1)
		{
		...
		public virtual Field13D setComponent2(string component2)
		{
		...
		public virtual Field13D setTime(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field13D setTime(DateTime component2)
		{
		...
		public virtual Field13D setComponent3(string component3)
		{
		...
		public virtual Field13D setSign(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field13D setComponent4(string component4)
		{
		...
		public virtual Field13D setComponent4(DateTime component4)
		{
		...
		public virtual Field13D setOffset(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field13D setOffset(DateTime component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field13D.NAME </returns>
		...
		/// <returns> the static value of Field13D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field13D get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field13D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field13D get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field13D> getAll(final SwiftMessage msg)
		public static IList<Field13D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field13D> getAll(final SwiftTagListBlock block)
		public static IList<Field13D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field13D> result = new java.util.ArrayList<>(arr.length);
				IList<Field13D> result = new List<Field13D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 13D");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field13D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field13D fromJson(final String json)
