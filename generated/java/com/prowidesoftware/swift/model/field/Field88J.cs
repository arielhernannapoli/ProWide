...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field88J extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field88J : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "88J";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_88J = "88J";
		...
		/// </summary>
		public const int? PARTY_IDENTIFICATION = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field88J() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field88J(final String value)
		public Field88J(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field88J(final com.prowidesoftware.swift.model.Tag tag)
		public Field88J(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "88J"))
			{
				throw new System.ArgumentException("cannot create field 88J from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Party Identification (component1). </summary>
		/// <returns> the Party Identification from component1 </returns>
		...
		public virtual Field88J setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Party Identification (component1). </summary>
		/// <param name="component1"> the Party Identification to set </param>
		public virtual Field88J setPartyIdentification(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field88J.NAME </returns>
		...
		/// <returns> the static value of Field88J.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field88J get(final SwiftTagListBlock block)
		public static Field88J get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field88J in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field88J get(final SwiftMessage msg)
		public static Field88J get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field88J> getAll(final SwiftMessage msg)
		public static IList<Field88J> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field88J> getAll(final SwiftTagListBlock block)
		public static IList<Field88J> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field88J> result = new java.util.ArrayList<>(arr.length);
				IList<Field88J> result = new List<Field88J>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 88J");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "partyIdentification";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field88J object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field88J fromJson(final String json)
		public static Field88J fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("partyIdentification").AsString;
			}
			return field;
		}
