...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field92M extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	...
	public class Field92M : Field, CurrencyContainer, AmountContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		...
		/// </summary>
		public const string NAME = "92M";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_92M = "92M";
		public const string PARSER_PATTERN = ":S//SN/S";
		public const string COMPONENTS_PATTERN = "SCNN";
...
//ORIGINAL LINE: public Field92M(final String value)
		public Field92M(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field92M(final com.prowidesoftware.swift.model.Tag tag)
		public Field92M(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "92M"))
			{
				throw new System.ArgumentException("cannot create field 92M from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field92M setComponent1(string component1)
		{
		...
		public virtual Field92M setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field92M setComponent2(string component2)
		{
		...
		public virtual Field92M setComponent2(Currency component2)
		{
		...
		public virtual Field92M setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field92M setCurrency(Currency component2)
		{
		...
		public virtual Field92M setComponent3(string component3)
		{
		...
		public virtual Field92M setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field92M setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field92M setAmount(java.lang.Number component3)
		{
		...
		/// <summary>
		/// Gets the Quantity (component4). </summary>
		/// <returns> the Quantity from component4 </returns>
		...
		/// <summary>
		/// Get the Quantity (component4) as Number </summary>
		/// <returns> the Quantity from component4 converted to Number or null if cannot be converted </returns>
		...
		public virtual Field92M setComponent4(string component4)
		{
		...
		public virtual Field92M setComponent4(java.lang.Number component4)
		{
		...
		/// <summary>
		/// Set the Quantity (component4). </summary>
		/// <param name="component4"> the Quantity to set </param>
		public virtual Field92M setQuantity(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		/// <summary>
		/// Set the Quantity (component4) from a Number object. </summary>
		/// <seealso cref= #setComponent4(java.lang.Number) </seealso>
		/// <param name="component4"> Number with the Quantity content to set </param>
		public virtual Field92M setQuantity(java.lang.Number component4)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field92M.NAME </returns>
		...
		/// <returns> the static value of Field92M.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92M get(final SwiftTagListBlock block)
		public static Field92M get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field92M in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92M get(final SwiftMessage msg)
		public static Field92M get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92M> getAll(final SwiftMessage msg)
		public static IList<Field92M> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field92M> getAll(final SwiftTagListBlock block)
		public static IList<Field92M> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field92M> result = new java.util.ArrayList<>(arr.length);
				IList<Field92M> result = new List<Field92M>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 92M");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field92M object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field92M fromJson(final String json)
		public static Field92M fromJson(string json)
		{
			...
			{
				field.setComponent4(jsonObject.get("quantity").AsString);
			}
			return field;
		}
