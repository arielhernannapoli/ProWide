...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field32G extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field32G : Field, CurrencyContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "32G";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_32G = "32G";
...
//ORIGINAL LINE: public Field32G(final String value)
		public Field32G(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field32G(final com.prowidesoftware.swift.model.Tag tag)
		public Field32G(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "32G"))
			{
				throw new System.ArgumentException("cannot create field 32G from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field32G setComponent1(string component1)
		{
		...
		public virtual Field32G setComponent1(Currency component1)
		{
		...
		public virtual Field32G setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field32G setCurrency(Currency component1)
		{
		...
		public virtual Field32G setComponent2(string component2)
		{
		...
		public virtual Field32G setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field32G setAmount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field32G setAmount(java.lang.Number component2)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field32G.NAME </returns>
		...
		/// <returns> the static value of Field32G.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32G get(final SwiftTagListBlock block)
		public static Field32G get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field32G in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32G get(final SwiftMessage msg)
		public static Field32G get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field32G> getAll(final SwiftMessage msg)
		public static IList<Field32G> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field32G> getAll(final SwiftTagListBlock block)
		public static IList<Field32G> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field32G> result = new java.util.ArrayList<>(arr.length);
				IList<Field32G> result = new List<Field32G>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 32G");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field32G object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32G fromJson(final String json)
		public static Field32G fromJson(string json)
		{
