...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field32D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	...
	public class Field32D : Field, CurrencyContainer, DateContainer, AmountContainer
	{
		...
		/// </summary>
		public const string NAME = "32D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_32D = "32D";
...
//ORIGINAL LINE: public Field32D(final String value)
		public Field32D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field32D(final com.prowidesoftware.swift.model.Tag tag)
		public Field32D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "32D"))
			{
				throw new System.ArgumentException("cannot create field 32D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field32D setComponent1(string component1)
		{
		...
		public virtual Field32D setComponent1(DateTime component1)
		{
		...
		public virtual Field32D setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field32D setDate(DateTime component1)
		{
		...
		public virtual Field32D setComponent2(string component2)
		{
		...
		public virtual Field32D setComponent2(Currency component2)
		{
		...
		public virtual Field32D setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field32D setCurrency(Currency component2)
		{
		...
		public virtual Field32D setComponent3(string component3)
		{
		...
		public virtual Field32D setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field32D setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field32D setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field32D.NAME </returns>
		...
		/// <returns> the static value of Field32D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32D get(final SwiftTagListBlock block)
		public static Field32D get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field32D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32D get(final SwiftMessage msg)
		public static Field32D get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field32D> getAll(final SwiftMessage msg)
		public static IList<Field32D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field32D> getAll(final SwiftTagListBlock block)
		public static IList<Field32D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field32D> result = new java.util.ArrayList<>(arr.length);
				IList<Field32D> result = new List<Field32D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 32D");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field32D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32D fromJson(final String json)
		public static Field32D fromJson(string json)
		{
