...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field280 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field280 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "280";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_280 = "280";
		public const string PARSER_PATTERN = "<HHMM><MIR>cS";
		public const string COMPONENTS_PATTERN = "HRLS";

		/// <summary>
		/// Component number for the Input Time subfield
		/// </summary>
		public const int? INPUT_TIME = 1;
...
//ORIGINAL LINE: public Field280(final String value)
		public Field280(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field280(final com.prowidesoftware.swift.model.Tag tag)
		public Field280(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "280"))
			{
				throw new System.ArgumentException("cannot create field 280 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Input Time (component1). </summary>
		/// <returns> the Input Time from component1 </returns>
		public virtual string getInputTime()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Input Time (component1) as Calendar </summary>
		/// <returns> the Input Time from component1 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime InputTimeAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getTime3(getComponent(1));
		...
		public virtual Field280 setComponent1(string component1)
		{
		...
		public virtual Field280 setComponent1(DateTime component1)
		{
		...
		/// <summary>
		/// Set the Input Time (component1). </summary>
		/// <param name="component1"> the Input Time to set </param>
		public virtual Field280 setInputTime(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Input Time (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Input Time content to set </param>
		public virtual Field280 setInputTime(DateTime component1)
		{
		...
		public virtual Field280 setComponent2(string component2)
		{
		...
		public virtual Field280 setComponent2(com.prowidesoftware.swift.model.MIR component2)
		{
		...
		public virtual Field280 setMIR(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field280 setMIR(com.prowidesoftware.swift.model.MIR component2)
		{
		...
		public virtual Field280 setComponent3(string component3)
		{
		...
		public virtual Field280 setComponent3(bool? component3)
		{
		...
		public virtual Field280 setAccepted(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field280 setAccepted(bool? component3)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		public virtual Field280 setComponent4(string component4)
		{
		...
		public virtual Field280 setError(string component4)
		{
			setComponent(4, component4);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field280.NAME </returns>
		...
		/// <returns> the static value of Field280.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field280 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field280 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field280 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field280> getAll(final SwiftMessage msg)
		public static IList<Field280> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field280> getAll(final SwiftTagListBlock block)
		public static IList<Field280> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field280> result = new java.util.ArrayList<>(arr.length);
				IList<Field280> result = new List<Field280>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 280");
			}
			if (component == 1)
			{
				//time
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field280 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field280 fromJson(final String json)
