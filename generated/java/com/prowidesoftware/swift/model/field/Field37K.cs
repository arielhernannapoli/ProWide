...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field37K extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field37K : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "37K";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_37K = "37K";
...
//ORIGINAL LINE: public Field37K(final String value)
		public Field37K(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field37K(final com.prowidesoftware.swift.model.Tag tag)
		public Field37K(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "37K"))
			{
				throw new System.ArgumentException("cannot create field 37K from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field37K setComponent1(string component1)
		{
		...
		public virtual Field37K setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field37K setComponent2(string component2)
		{
		...
		public virtual Field37K setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field37K setRate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field37K setRate(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field37K.NAME </returns>
		...
		/// <returns> the static value of Field37K.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37K get(final SwiftTagListBlock block)
		public static Field37K get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field37K in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37K get(final SwiftMessage msg)
		public static Field37K get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37K> getAll(final SwiftMessage msg)
		public static IList<Field37K> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field37K> getAll(final SwiftTagListBlock block)
		public static IList<Field37K> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field37K> result = new java.util.ArrayList<>(arr.length);
				IList<Field37K> result = new List<Field37K>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 37K");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field37K object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field37K fromJson(final String json)
		public static Field37K fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("currency").AsString;
			}
