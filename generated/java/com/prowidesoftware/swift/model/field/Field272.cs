...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field272 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field272 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "272";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_272 = "272";
		public const string PARSER_PATTERN = "10!NS";
		public const string COMPONENTS_PATTERN = "US";
...
//ORIGINAL LINE: public Field272(final String value)
		public Field272(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field272(final com.prowidesoftware.swift.model.Tag tag)
		public Field272(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "272"))
			{
				throw new System.ArgumentException("cannot create field 272 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				...
				if (value.Length > 10)
				{
					Component2 = StringUtils.Substring(value, 10 - value);
				}
			}
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Timestamp (component1). </summary>
		/// <returns> the Timestamp from component1 </returns>
		...
		/// <summary>
		/// Get the Timestamp (component1) as Calendar </summary>
		/// <returns> the Timestamp from component1 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime TimestampAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getDateTimeShortYear(getComponent(1));
		...
		public virtual Field272 setComponent1(string component1)
		{
		...
		public virtual Field272 setComponent1(DateTime component1)
		{
		...
		/// <summary>
		/// Set the Timestamp (component1). </summary>
		/// <param name="component1"> the Timestamp to set </param>
		public virtual Field272 setTimestamp(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Timestamp (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Timestamp content to set </param>
		public virtual Field272 setTimestamp(DateTime component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Abort (component2). </summary>
		/// <returns> the Abort from component2 </returns>
		...
		public virtual Field272 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Abort (component2). </summary>
		/// <param name="component2"> the Abort to set </param>
		public virtual Field272 setAbort(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field272.NAME </returns>
		...
		/// <returns> the static value of Field272.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field272 get(final SwiftTagListBlock block)
		public static Field272 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field272 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field272 get(final SwiftMessage msg)
		public static Field272 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field272> getAll(final SwiftMessage msg)
		public static IList<Field272> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field272> getAll(final SwiftTagListBlock block)
		public static IList<Field272> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field272> result = new java.util.ArrayList<>(arr.length);
				IList<Field272> result = new List<Field272>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 272");
			}
			if (component == 1)
			{
				//date + time
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field272 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field272 fromJson(final String json)
		public static Field272 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("timestamp").AsString);
			}
			if (jsonObject.get("abort") != null)
			{
				field.Component2 = jsonObject.get("abort").AsString;
			}
			return field;
		}
