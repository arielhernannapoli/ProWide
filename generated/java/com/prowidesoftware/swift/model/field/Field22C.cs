...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22C : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22C = "22C";
		public const string PARSER_PATTERN = "4!S2!S4!S4!S2!S";
		public const string COMPONENTS_PATTERN = "SSNSS";

		/// <summary>
		/// Component number for the Party Prefix 1 subfield
		/// </summary>
		public const int? PARTY_PREFIX_1 = 1;

		/// <summary>
		/// Component number for the Party Suffix 1 subfield
		/// </summary>
		public const int? PARTY_SUFFIX_1 = 2;

		/// <summary>
		/// Component number for the Reference Code subfield
		/// </summary>
		public const int? REFERENCE_CODE = 3;

		/// <summary>
		/// Component number for the Party Prefix 2 subfield
		/// </summary>
		public const int? PARTY_PREFIX_2 = 4;

		/// <summary>
		/// Component number for the Party Suffix 2 subfield
		/// </summary>
		public const int? PARTY_SUFFIX_2 = 5;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field22C() : base(5)
		{
		}
...
//ORIGINAL LINE: public Field22C(final String value)
		public Field22C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22C(final com.prowidesoftware.swift.model.Tag tag)
		public Field22C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22C"))
			{
				throw new System.ArgumentException("cannot create field 22C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				if (value.Length >= 4)
				{
					Component1 = StringUtils.Substring(value, 0, 4);
				}
				if (value.Length >= 6)
				{
					Component2 = StringUtils.Substring(value, 4, 6);
				}
				if (value.Length >= 10)
				{
				...
				if (value.Length >= 14)
				{
					Component4 = StringUtils.Substring(value, 10, 14);
				}
				if (value.Length > 14)
				{
					Component5 = StringUtils.Substring(value, 14 - value);
				}
			}
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Party Prefix 1 (component1). </summary>
		/// <returns> the Party Prefix 1 from component1 </returns>
		public virtual string PartyPrefix1
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field22C setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Party Prefix 1 (component1). </summary>
		/// <param name="component1"> the Party Prefix 1 to set </param>
		public virtual Field22C setPartyPrefix1(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Party Suffix 1 (component2). </summary>
		/// <returns> the Party Suffix 1 from component2 </returns>
		public virtual string PartySuffix1
		{
			get
			{
				return getComponent(2);
		...
		public virtual Field22C setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Party Suffix 1 (component2). </summary>
		/// <param name="component2"> the Party Suffix 1 to set </param>
		public virtual Field22C setPartySuffix1(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Gets the Reference Code (component3). </summary>
		/// <returns> the Reference Code from component3 </returns>
		public virtual string getReferenceCode()
		{
			return getComponent(3);
		}

		/// <summary>
		/// Get the Reference Code (component3) as Number </summary>
		/// <returns> the Reference Code from component3 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number ReferenceCodeAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(3));
		...
		public virtual Field22C setComponent3(string component3)
		{
		...
		public virtual Field22C setComponent3(java.lang.Number component3)
		{
			if (component3 != null)
			{
		...
		/// <summary>
		/// Set the Reference Code (component3). </summary>
		/// <param name="component3"> the Reference Code to set </param>
		public virtual Field22C setReferenceCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		/// <summary>
		/// Set the Reference Code (component3) from a Number object. </summary>
		/// <seealso cref= #setComponent3(java.lang.Number) </seealso>
		/// <param name="component3"> Number with the Reference Code content to set </param>
		public virtual Field22C setReferenceCode(java.lang.Number component3)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent4AsString()
		...
		/// <summary>
		/// Gets the Party Prefix 2 (component4). </summary>
		/// <returns> the Party Prefix 2 from component4 </returns>
		public virtual string PartyPrefix2
		{
			get
			{
				return getComponent(4);
		...
		public virtual Field22C setComponent4(string component4)
		{
		...
		/// <summary>
		/// Set the Party Prefix 2 (component4). </summary>
		/// <param name="component4"> the Party Prefix 2 to set </param>
		public virtual Field22C setPartyPrefix2(string component4)
		{
			setComponent(4, component4);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent5AsString()
		...
		/// <summary>
		/// Gets the Party Suffix 2 (component5). </summary>
		/// <returns> the Party Suffix 2 from component5 </returns>
		public virtual string PartySuffix2
		{
			get
			{
				return getComponent(5);
		...
		public virtual Field22C setComponent5(string component5)
		{
		...
		/// <summary>
		/// Set the Party Suffix 2 (component5). </summary>
		/// <param name="component5"> the Party Suffix 2 to set </param>
		public virtual Field22C setPartySuffix2(string component5)
		{
			setComponent(5, component5);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22C.NAME </returns>
		...
		/// <returns> the static value of Field22C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22C get(final SwiftTagListBlock block)
		public static Field22C get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22C get(final SwiftMessage msg)
		public static Field22C get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22C> getAll(final SwiftMessage msg)
		public static IList<Field22C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22C> getAll(final SwiftTagListBlock block)
		public static IList<Field22C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22C> result = new java.util.ArrayList<>(arr.length);
				IList<Field22C> result = new List<Field22C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22C");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "partyPrefix1";
				result[2] = "partySuffix1";
				result[3] = "referenceCode";
				result[4] = "partyPrefix2";
				result[5] = "partySuffix2";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field22C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22C fromJson(final String json)
