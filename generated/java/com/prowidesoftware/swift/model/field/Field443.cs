...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field443 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field443 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "443";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_443 = "443";
		...
		/// </summary>
		public const int? REASON_CODE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field443() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field443(final String value)
		public Field443(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field443(final com.prowidesoftware.swift.model.Tag tag)
		public Field443(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "443"))
			{
				throw new System.ArgumentException("cannot create field 443 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Reason Code (component1). </summary>
		/// <returns> the Reason Code from component1 </returns>
		...
		public virtual Field443 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Reason Code (component1). </summary>
		/// <param name="component1"> the Reason Code to set </param>
		public virtual Field443 setReasonCode(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field443.NAME </returns>
		...
		/// <returns> the static value of Field443.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field443 get(final SwiftTagListBlock block)
		public static Field443 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field443 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field443 get(final SwiftMessage msg)
		public static Field443 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field443> getAll(final SwiftMessage msg)
		public static IList<Field443> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field443> getAll(final SwiftTagListBlock block)
		public static IList<Field443> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field443> result = new java.util.ArrayList<>(arr.length);
				IList<Field443> result = new List<Field443>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 443");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field443 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field443 fromJson(final String json)
		public static Field443 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("reasonCode").AsString;
			}
			return field;
		}
