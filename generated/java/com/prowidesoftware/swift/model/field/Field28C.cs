...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field28C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field28C : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "28C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_28C = "28C";
...
//ORIGINAL LINE: public Field28C(final String value)
		public Field28C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field28C(final com.prowidesoftware.swift.model.Tag tag)
		public Field28C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "28C"))
			{
				throw new System.ArgumentException("cannot create field 28C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field28C setComponent1(string component1)
		{
		...
		public virtual Field28C setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		public virtual Field28C setStatementNumber(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field28C setStatementNumber(java.lang.Number component1)
		{
		...
		public virtual Field28C setComponent2(string component2)
		{
		...
		public virtual Field28C setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		public virtual Field28C setSequenceNumber(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field28C setSequenceNumber(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field28C.NAME </returns>
		...
		/// <returns> the static value of Field28C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field28C get(final SwiftTagListBlock block)
		public static Field28C get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field28C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field28C get(final SwiftMessage msg)
		public static Field28C get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field28C> getAll(final SwiftMessage msg)
		public static IList<Field28C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field28C> getAll(final SwiftTagListBlock block)
		public static IList<Field28C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field28C> result = new java.util.ArrayList<>(arr.length);
				IList<Field28C> result = new List<Field28C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 28C");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field28C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field28C fromJson(final String json)
		public static Field28C fromJson(string json)
		{
