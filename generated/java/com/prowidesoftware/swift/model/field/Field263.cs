...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field263 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer
	[Serializable]
	public class Field263 : Field, DateContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "263";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_263 = "263";
...
//ORIGINAL LINE: public Field263(final String value)
		public Field263(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field263(final com.prowidesoftware.swift.model.Tag tag)
		public Field263(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "263"))
			{
				throw new System.ArgumentException("cannot create field 263 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field263 setComponent1(string component1)
		{
		...
		public virtual Field263 setComponent1(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
		...
		public virtual Field263 setLTAddress(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field263 setLTAddress(com.prowidesoftware.swift.model.LogicalTerminalAddress component1)
		{
		...
		public virtual Field263 setComponent2(string component2)
		{
		...
		public virtual Field263 setComponent2(DateTime component2)
		{
		...
		public virtual Field263 setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field263 setDate(DateTime component2)
		{
		...
		public virtual Field263 setComponent3(string component3)
		{
		...
		public virtual Field263 setComponent3(DateTime component3)
		{
		...
		public virtual Field263 setStartTime(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field263 setStartTime(DateTime component3)
		{
		...
		public virtual Field263 setComponent4(string component4)
		{
		...
		public virtual Field263 setComponent4(DateTime component4)
		{
		...
		public virtual Field263 setEndTime(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field263 setEndTime(DateTime component4)
		{
		...
		public virtual Field263 setComponent5(string component5)
		{
		...
		public virtual Field263 setComponent5(java.lang.Number component5)
		{
			if (component5 != null)
			{
		...
		public virtual Field263 setSessionNumber(string component5)
		{
			setComponent(5, component5);
			return this;
		}
		...
		public virtual Field263 setSessionNumber(java.lang.Number component5)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field263.NAME </returns>
		...
		/// <returns> the static value of Field263.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field263 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field263 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field263 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field263> getAll(final SwiftMessage msg)
		public static IList<Field263> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field263> getAll(final SwiftTagListBlock block)
		public static IList<Field263> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field263> result = new java.util.ArrayList<>(arr.length);
				IList<Field263> result = new List<Field263>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 263");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field263 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field263 fromJson(final String json)
