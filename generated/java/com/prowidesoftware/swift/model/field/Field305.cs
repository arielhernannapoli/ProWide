...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field305 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field305 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "305";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_305 = "305";
		...
		/// </summary>
		public const int? LT_Renamed = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field305() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field305(final String value)
		public Field305(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field305(final com.prowidesoftware.swift.model.Tag tag)
		public Field305(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "305"))
			{
				throw new System.ArgumentException("cannot create field 305 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the LT (component1). </summary>
		/// <returns> the LT from component1 </returns>
		...
		public virtual Field305 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the LT (component1). </summary>
		/// <param name="component1"> the LT to set </param>
		public virtual Field305 setLT(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field305.NAME </returns>
		...
		/// <returns> the static value of Field305.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field305 get(final SwiftTagListBlock block)
		public static Field305 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field305 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field305 get(final SwiftMessage msg)
		public static Field305 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field305> getAll(final SwiftMessage msg)
		public static IList<Field305> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field305> getAll(final SwiftTagListBlock block)
		public static IList<Field305> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field305> result = new java.util.ArrayList<>(arr.length);
				IList<Field305> result = new List<Field305>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 305");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field305 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field305 fromJson(final String json)
		public static Field305 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("lT").AsString;
			}
			return field;
		}
