...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field12F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field12F : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "12F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_12F = "12F";
		...
		/// </summary>
		public const int? OPTION_STYLE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field12F() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field12F(final String value)
		public Field12F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field12F(final com.prowidesoftware.swift.model.Tag tag)
		public Field12F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "12F"))
			{
				throw new System.ArgumentException("cannot create field 12F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Option Style (component1). </summary>
		/// <returns> the Option Style from component1 </returns>
		public virtual string OptionStyle
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field12F setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Option Style (component1). </summary>
		/// <param name="component1"> the Option Style to set </param>
		public virtual Field12F setOptionStyle(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field12F.NAME </returns>
		...
		/// <returns> the static value of Field12F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12F get(final SwiftTagListBlock block)
		public static Field12F get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field12F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12F get(final SwiftMessage msg)
		public static Field12F get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12F> getAll(final SwiftMessage msg)
		public static IList<Field12F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12F> getAll(final SwiftTagListBlock block)
		public static IList<Field12F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field12F> result = new java.util.ArrayList<>(arr.length);
				IList<Field12F> result = new List<Field12F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 12F");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "optionStyle";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field12F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12F fromJson(final String json)
		public static Field12F fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("optionStyle").AsString;
			}
			return field;
		}
