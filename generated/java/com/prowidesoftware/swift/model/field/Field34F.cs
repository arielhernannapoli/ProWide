...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field34F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field34F : Field, CurrencyContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "34F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_34F = "34F";
		public const string PARSER_PATTERN = "CSN";
		public const string COMPONENTS_PATTERN = "CSN";
...
//ORIGINAL LINE: public Field34F(final String value)
		public Field34F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field34F(final com.prowidesoftware.swift.model.Tag tag)
		public Field34F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "34F"))
			{
				throw new System.ArgumentException("cannot create field 34F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (toparse != null)
			{
				...
				if (toparse.Length > 3)
				{
					Component2 = StringUtils.Substring(toparse, 3 - toparse);
				}
			}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field34F setComponent1(string component1)
		{
		...
		public virtual Field34F setComponent1(Currency component1)
		{
		...
		public virtual Field34F setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field34F setCurrency(Currency component1)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the D/C Mark (component2). </summary>
		/// <returns> the D/C Mark from component2 </returns>
		...
		public virtual Field34F setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the D/C Mark (component2). </summary>
		/// <param name="component2"> the D/C Mark to set </param>
		public virtual Field34F setDCMark(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field34F setComponent3(string component3)
		{
		...
		public virtual Field34F setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field34F setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field34F setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field34F.NAME </returns>
		...
		/// <returns> the static value of Field34F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34F get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field34F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34F get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34F> getAll(final SwiftMessage msg)
		public static IList<Field34F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field34F> getAll(final SwiftTagListBlock block)
		public static IList<Field34F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field34F> result = new java.util.ArrayList<>(arr.length);
				IList<Field34F> result = new List<Field34F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 34F");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field34F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field34F fromJson(final String json)
		public static Field34F fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("dCMark").AsString;
			}
