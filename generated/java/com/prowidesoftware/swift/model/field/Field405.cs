...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field405 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field405 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "405";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_405 = "405";
		public const string PARSER_PATTERN = "3!SN";
		public const string COMPONENTS_PATTERN = "SN";

		/// <summary>
		/// Component number for the Reason For Rejection subfield
		/// </summary>
		public const int? REASON_FOR_REJECTION = 1;

		/// <summary>
		/// Component number for the Line Field Number subfield
		/// </summary>
		public const int? LINE_FIELD_NUMBER = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field405() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field405(final String value)
		public Field405(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field405(final com.prowidesoftware.swift.model.Tag tag)
		public Field405(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "405"))
			{
				throw new System.ArgumentException("cannot create field 405 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			if (value != null)
			{
				if (value.Length >= 3)
				{
					Component1 = StringUtils.Substring(value, 0, 3);
				}
				if (value.Length > 3)
				{
					setComponent2(StringUtils.Substring(value, 3 - value));
				}
			}
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Reason For Rejection (component1). </summary>
		/// <returns> the Reason For Rejection from component1 </returns>
		...
		public virtual Field405 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Reason For Rejection (component1). </summary>
		/// <param name="component1"> the Reason For Rejection to set </param>
		public virtual Field405 setReasonForRejection(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Gets the Line Field Number (component2). </summary>
		/// <returns> the Line Field Number from component2 </returns>
		public virtual string getLineFieldNumber()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Line Field Number (component2) as Number </summary>
		/// <returns> the Line Field Number from component2 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number LineFieldNumberAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(2));
		...
		public virtual Field405 setComponent2(string component2)
		{
		...
		public virtual Field405 setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		/// <summary>
		/// Set the Line Field Number (component2). </summary>
		/// <param name="component2"> the Line Field Number to set </param>
		public virtual Field405 setLineFieldNumber(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Line Field Number (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the Line Field Number content to set </param>
		public virtual Field405 setLineFieldNumber(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field405.NAME </returns>
		...
		/// <returns> the static value of Field405.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field405 get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field405 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field405 get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field405> getAll(final SwiftMessage msg)
		public static IList<Field405> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field405> getAll(final SwiftTagListBlock block)
		public static IList<Field405> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field405> result = new java.util.ArrayList<>(arr.length);
				IList<Field405> result = new List<Field405>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 405");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "reasonForRejection";
				result[2] = "lineFieldNumber";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field405 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field405 fromJson(final String json)
		public static Field405 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("reasonForRejection").AsString;
			}
			if (jsonObject.get("lineFieldNumber") != null)
			{
				field.setComponent2(jsonObject.get("lineFieldNumber").AsString);
			}
			return field;
		}
