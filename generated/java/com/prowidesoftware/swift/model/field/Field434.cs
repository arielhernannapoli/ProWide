...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field434 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field434 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "434";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_434 = "434";
...
//ORIGINAL LINE: public Field434(final String value)
		public Field434(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field434(final com.prowidesoftware.swift.model.Tag tag)
		public Field434(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "434"))
			{
				throw new System.ArgumentException("cannot create field 434 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Code Word (component1). </summary>
		/// <returns> the Code Word from component1 </returns>
		public virtual string CodeWord
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field434 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Code Word (component1). </summary>
		/// <param name="component1"> the Code Word to set </param>
		public virtual Field434 setCodeWord(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field434 setComponent2(string component2)
		{
		...
		public virtual Field434 setAdditionalInformation(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field434.NAME </returns>
		...
		/// <returns> the static value of Field434.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field434 get(final SwiftTagListBlock block)
		public static Field434 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field434 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field434 get(final SwiftMessage msg)
		public static Field434 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field434> getAll(final SwiftMessage msg)
		public static IList<Field434> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field434> getAll(final SwiftTagListBlock block)
		public static IList<Field434> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field434> result = new java.util.ArrayList<>(arr.length);
				IList<Field434> result = new List<Field434>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 434");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field434 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field434 fromJson(final String json)
		public static Field434 fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("codeWord").AsString;
			}
