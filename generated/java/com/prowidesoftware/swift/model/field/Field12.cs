...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field12 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field12 : Field
	{
		/// <summary>
...
//ORIGINAL LINE: public Field12(final String value)
		public Field12(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field12(final com.prowidesoftware.swift.model.Tag tag)
		public Field12(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "12"))
			{
				throw new System.ArgumentException("cannot create field 12 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Message Type (component1). </summary>
		/// <returns> the Message Type from component1 </returns>
		...
		public virtual Field12 setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Message Type (component1). </summary>
		/// <param name="component1"> the Message Type to set </param>
		public virtual Field12 setMessageType(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field12.NAME </returns>
		...
		/// <returns> the static value of Field12.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12 get(final SwiftTagListBlock block)
		public static Field12 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field12 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12 get(final SwiftMessage msg)
		public static Field12 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12> getAll(final SwiftMessage msg)
		public static IList<Field12> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12> getAll(final SwiftTagListBlock block)
		public static IList<Field12> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field12> result = new java.util.ArrayList<>(arr.length);
				IList<Field12> result = new List<Field12>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 12");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field12 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12 fromJson(final String json)
		...
		public virtual java.lang.Number Component1AsNumber
		{
			get
			{
				return (java.lang.Number)getComponentAs(1, typeof(java.lang.Number));
			}
		}
	}
