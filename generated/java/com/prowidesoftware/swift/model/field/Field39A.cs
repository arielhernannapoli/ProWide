...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field39A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field39A : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "39A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_39A = "39A";
		...
		/// </summary>
		public const int? TOLERANCE_1 = 1;

		/// <summary>
		/// Component number for the Tolerance 2 subfield
		/// </summary>
		public const int? TOLERANCE_2 = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field39A() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field39A(final String value)
		public Field39A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field39A(final com.prowidesoftware.swift.model.Tag tag)
		public Field39A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "39A"))
			{
				throw new System.ArgumentException("cannot create field 39A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Tolerance 1 (component1). </summary>
		/// <returns> the Tolerance 1 from component1 </returns>
		public virtual string getTolerance1()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Tolerance 1 (component1) as Number </summary>
		/// <returns> the Tolerance 1 from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number Tolerance1AsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field39A setComponent1(string component1)
		{
		...
		public virtual Field39A setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Tolerance 1 (component1). </summary>
		/// <param name="component1"> the Tolerance 1 to set </param>
		public virtual Field39A setTolerance1(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Tolerance 1 (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Tolerance 1 content to set </param>
		public virtual Field39A setTolerance1(java.lang.Number component1)
		{
		...
		/// <summary>
		/// Gets the Tolerance 2 (component2). </summary>
		/// <returns> the Tolerance 2 from component2 </returns>
		public virtual string getTolerance2()
		{
			return getComponent(2);
		}

		/// <summary>
		/// Get the Tolerance 2 (component2) as Number </summary>
		/// <returns> the Tolerance 2 from component2 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number Tolerance2AsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(2));
		...
		public virtual Field39A setComponent2(string component2)
		{
		...
		public virtual Field39A setComponent2(java.lang.Number component2)
		{
			if (component2 != null)
			{
		...
		/// <summary>
		/// Set the Tolerance 2 (component2). </summary>
		/// <param name="component2"> the Tolerance 2 to set </param>
		public virtual Field39A setTolerance2(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		/// <summary>
		/// Set the Tolerance 2 (component2) from a Number object. </summary>
		/// <seealso cref= #setComponent2(java.lang.Number) </seealso>
		/// <param name="component2"> Number with the Tolerance 2 content to set </param>
		public virtual Field39A setTolerance2(java.lang.Number component2)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field39A.NAME </returns>
		...
		/// <returns> the static value of Field39A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field39A get(final SwiftTagListBlock block)
		public static Field39A get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field39A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field39A get(final SwiftMessage msg)
		public static Field39A get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field39A> getAll(final SwiftMessage msg)
		public static IList<Field39A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field39A> getAll(final SwiftTagListBlock block)
		public static IList<Field39A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field39A> result = new java.util.ArrayList<>(arr.length);
				IList<Field39A> result = new List<Field39A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 39A");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field39A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field39A fromJson(final String json)
		public static Field39A fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("tolerance1").AsString);
			}
			if (jsonObject.get("tolerance2") != null)
			{
				field.setComponent2(jsonObject.get("tolerance2").AsString);
			}
			return field;
		}
