...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field35U extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field35U : Field, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "35U";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_35U = "35U";
		public const string PARSER_PATTERN = "SN[S]";
		public const string COMPONENTS_PATTERN = "SNS";
...
//ORIGINAL LINE: public Field35U(final String value)
		public Field35U(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field35U(final com.prowidesoftware.swift.model.Tag tag)
		public Field35U(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "35U"))
			{
				throw new System.ArgumentException("cannot create field 35U from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Override public void parse(final String value)
		public override void parse(string value)
		{
			...
			string toparse = Component1 == null? value : StringUtils.substringAfter(value, Component1);
			setComponent2(SwiftParseUtils.getNumericPrefix(toparse));
			Component3 = SwiftParseUtils.getAlphaSuffix(toparse);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field35U setComponent1(string component1)
		{
		...
		public virtual Field35U setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field35U setComponent2(string component2)
		{
		...
		public virtual Field35U setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field35U setAmount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field35U setAmount(java.lang.Number component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Period (component3). </summary>
		/// <returns> the Period from component3 </returns>
		...
		public virtual Field35U setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Period (component3). </summary>
		/// <param name="component3"> the Period to set </param>
		public virtual Field35U setPeriod(string component3)
		{
			setComponent(3, component3);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field35U.NAME </returns>
		...
		/// <returns> the static value of Field35U.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35U get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field35U in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35U get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field35U> getAll(final SwiftMessage msg)
		public static IList<Field35U> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field35U> getAll(final SwiftTagListBlock block)
		public static IList<Field35U> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field35U> result = new java.util.ArrayList<>(arr.length);
				IList<Field35U> result = new List<Field35U>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 35U");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field35U object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field35U fromJson(final String json)
		public static Field35U fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("period").AsString;
			}
			return field;
		}
