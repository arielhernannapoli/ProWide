...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field12D extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field12D : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "12D";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_12D = "12D";
		...
		/// </summary>
		public const int? OPTION_TYPE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field12D() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field12D(final String value)
		public Field12D(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field12D(final com.prowidesoftware.swift.model.Tag tag)
		public Field12D(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "12D"))
			{
				throw new System.ArgumentException("cannot create field 12D from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Option Type (component1). </summary>
		/// <returns> the Option Type from component1 </returns>
		...
		public virtual Field12D setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Option Type (component1). </summary>
		/// <param name="component1"> the Option Type to set </param>
		public virtual Field12D setOptionType(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field12D.NAME </returns>
		...
		/// <returns> the static value of Field12D.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12D get(final SwiftTagListBlock block)
		public static Field12D get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field12D in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12D get(final SwiftMessage msg)
		public static Field12D get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12D> getAll(final SwiftMessage msg)
		public static IList<Field12D> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field12D> getAll(final SwiftTagListBlock block)
		public static IList<Field12D> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field12D> result = new java.util.ArrayList<>(arr.length);
				IList<Field12D> result = new List<Field12D>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 12D");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field12D object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field12D fromJson(final String json)
		public static Field12D fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("optionType").AsString;
			}
			return field;
		}
