...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22J extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22J : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22J";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22J = "22J";
		...
		/// </summary>
		public const int? TYPE_OF_BARRIER = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field22J() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field22J(final String value)
		public Field22J(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22J(final com.prowidesoftware.swift.model.Tag tag)
		public Field22J(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22J"))
			{
				throw new System.ArgumentException("cannot create field 22J from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the Type Of Barrier (component1). </summary>
		/// <returns> the Type Of Barrier from component1 </returns>
		public virtual string TypeOfBarrier
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field22J setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the Type Of Barrier (component1). </summary>
		/// <param name="component1"> the Type Of Barrier to set </param>
		public virtual Field22J setTypeOfBarrier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22J.NAME </returns>
		...
		/// <returns> the static value of Field22J.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22J get(final SwiftTagListBlock block)
		public static Field22J get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22J in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22J get(final SwiftMessage msg)
		public static Field22J get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22J> getAll(final SwiftMessage msg)
		public static IList<Field22J> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22J> getAll(final SwiftTagListBlock block)
		public static IList<Field22J> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22J> result = new java.util.ArrayList<>(arr.length);
				IList<Field22J> result = new List<Field22J>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22J");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "typeOfBarrier";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field22J object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22J fromJson(final String json)
		public static Field22J fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("typeOfBarrier").AsString;
			}
			return field;
		}
