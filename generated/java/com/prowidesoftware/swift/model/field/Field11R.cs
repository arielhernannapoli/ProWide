...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field11R extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field11R : Field, DateContainer, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "11R";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_11R = "11R";
...
//ORIGINAL LINE: public Field11R(final String value)
		public Field11R(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field11R(final com.prowidesoftware.swift.model.Tag tag)
		public Field11R(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "11R"))
			{
				throw new System.ArgumentException("cannot create field 11R from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field11R setComponent1(string component1)
		{
		...
		public virtual Field11R setMT(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field11R setComponent2(string component2)
		{
		...
		public virtual Field11R setComponent2(DateTime component2)
		{
		...
		public virtual Field11R setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field11R setDate(DateTime component2)
		{
		...
		public virtual Field11R setComponent3(string component3)
		{
		...
		public virtual Field11R setComponent3(java.lang.Number component3)
		{
			if (component3 != null)
			{
		...
		public virtual Field11R setSessionNumber(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field11R setSessionNumber(java.lang.Number component3)
		{
		...
		public virtual Field11R setComponent4(string component4)
		{
		...
		public virtual Field11R setComponent4(java.lang.Number component4)
		{
			if (component4 != null)
			{
		...
		public virtual Field11R setISN(string component4)
		{
			setComponent(4, component4);
			return this;
		}
		...
		public virtual Field11R setISN(java.lang.Number component4)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field11R.NAME </returns>
		...
		/// <returns> the static value of Field11R.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field11R get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field11R in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field11R get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field11R> getAll(final SwiftMessage msg)
		public static IList<Field11R> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field11R> getAll(final SwiftTagListBlock block)
		public static IList<Field11R> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field11R> result = new java.util.ArrayList<>(arr.length);
				IList<Field11R> result = new List<Field11R>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 11R");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field11R object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field11R fromJson(final String json)
