...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field126 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field126 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "126";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_126 = "126";
...
//ORIGINAL LINE: public Field126(final String value)
		public Field126(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field126(final com.prowidesoftware.swift.model.Tag tag)
		public Field126(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "126"))
			{
				throw new System.ArgumentException("cannot create field 126 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Seed (component1). </summary>
		/// <returns> the Seed from component1 </returns>
		...
		/// <summary>
		/// Get the Seed (component1) as Number </summary>
		/// <returns> the Seed from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number SeedAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field126 setComponent1(string component1)
		{
		...
		public virtual Field126 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Seed (component1). </summary>
		/// <param name="component1"> the Seed to set </param>
		public virtual Field126 setSeed(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Seed (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Seed content to set </param>
		public virtual Field126 setSeed(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field126.NAME </returns>
		...
		/// <returns> the static value of Field126.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field126 get(final SwiftTagListBlock block)
		public static Field126 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field126 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field126 get(final SwiftMessage msg)
		public static Field126 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field126> getAll(final SwiftMessage msg)
		public static IList<Field126> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field126> getAll(final SwiftTagListBlock block)
		public static IList<Field126> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field126> result = new java.util.ArrayList<>(arr.length);
				IList<Field126> result = new List<Field126>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 126");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field126 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field126 fromJson(final String json)
		public static Field126 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("seed").AsString);
			}
			return field;
		}
