...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field105 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field105 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const int? DELIVERY_MONITORING = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field105() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field105(final String value)
		public Field105(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field105(final com.prowidesoftware.swift.model.Tag tag)
		public Field105(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "105"))
			{
				throw new System.ArgumentException("cannot create field 105 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Delivery Monitoring (component1). </summary>
		/// <returns> the Delivery Monitoring from component1 </returns>
		public virtual string getDeliveryMonitoring()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Delivery Monitoring (component1) as Number </summary>
		/// <returns> the Delivery Monitoring from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number DeliveryMonitoringAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field105 setComponent1(string component1)
		{
		...
		public virtual Field105 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Delivery Monitoring (component1). </summary>
		/// <param name="component1"> the Delivery Monitoring to set </param>
		public virtual Field105 setDeliveryMonitoring(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field105.NAME </returns>
		...
		/// <returns> the static value of Field105.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field105 get(final SwiftTagListBlock block)
		public static Field105 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field105 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field105 get(final SwiftMessage msg)
		public static Field105 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field105> getAll(final SwiftMessage msg)
		public static IList<Field105> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field105> getAll(final SwiftTagListBlock block)
		public static IList<Field105> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field105> result = new java.util.ArrayList<>(arr.length);
				IList<Field105> result = new List<Field105>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 105");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "deliveryMonitoring";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field105 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field105 fromJson(final String json)
		public static Field105 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("deliveryMonitoring").AsString);
			}
			return field;
		}
