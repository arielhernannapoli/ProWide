...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field33H extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.AmountContainer
	[Serializable]
	public class Field33H : Field, CurrencyContainer, AmountContainer
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "33H";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_33H = "33H";
...
//ORIGINAL LINE: public Field33H(final String value)
		public Field33H(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field33H(final com.prowidesoftware.swift.model.Tag tag)
		public Field33H(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "33H"))
			{
				throw new System.ArgumentException("cannot create field 33H from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field33H setComponent1(string component1)
		{
		...
		public virtual Field33H setComponent1(Currency component1)
		{
		...
		public virtual Field33H setCurrency(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field33H setCurrency(Currency component1)
		{
		...
		public virtual Field33H setComponent2(string component2)
		{
		...
		public virtual Field33H setComponent2(java.lang.Number component2)
		{
		...
		public virtual Field33H setAmount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field33H setAmount(java.lang.Number component2)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field33H.NAME </returns>
		...
		/// <returns> the static value of Field33H.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33H get(final SwiftTagListBlock block)
		public static Field33H get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field33H in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33H get(final SwiftMessage msg)
		public static Field33H get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33H> getAll(final SwiftMessage msg)
		public static IList<Field33H> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field33H> getAll(final SwiftTagListBlock block)
		public static IList<Field33H> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field33H> result = new java.util.ArrayList<>(arr.length);
				IList<Field33H> result = new List<Field33H>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 33H");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field33H object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field33H fromJson(final String json)
		public static Field33H fromJson(string json)
		{
