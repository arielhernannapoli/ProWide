...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field32A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.CurrencyContainer, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.AmountContainer
	...
	public class Field32A : Field, CurrencyContainer, DateContainer, AmountContainer
	{
		...
		/// </summary>
		public const string NAME = "32A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_32A = "32A";
...
//ORIGINAL LINE: public Field32A(final String value)
		public Field32A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field32A(final com.prowidesoftware.swift.model.Tag tag)
		public Field32A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "32A"))
			{
				throw new System.ArgumentException("cannot create field 32A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field32A setComponent1(string component1)
		{
		...
		public virtual Field32A setComponent1(DateTime component1)
		{
		...
		public virtual Field32A setDate(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field32A setDate(DateTime component1)
		{
		...
		public virtual Field32A setComponent2(string component2)
		{
		...
		public virtual Field32A setComponent2(Currency component2)
		{
		...
		public virtual Field32A setCurrency(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field32A setCurrency(Currency component2)
		{
		...
		public virtual Field32A setComponent3(string component3)
		{
		...
		public virtual Field32A setComponent3(java.lang.Number component3)
		{
		...
		public virtual Field32A setAmount(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field32A setAmount(java.lang.Number component3)
		{
...
//ORIGINAL LINE: final java.util.List<java.util.Currency> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field32A.NAME </returns>
		...
		/// <returns> the static value of Field32A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32A get(final SwiftTagListBlock block)
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field32A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32A get(final SwiftMessage msg)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field32A> getAll(final SwiftMessage msg)
		public static IList<Field32A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
				return java.util.Collections.emptyList();
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field32A> getAll(final SwiftTagListBlock block)
		public static IList<Field32A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field32A> result = new java.util.ArrayList<>(arr.length);
				IList<Field32A> result = new List<Field32A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 32A");
			}
			if (component == 1)
			{
				//date
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field32A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field32A fromJson(final String json)
		public static Field32A fromJson(string json)
		{
		...
		/// <summary>
		/// Returns the amount converted to a Double or null if amount attribute is not set </summary>
		/// <returns> Double value of amount attribute or null. </returns>
		/// @deprecated use getAmountBigDecimal() instead (double is strongly discouraged for financial math operations) 
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deprecated("use getAmountBigDecimal() instead (double is strongly discouraged for financial math operations)") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public Double getAmountDouble()
		[Obsolete("use getAmountBigDecimal() instead (double is strongly discouraged for financial math operations)")]
		public virtual double? AmountDouble
		{
			get
			{
				com.prowidesoftware.deprecation.DeprecationUtils.phase2(this.GetType(), "getAmountDouble()", "Use use getAmountBigDecimal() instead.");
				if (Component3AsNumber == null)
				{
					return null;
				}
				return Convert.ToDouble((double)Component3AsNumber);
			}
		}

		/// <summary>
		/// Returns the amount converted to a BigDecimal or null if amount attribute is not set </summary>
		/// <returns> BigDecimal value of amount attribute or null. </returns>
		public virtual decimal AmountBigDecimal
		{
			get
			{
				if (Component3AsNumber == null)
				...
				return (decimal) getComponentAs(3, typeof(decimal));
			}
		}
	...
	//ORIGINAL LINE: final StringBuilder sb = new StringBuilder();
				...
				sb.Append(" ");
				sb.Append(formatNumber(Component3AsNumber));
				sb.Append(" ");
				string valueDate = format(Component1AsCalendar);
				sb.Append(valueDate);
				return sb.ToString();
			}
		}
