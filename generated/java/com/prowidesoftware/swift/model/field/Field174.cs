...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field174 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field174 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "174";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_174 = "174";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "Q";
...
//ORIGINAL LINE: public Field174(final String value)
		public Field174(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field174(final com.prowidesoftware.swift.model.Tag tag)
		public Field174(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "174"))
			{
				throw new System.ArgumentException("cannot create field 174 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Range (component1). </summary>
		/// <returns> the Range from component1 </returns>
		...
		/// <summary>
		/// Get the Range (component1) as Calendar </summary>
		/// <returns> the Range from component1 converted to Calendar or null if cannot be converted </returns>
		public virtual DateTime RangeAsCalendar
		{
			get
			{
				return SwiftFormatUtils.getHour(getComponent(1));
		...
		public virtual Field174 setComponent1(string component1)
		{
		...
		public virtual Field174 setComponent1(DateTime component1)
		{
		...
		/// <summary>
		/// Set the Range (component1). </summary>
		/// <param name="component1"> the Range to set </param>
		public virtual Field174 setRange(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Range (component1) from a Calendar object. </summary>
		/// <seealso cref= #setComponent1(java.util.Calendar) </seealso>
		/// <param name="component1"> Calendar with the Range content to set </param>
		public virtual Field174 setRange(DateTime component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field174.NAME </returns>
		...
		/// <returns> the static value of Field174.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field174 get(final SwiftTagListBlock block)
		public static Field174 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field174 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field174 get(final SwiftMessage msg)
		public static Field174 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field174> getAll(final SwiftMessage msg)
		public static IList<Field174> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field174> getAll(final SwiftTagListBlock block)
		public static IList<Field174> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field174> result = new java.util.ArrayList<>(arr.length);
				IList<Field174> result = new List<Field174>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 174");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field174 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field174 fromJson(final String json)
		public static Field174 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("range").AsString);
			}
			return field;
		}
