...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field22 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field22 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "22";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_22 = "22";
		...
		/// </summary>
		public const int? COMMON_REFERENCE = 2;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field22() : base(2)
		{
		}
...
//ORIGINAL LINE: public Field22(final String value)
		public Field22(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field22(final com.prowidesoftware.swift.model.Tag tag)
		public Field22(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "22"))
			{
				throw new System.ArgumentException("cannot create field 22 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field22 setComponent1(string component1)
		{
		...
		public virtual Field22 setCode(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		/// <summary>
		/// Gets the Common Reference (component2). </summary>
		/// <returns> the Common Reference from component2 </returns>
		public virtual string CommonReference
		{
			get
			{
				return getComponent(2);
		...
		public virtual Field22 setComponent2(string component2)
		{
		...
		/// <summary>
		/// Set the Common Reference (component2). </summary>
		/// <param name="component2"> the Common Reference to set </param>
		public virtual Field22 setCommonReference(string component2)
		{
			setComponent(2, component2);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field22.NAME </returns>
		...
		/// <returns> the static value of Field22.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22 get(final SwiftTagListBlock block)
		public static Field22 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field22 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22 get(final SwiftMessage msg)
		public static Field22 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22> getAll(final SwiftMessage msg)
		public static IList<Field22> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field22> getAll(final SwiftTagListBlock block)
		public static IList<Field22> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field22> result = new java.util.ArrayList<>(arr.length);
				IList<Field22> result = new List<Field22>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 22");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "code";
				result[2] = "commonReference";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field22 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field22 fromJson(final String json)
		public static Field22 fromJson(string json)
		{
			...
			{
				field.Component2 = jsonObject.get("commonReference").AsString;
			}
			return field;
		}
