...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field175 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field175 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "175";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_175 = "175";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "H";
...
//ORIGINAL LINE: public Field175(final String value)
		public Field175(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field175(final com.prowidesoftware.swift.model.Tag tag)
		public Field175(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "175"))
			{
				throw new System.ArgumentException("cannot create field 175 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		public virtual Field175 setComponent1(string component1)
		{
		...
		public virtual Field175 setComponent1(DateTime component1)
		{
		...
		public virtual Field175 setTime(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field175 setTime(DateTime component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field175.NAME </returns>
		...
		/// <returns> the static value of Field175.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field175 get(final SwiftTagListBlock block)
		public static Field175 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field175 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field175 get(final SwiftMessage msg)
		public static Field175 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field175> getAll(final SwiftMessage msg)
		public static IList<Field175> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field175> getAll(final SwiftTagListBlock block)
		public static IList<Field175> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field175> result = new java.util.ArrayList<>(arr.length);
				IList<Field175> result = new List<Field175>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 175");
			}
			if (component == 1)
			{
				//time
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field175 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field175 fromJson(final String json)
		public static Field175 fromJson(string json)
		{
