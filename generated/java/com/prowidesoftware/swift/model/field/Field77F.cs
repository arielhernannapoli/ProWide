...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field77F extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field77F : Field, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "77F";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_77F = "77F";
		...
		/// </summary>
		public const int? DIFACT_MESSAGE = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field77F() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field77F(final String value)
		public Field77F(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field77F(final com.prowidesoftware.swift.model.Tag tag)
		public Field77F(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "77F"))
			{
				throw new System.ArgumentException("cannot create field 77F from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		/// <summary>
		/// Gets the DIFACT Message (component1). </summary>
		/// <returns> the DIFACT Message from component1 </returns>
		public virtual string DIFACTMessage
		{
			get
			{
				return getComponent(1);
		...
		public virtual Field77F setComponent1(string component1)
		{
		...
		/// <summary>
		/// Set the DIFACT Message (component1). </summary>
		/// <param name="component1"> the DIFACT Message to set </param>
		public virtual Field77F setDIFACTMessage(string component1)
		{
			setComponent(1, component1);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field77F.NAME </returns>
		...
		/// <returns> the static value of Field77F.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field77F get(final SwiftTagListBlock block)
		public static Field77F get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field77F in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field77F get(final SwiftMessage msg)
		public static Field77F get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field77F> getAll(final SwiftMessage msg)
		public static IList<Field77F> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field77F> getAll(final SwiftTagListBlock block)
		public static IList<Field77F> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field77F> result = new java.util.ArrayList<>(arr.length);
				IList<Field77F> result = new List<Field77F>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 77F");
			}
			if (component == 1)
			{
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "dIFACTMessage";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field77F object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field77F fromJson(final String json)
		public static Field77F fromJson(string json)
		{
			...
			{
				field.Component1 = jsonObject.get("dIFACTMessage").AsString;
			}
			return field;
		}
