...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field451 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field451 : Field
	{
		...
		/// </summary>
		public const string NAME = "451";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_451 = "451";
		...
		/// </summary>
		public const int? ACCEPT_REJECT_OPTION = 1;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field451() : base(1)
		{
		}
...
//ORIGINAL LINE: public Field451(final String value)
		public Field451(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field451(final com.prowidesoftware.swift.model.Tag tag)
		public Field451(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "451"))
			{
				throw new System.ArgumentException("cannot create field 451 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Gets the Accept Reject Option (component1). </summary>
		/// <returns> the Accept Reject Option from component1 </returns>
		public virtual string getAcceptRejectOption()
		{
			return getComponent(1);
		}

		/// <summary>
		/// Get the Accept Reject Option (component1) as Number </summary>
		/// <returns> the Accept Reject Option from component1 converted to Number or null if cannot be converted </returns>
		public virtual java.lang.Number AcceptRejectOptionAsNumber
		{
			get
			{
				return SwiftFormatUtils.getNumber(getComponent(1));
		...
		public virtual Field451 setComponent1(string component1)
		{
		...
		public virtual Field451 setComponent1(java.lang.Number component1)
		{
			if (component1 != null)
			{
		...
		/// <summary>
		/// Set the Accept Reject Option (component1). </summary>
		/// <param name="component1"> the Accept Reject Option to set </param>
		public virtual Field451 setAcceptRejectOption(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the Accept Reject Option (component1) from a Number object. </summary>
		/// <seealso cref= #setComponent1(java.lang.Number) </seealso>
		/// <param name="component1"> Number with the Accept Reject Option content to set </param>
		public virtual Field451 setAcceptRejectOption(java.lang.Number component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field451.NAME </returns>
		...
		/// <returns> the static value of Field451.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field451 get(final SwiftTagListBlock block)
		public static Field451 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field451 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field451 get(final SwiftMessage msg)
		public static Field451 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field451> getAll(final SwiftMessage msg)
		public static IList<Field451> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field451> getAll(final SwiftTagListBlock block)
		public static IList<Field451> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field451> result = new java.util.ArrayList<>(arr.length);
				IList<Field451> result = new List<Field451>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 451");
			}
			if (component == 1)
			{
				//number, amount, rate
		...
		protected internal override IDictionary<int?, string> ComponentMap
		{
			get
			{
				...
				result[1] = "acceptRejectOption";
				return result;
			}
		}

		/// <summary>
		/// This method deserializes the JSON data into a Field451 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field451 fromJson(final String json)
		public static Field451 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("acceptRejectOption").AsString);
			}
			return field;
		}
