...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field55A extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	[Serializable]
	public class Field55A : Field, BICContainer, com.prowidesoftware.swift.model.field.MultiLineField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "55A";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_55A = "55A";
...
//ORIGINAL LINE: public Field55A(final String value)
		public Field55A(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field55A(final com.prowidesoftware.swift.model.Tag tag)
		public Field55A(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "55A"))
			{
				throw new System.ArgumentException("cannot create field 55A from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field55A setComponent1(string component1)
		{
		...
		public virtual Field55A setDCMark(string component1)
		{
			setComponent(1, component1);
			return this;
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent2AsString()
		...
		public virtual Field55A setComponent2(string component2)
		{
		...
		public virtual Field55A setAccount(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field55A setComponent3(string component3)
		{
		...
		public virtual Field55A setComponent3(BIC component3)
		{
		...
		public virtual Field55A setBIC(string component3)
		{
			setComponent(3, component3);
			return this;
		}
		...
		public virtual Field55A setBIC(BIC component3)
		{
...
//ORIGINAL LINE: final java.util.List<String> result = new java.util.ArrayList<>();
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field55A.NAME </returns>
		...
		/// <returns> the static value of Field55A.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field55A get(final SwiftTagListBlock block)
		public static Field55A get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field55A in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field55A get(final SwiftMessage msg)
		public static Field55A get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field55A> getAll(final SwiftMessage msg)
		public static IList<Field55A> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field55A> getAll(final SwiftTagListBlock block)
		public static IList<Field55A> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field55A> result = new java.util.ArrayList<>(arr.length);
				IList<Field55A> result = new List<Field55A>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 55A");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field55A object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field55A fromJson(final String json)
		public static Field55A fromJson(string json)
		{
