...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field69C extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable, com.prowidesoftware.swift.model.field.DateContainer, com.prowidesoftware.swift.model.field.GenericField
	[Serializable]
	public class Field69C : Field, DateContainer, com.prowidesoftware.swift.model.field.GenericField
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "69C";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_69C = "69C";
		public const string PARSER_PATTERN = ":S//S/S";
		public const string COMPONENTS_PATTERN = "SDS";
		...
		/// </summary>
		public const int? DATE_CODE = 3;

		/// <summary>
		/// Default constructor. Creates a new field setting all components to null.
		/// </summary>
		public Field69C() : base(3)
		{
		}
...
//ORIGINAL LINE: public Field69C(final String value)
		public Field69C(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field69C(final com.prowidesoftware.swift.model.Tag tag)
		public Field69C(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "69C"))
			{
				throw new System.ArgumentException("cannot create field 69C from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent1AsString()
		...
		public virtual Field69C setComponent1(string component1)
		{
		...
		public virtual Field69C setQualifier(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		public virtual Field69C setComponent2(string component2)
		{
		...
		public virtual Field69C setComponent2(DateTime component2)
		{
		...
		public virtual Field69C setDate(string component2)
		{
			setComponent(2, component2);
			return this;
		}
		...
		public virtual Field69C setDate(DateTime component2)
		{
...
//ORIGINAL LINE: @Deprecated("use <seealso cref="#getComponent(int)"/> instead") @ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2019) public java.lang.String getComponent3AsString()
		...
		/// <summary>
		/// Gets the Date Code (component3). </summary>
		/// <returns> the Date Code from component3 </returns>
		...
		public virtual Field69C setComponent3(string component3)
		{
		...
		/// <summary>
		/// Set the Date Code (component3). </summary>
		/// <param name="component3"> the Date Code to set </param>
		public virtual Field69C setDateCode(string component3)
		{
			setComponent(3, component3);
			return this;
		}
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field69C.NAME </returns>
		...
		/// <returns> the static value of Field69C.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69C get(final SwiftTagListBlock block)
		public static Field69C get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field69C in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69C get(final SwiftMessage msg)
		public static Field69C get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field69C> getAll(final SwiftMessage msg)
		public static IList<Field69C> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field69C> getAll(final SwiftTagListBlock block)
		public static IList<Field69C> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field69C> result = new java.util.ArrayList<>(arr.length);
				IList<Field69C> result = new List<Field69C>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 69C");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field69C object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field69C fromJson(final String json)
		public static Field69C fromJson(string json)
		{
			...
			{
				field.Component3 = jsonObject.get("dateCode").AsString;
			}
			return field;
		}
