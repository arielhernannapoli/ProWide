...
//ORIGINAL LINE: @SuppressWarnings("unused") @Generated public class Field251 extends com.prowidesoftware.swift.model.field.Field implements java.io.Serializable
	[Serializable]
	public class Field251 : Field
	{
		/// <summary>
		...
		/// </summary>
		public const string NAME = "251";
		/// <summary>
		/// same as NAME, intended to be clear when using static imports
		/// </summary>
		public const string F_251 = "251";
		public const string PARSER_PATTERN = "S";
		public const string COMPONENTS_PATTERN = "R";
...
//ORIGINAL LINE: public Field251(final String value)
		public Field251(string value) : base(value)
		{
		}
		...
		/// @since 7.8 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Field251(final com.prowidesoftware.swift.model.Tag tag)
		public Field251(Tag tag) : this()
		{
			if (tag == null)
			{
				throw new System.ArgumentException("tag cannot be null.");
			}
			if (!StringUtils.Equals(tag.Name, "251"))
			{
				throw new System.ArgumentException("cannot create field 251 from tag " + tag.Name + ", tagname must match the name of the field.");
			}
			parse(tag.Value);
		}
...
//ORIGINAL LINE: public static com.prowidesoftware.swift.model.Tag tag(final String value)
		...
		/// <summary>
		/// Get the MIR (component1) as MIR </summary>
		/// <returns> the MIR from component1 converted to MIR or null if cannot be converted </returns>
		...
		public virtual Field251 setComponent1(string component1)
		{
		...
		public virtual Field251 setComponent1(com.prowidesoftware.swift.model.MIR component1)
		{
		...
		public virtual Field251 setMIR(string component1)
		{
			setComponent(1, component1);
			return this;
		}
		...
		/// <summary>
		/// Set the MIR (component1) from a MIR object. </summary>
		/// <seealso cref= #setComponent1(com.prowidesoftware.swift.model.MIR) </seealso>
		/// <param name="component1"> MIR with the MIR content to set </param>
		public virtual Field251 setMIR(com.prowidesoftware.swift.model.MIR component1)
		{
	   ...
	   public override string parserPattern()
	   {
		...
		/// <returns> the static value of Field251.NAME </returns>
		...
		/// <returns> the static value of Field251.COMPONENTS_PATTERN </returns>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field251 get(final SwiftTagListBlock block)
		public static Field251 get(SwiftTagListBlock block)
		{
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag t = block.getTagByName(NAME);
		...
		/// <summary>
		/// Gets the first instance of Field251 in the given message. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field251 get(final SwiftMessage msg)
		public static Field251 get(SwiftMessage msg)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field251> getAll(final SwiftMessage msg)
		public static IList<Field251> getAll(SwiftMessage msg)
		{
			if (msg == null || msg.Block4 == null || msg.Block4.Empty)
			{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static java.util.List<Field251> getAll(final SwiftTagListBlock block)
		public static IList<Field251> getAll(SwiftTagListBlock block)
		{
			if (block == null || block.Empty)
			{
				return java.util.Collections.emptyList();
...
//ORIGINAL LINE: final com.prowidesoftware.swift.model.Tag[] arr = block.getTagsByName(NAME);
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Field251> result = new java.util.ArrayList<>(arr.length);
				IList<Field251> result = new List<Field251>(arr.Length);
		...
		public override string getValueDisplay(int component, Locale locale)
		{
			...
			{
				throw new System.ArgumentException("invalid component number " + component + " for field 251");
			}
			if (component == 1)
			{
		...
		/// <summary>
		/// This method deserializes the JSON data into a Field251 object. </summary>
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static Field251 fromJson(final String json)
		public static Field251 fromJson(string json)
		{
			...
			{
				field.setComponent1(jsonObject.get("mIR").AsString);
			}
			return field;
		}
