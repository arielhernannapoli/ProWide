...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to .NET:
	...
	/// @since 4.0
	/// </summary>
	public class MT202Test : BaseMessageTestcase
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test202_1()
		public virtual void test202_1()
		{
			...
			assertEquals("202", (parseMessage(messageToParse)).Type);

			//check b1
			assertEquals("F01FOOBARYYAXXX1234123456", b1.BlockValue);
			assertEquals("F", b1.ApplicationId);
			assertEquals("01", b1.ServiceId);
			assertEquals("FOOBARYYAXXX", b1.LogicalTerminal);
			assertEquals("1234", b1.SessionNumber);
			assertEquals("123456", b1.SequenceNumber);

			//check b2
			assertEquals("O2020810060308QQQQESMMAXXX55610922240603080810N", b2.BlockValue);
			assertEquals("202", ((SwiftBlock2Output)b2).MessageType);
			assertEquals("0810", ((SwiftBlock2Output)b2).SenderInputTime);
			assertEquals("060308", ((SwiftBlock2Output)b2).MIRDate);
			assertEquals("QQQQESMMAXXX", ((SwiftBlock2Output)b2).MIRLogicalTerminal);
			assertEquals("5561", ((SwiftBlock2Output)b2).MIRSessionNumber);
			assertEquals("092224", ((SwiftBlock2Output)b2).MIRSequenceNumber);
			assertEquals("060308QQQQESMMAXXX5561092224", ((SwiftBlock2Output)b2).MIR);
			assertEquals("060308", ((SwiftBlock2Output)b2).ReceiverOutputDate);
			assertEquals("0810", ((SwiftBlock2Output)b2).ReceiverOutputTime);
			assertEquals("N", ((SwiftBlock2Output)b2).MessagePriority);
			...
			assertEquals("/SNDTIME/0809+0100", tags[0].Value);
			assertEquals("/RNCTIME/0809+0100", tags[1].Value);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test202_2()
		public virtual void test202_2()
		{
			...
			//check b2
			assertEquals("O2021340060306PPPPESMMAXXX55590714410603061340N", b2.BlockValue);
			...
			tags = b4.getTagsByName("13C");
			assertEquals("/SNDTIME/1339+0100", tags[0].Value);
			assertEquals("/RNCTIME/1339+0100", tags[1].Value);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test202_3()
		public virtual void test202_3()
		{
			...
			//check b2
			assertEquals("O2020838060307AAAABRMMAXXX55600795140603070838N", b2.BlockValue);
			...
			tags = b4.getTagsByName("13C");
			assertEquals("/SNDTIME/0837+0100", tags[0].Value);
			assertEquals("/RNCTIME/0837+0100", tags[1].Value);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test202_4()
		public virtual void test202_4()
		{
			...
			//check b2
			assertEquals("O2021011060227FOOOESMMAXXX55529778600602271011N", b2.BlockValue);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test202_5()
		public virtual void test202_5()
		{
			...
			//check b2
			assertEquals("O2021559051102ABCDEFMMAXXX54267910040511021559N", b2.BlockValue);
