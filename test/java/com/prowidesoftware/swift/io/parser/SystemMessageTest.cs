...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to .NET:
	...
	/// @since 4.0
	/// </summary>
	public class SystemMessageTest : BaseMessageTestcase
	{
...
//ORIGINAL LINE: @Test public void testPostedFengw2_01()
		public virtual void testPostedFengw2_01()
		{
			...
			assertNotNull(o.UnparsedTexts);
			assertEquals(1, (int)o.UnparsedTextsSize);

			SwiftMessage mt535 = o.UnparsedTexts.getTextAsMessage(0);
			assertEquals("535", mt535.Type);
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPostedFengw2_02()
		public virtual void testPostedFengw2_02()
		{
			...
			SwiftMessage mt950 = o.UnparsedTexts.getTextAsMessage(0);
			assertEquals("950", mt950.Type);
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPostedDonreda_01()
		public virtual void testPostedDonreda_01()
		{
			...
			assertNotNull(b1);
			assertEquals("F21MTGSUS6SAXXX3206837054", b1.BlockValue);
			assertEquals("F", b1.ApplicationId);
			assertEquals("21", b1.ServiceId);
			assertEquals("MTGSUS6SAXXX", b1.LogicalTerminal);
			assertEquals("3206", b1.SessionNumber);
			assertEquals("837054", b1.SequenceNumber);
			...
			SwiftMessage mt564 = o.UnparsedTexts.getTextAsMessage(0);
			assertEquals("564", mt564.Type);
