...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to .NET:
	...
	/// @since 4.0
	/// </summary>
	public class MT103Test : BaseMessageTestcase
	{
...
//ORIGINAL LINE: @Test public void test103_1()
		public virtual void test103_1()
		{
			...
			assertEquals("103", (parseMessage(messageToParse)).Type);
			...
			//check b2
			assertEquals("O1030803051028AAPBESMMAXXX54237368560510280803N", b2.BlockValue);
			assertEquals("103", ((SwiftBlock2Output) b2).MessageType);
			assertEquals("0803", ((SwiftBlock2Output) b2).SenderInputTime);
			assertEquals("051028", ((SwiftBlock2Output) b2).MIRDate);
			assertEquals("AAPBESMMAXXX", ((SwiftBlock2Output) b2).MIRLogicalTerminal);
			assertEquals("5423", ((SwiftBlock2Output) b2).MIRSessionNumber);
			assertEquals("736856", ((SwiftBlock2Output) b2).MIRSequenceNumber);
			assertEquals("051028AAPBESMMAXXX5423736856", ((SwiftBlock2Output) b2).MIR);
			assertEquals("051028", ((SwiftBlock2Output) b2).ReceiverOutputDate);
			assertEquals("0803", ((SwiftBlock2Output) b2).ReceiverOutputTime);
...
//ORIGINAL LINE: @Test public void test103_2()
		public virtual void test103_2()
		{
			...
			//check b1
			assertEquals("F01FOOBARXXAXXX1234123456", b1.BlockValue);

			//check b2
			assertEquals("O1031041060411AAABESMMAXXX55944670160604111041N", b2.BlockValue);
			...
			assertEquals("SDVA", tags[0].Value);
			assertEquals("CORT", tags[1].Value);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test103_3()
		public virtual void test103_3()
		{
			...
			//check b2
			assertEquals("O1030954060228RRRRESMMAXXX55549966520602280954N", b2.BlockValue);
			...
			assertEquals("/SNDTIME/0951+0100", tags[0].Value);
			assertEquals("/RNCTIME/0952+0100", tags[1].Value);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test103_4()
		public virtual void test103_4()
		{
			...
			//check b2
			assertEquals("O1031101051102UUUUESMMAXXX54267818770511021101N", b2.BlockValue);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test103_5()
		public virtual void test103_5()
		{
			...
			//check b2
			assertEquals("O1031101051102KKKKESMMAXXX54267818770511021101N", b2.BlockValue);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test103_6()
		public virtual void test103_6()
		{
			messageToParse = "{1:F01FOOBARYYAXXX1234123456}{2:O1031101051102KKKKESMMAXXX54267818770511021101N}{3:{113:ROMF}{108:0511029000000056}}{4:\n" + ":20:0511029000000056\n" + ":13C:/RNCTIME/1101+0000\n" + ":23B:CRED\n" + ":32A:051102EUR66666,66\n" + ":33B:EUR66666,66\n" + ":50K:/1234}5678\n" + "AAAA BBB CCCCC DDDDD\n" + ":53A:FOOBARMMXXX\n" + ":57A:FOOBARYYXXX\n" + ":59:/00123456789012345678\n" + "FOOBAR, S.A.\n" + "PS DE FFFFFFF 66\n" + "MADRID\n" + ":70:/CNC/FRA. 6666 CUENTA 66 EEEEEEE\n" + "//MANT\n" + "//NIMIENTO EQUIPOS E UUUUUUUUUUUUU\n" + "//TO\n" + ":71A:OUR\n" + ":72:/PORCTA1/M  YYYYYYY(001622053100386\n" + "//98)\n" + "/REFBEN/000A80960552\n" + "/REC/00940001872410904744\n" + "/CODORD/40005\n" + ":77B:/ORDERRES///000000\n" + "-}{5:{MAC:17F13741}{CHK:802BE35B36EB}}";
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test103_7()
		public virtual void test103_7()
		{
