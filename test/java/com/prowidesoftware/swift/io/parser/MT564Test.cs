...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to .NET:
	...
	/// @since 4.0
	/// </summary>
	public class MT564Test : BaseMessageTestcase
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test564_1()
		public virtual void test564_1()
		{
			...
			assertEquals(6, o.Block4.countByName("16R"));

			Tag[] blocks = o.Block4.getTagsByName("16R");
			IList<Tag> b4Tags = o.Block4.Tags;

			// Check first and last subblocks
			int pos = b4Tags.IndexOf(blocks[0]);
			Tag t = (Tag) b4Tags[pos + 1];
			assertEquals("20C", t.Name);
			assertEquals(":CORP//D455103", t.Value);
			t = (Tag) b4Tags[pos + 2];
			assertEquals("20C", t.Name);
			assertEquals(":SEME//029206016", t.Value);
			...
			t = (Tag) b4Tags[++pos];
			assertEquals("22H", t.Name);
			assertEquals(":CRDB//CRED", t.Value);

			t = (Tag) b4Tags[++pos];
			assertEquals("19B", t.Name);
			assertEquals(":ENTL//CHF0,01", t.Value);

			t = (Tag) b4Tags[++pos];
			assertEquals("19B", t.Name);
			assertEquals(":GRSS//CHF0,01", t.Value);

			t = (Tag) b4Tags[++pos];
			assertEquals("19B", t.Name);
			assertEquals(":NETT//CHF0,01", t.Value);

			t = (Tag) b4Tags[++pos];
			assertEquals("98A", t.Name);
			assertEquals(":PAYD//20111111", t.Value);

			t = (Tag) b4Tags[++pos];
			assertEquals("98A", t.Name);
			assertEquals(":VALU//20111111", t.Value);
		}
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test564_2()
		public virtual void test564_2()
		{
			messageToParse = "{1:F01MTGSUS6SAXXX3206837054}{2:O5641435070316CHASGB2LDGST07128160300703160735N}{3:{108:000255CQ8272245}}{4:\n" + ":16R:GENL\n" + ":20C::CORP//D455103\n" + ":20C::SEME//029206016\n" + ":23G:NEWM\n" + ":22F::CAEV//DVCA\n" + ":22F::CAMV//MAND\n" + ":98C::PREP//20070316143348\n" + ":25D::PROC//COMP\n" + ":16S:GENL\n" + ":16R:USECU\n" + ":35B:ISIN CH0011075394\n" + "/XX/5983816\n" + "ZURICH FIN SVS GRP\n" + "CHF0.10\n" + ":16R:ACCTINFO\n" + ":97A::SAFE//760043140\n" + ":94F::SAFE//CUST/UBSWCHZH80A\n" + ":93B::ELIG//UNIT/7000,\n" + ":16S:ACCTINFO\n" + ":16S:USECU\n" + ":16R:CADETL\n" + ":98A::XDTE//20111111\n" + ":98A::PAYD//20111111\n" + ":98A::RDTE//20111111\n" + ":92A::WITF//35,\n" + ":92A::GRSS//0,000001000\n" + ":16S:CADETL\n" + ":16R:CAOPTN\n" + ":13A::CAON//001\n" + ":22F::CAOP//CASH\n" + ":11A::OPTN//CHF\n" + ":17B::DFLT//Y\n" + ":98A::XDTE//20111111\n" + ":98A::PAYD//20111111\n" + ":98A::RDTE//20111111\n" + ":92A::GRSS//0,000001000\n" + ":16R:CASHMOVE\n" + ":22H::CRDB//CRED\n" + ":19B::ENTL//CHF0,01\n" + ":19B::GRSS//CHF0,01\n" + ":19B::NETT//CHF0,01\n" + ":98A::PAYD//20111111\n" + ":98A::VALU//20111111\n" + ":16S:CASHMOVE\n" + ":16S:CAOPTN\n" + "-}";
			assertEquals("564", (parseMessage(messageToParse)).Type);
			assertEquals("F01MTGSUS6SAXXX3206837054", b1.BlockValue);
			assertEquals("O5641435070316CHASGB2LDGST07128160300703160735N", b2.BlockValue);
			assertEquals(42, b4.countAll());
		}

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void test564_3()
		public virtual void test564_3()
		{
			...
			b4.getTagByName("93B").Value = ":SETT//UNIT/0000,";
