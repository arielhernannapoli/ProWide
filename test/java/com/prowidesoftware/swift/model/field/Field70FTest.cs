...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to .NET:
	...
	/// @since 6.0
	/// </summary>
	public class Field70FTest : AbstractFieldTest
	{
...
//ORIGINAL LINE: @Override @Test public void testSerialization()
		...
		{
			testSerializationImpl("70F", ":ADTX//----REPURCHASE OFFER----\n.\nFTT/N: PURCHASED SHARES WILL BE\nDESTROYED", ":ABCD//SIMPLE FOO NARRATIVE WITHOUT ANY CODEWORD");
		}

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testField70FString()
		public virtual void testField70FString()
		{
			...
			assertEquals("ADTX", f.Component1);
			assertEquals(c2, f.Component2);
		}
	}
