...
//ORIGINAL LINE: @Test public void testMT547ToJson()
		public virtual void testMT547ToJson()
		{
			...
			JsonObject o = parser.parse(toJson).AsJsonObject;

			assertEquals("FMACUS33AXXX", o.get("basicHeaderBlock").AsJsonObject.get("logicalTerminal").AsString);
			assertEquals("CHASUSU9AXXX", o.get("applicationHeaderBlock").AsJsonObject.get("MIRLogicalTerminal").AsString);
			assertEquals("108", o.get("userHeaderBlock").AsJsonObject.get("fields").AsJsonArray.get(0).AsJsonObject.get("name").AsString);
			assertEquals("98E", o.get("textBlock").AsJsonObject.get("fields").AsJsonArray.get(3).AsJsonObject.get("name").AsString);
			assertEquals("PREP", o.get("textBlock").AsJsonObject.get("fields").AsJsonArray.get(3).AsJsonObject.get("qualifier").AsString);
			assertEquals("N", o.get("textBlock").AsJsonObject.get("fields").AsJsonArray.get(3).AsJsonObject.get("sign").AsString);
		}

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testMT547FromJson()
		public virtual void testMT547FromJson()
		{
			...
			assertNotNull(mt);
			assertEquals("547", mt.MessageType);
			assertEquals("SEME", mt.Field20C[0].Qualifier);
			assertEquals("T314314CDM0", mt.Field20C[0].Reference);
			assertEquals("NEWM", mt.Field23G.Value);
			assertEquals("8217083,72", mt.Field19A[0].Amount);

			assertTrue(mt.m.Block3.Tags.size() == 1);
			assertEquals("001823CQ1833911", mt.m.Block3.getTag(0).Value);

			assertTrue(mt.m.Block4.Tags.size() == 45);
			assertEquals(":TRAD//20141107", mt.m.Block4.getTag(9).Value);
		}

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testToJsonAndFromJson()
		public virtual void testToJsonAndFromJson()
		{
			...
			SwiftMessage original = mt.SwiftMessage;
			...
			assertTrue(comp.Compare(original, mt2.SwiftMessage) == 0);
			...
			assertTrue(comp.Compare(original, mt3.SwiftMessage) == 0);
		}
...
//ORIGINAL LINE: @Test public void testJsonSlashPreserveField59()
		public virtual void testJsonSlashPreserveField59()
		{
			...
			assertNotNull(o);
			assertEquals("/ES0123456789012345671234\nFOOOOO 1000 FOOBAR S.A.", o.get("data").AsJsonObject.get("block4").AsJsonObject.getAsJsonArray("tags").get(8).AsJsonObject.get("value").AsString);
		}
